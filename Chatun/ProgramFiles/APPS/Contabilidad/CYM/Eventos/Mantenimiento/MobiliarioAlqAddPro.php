						...
						<div class="card-body">
							<div class="row">
								<?php
									...
									$Query = mysqli_query($db, "INSERT INTO Bodega.MOBILIARIO_ALQUILER(MA_NOMBRE, CM_CODIGO, TM_CODIGO, MA_PRECIO_COSTO, MA_PRECIO_UNITARIO, MA_ESTADO)VALUES('".$Nombre."', ".$CategoriaMobiliario.", ".$TipoMobiliario.", ".$PrecioCosto.", ".$PrecioUnitario.", 1)");
