						...
						<div class="card-body">
							<div class="row">
								<?php
									...
									$Contador      = count($Observaciones);

									$Query = mysqli_query($db, "INSERT INTO Bodega.RANCHO(R_NOMBRE, R_REFERENCIA, R_PRECIO_UNITARIO, R_ESTADO, R_CAPACIDAD)VALUES('".$Nombre."', '".$CodigoUnico."', ".$PrecioUnitario.", 1, ".$Capacidad.")");
			                        ...
			                        echo '<div class="col-lg-12 text-center">
											...
											<div class="row">
												<div class="col-lg-12 text-center"><a href="Rancho.php"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></div>
										</div>';
