	...
	<div id="base">
		...
		<div id="content">
			<?php
				...
				{
					$TotalTarjetaCredito = $row3["TOTAL_CREDITO"]+$TotalTarjetaMF;
				}
				...
				{
					$TotalDeposito = $row5["TOTAL_DEPOSITOS"]+$TotalBancoMF;
				}	
				...
				{
					$TotalEfectivo = $row["TOTAL_EFECTIVO"]+$TotalEfectivoMF;
				}	
				...
				$Total = ($TCQ + $TotalAnticipoMF + $TotalTarjetaCredito + $TotalDolaresQuetzalisados + $TotalLempirasQuetzalisados + $TotalDeposito + $TotalCreditos - ($FilaNotaEfectivo[TRA_TOTAL] + $FilaNotaCredito[TRA_TOTAL] + $FilaNotaTarjetaCredito[TRA_TOTAL] + $FilaNotaDepositos[TRA_TOTAL] + $FilaNotaDolares[TRA_TOTAL] + $FilaNotaLempiras[TRA_TOTAL]));

				$FaltSob = ($TCQ + $TotalAnticipoMF + $TotalCreditos + $TotalTarjetaCredito + $TotalDolaresQuetzalisados + $TotalLempirasQuetzalisados + $TotalDeposito) - ($TotalFacturado - ($FilaNotaEfectivo[TRA_TOTAL] + $FilaNotaCredito[TRA_TOTAL] + $FilaNotaTarjetaCredito[TRA_TOTAL] + $FilaNotaDepositos[TRA_TOTAL] + $FilaNotaDolares[TRA_TOTAL] + $FilaNotaLempiras[TRA_TOTAL]));
				...
				$Query12 = "SELECT SUM(AE_MONTO) AS TOTAL_ANTICIPOS FROM Contabilidad.ANTICIPO_EVENTOS WHERE AE_ESTADO = 0 AND AE_FECHA = '".$Fecha."' ";
				...
				$Query13 = "SELECT SUM(AE_MONTO) AS TOTAL_ANTICIPOSEFE FROM Contabilidad.ANTICIPO_EVENTOS WHERE AE_ESTADO = 0 AND AE_TIPOPAGO = 1 AND AE_FECHA = '".$Fecha."'";
				...
				$Query14 = "SELECT SUM(AE_MONTO) AS TOTAL_ANTICIPOSTAR FROM Contabilidad.ANTICIPO_EVENTOS WHERE AE_ESTADO = 0 AND AE_TIPOPAGO = 2 AND AE_FECHA = '".$Fecha."'";
				...
				$Query15 = "SELECT SUM(AE_MONTO) AS TOTAL_ANTICIPOSDEP FROM Contabilidad.ANTICIPO_EVENTOS WHERE  AE_ESTADO = 0 AND AE_TIPOPAGO = 4 AND AE_FECHA = '".$Fecha."' ";
				$Result15 = mysqli_query($db,$Query15);
				...
				$Query16 = "SELECT COUNT(AE_CODIGO) AS ANTICIPOS_EMITIDAS FROM Contabilidad.ANTICIPO_EVENTOS WHERE AE_ESTADO = 0 AND AE_FECHA = '".$Fecha."'";
				...
				{
					$Falta = $TCQ + $TotalAnticipoMF + $TotalCreditos + $TotalTarjetaCredito + $TotalDolaresQuetzalisados + $TotalLempirasQuetzalisados + $TotalDeposito + $TotalAnticipoTar + $TotalAnticipoDep - $TotalFacturado;
				}
				if($Sobrante!="")
				{
					$Sobra = $Sobrante;
				...
				{
					$Sobra = $TCQ + $TotalAnticipoMF + $TotalCreditos + $TotalTarjetaCredito + $TotalDolaresQuetzalisados + $TotalLempirasQuetzalisados + $TotalDeposito + $TotalAnticipoTar + $TotalAnticipoDep - $TotalFacturado;
				}
