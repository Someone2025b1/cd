...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Bodegas</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
						<h4 class="text-center"><strong>Bodegas</strong></h4>
						</div>
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<tbody>
								<?php
									$Consulta = "SELECT * FROM Bodega.BODEGA ORDER BY B_NOMBRE";
									$Resultado = mysqli_query($db, $Consulta);
									while($row = mysqli_fetch_array($Resultado))
									{
										$Codigo = $row["B_CODIGO"];
										echo '<tr>';
										    	echo '<td style="font-size: 10px">'.$row["B_CODIGO"].'</td>';               
										    	echo '<td style="font-size: 10px">'.$row["B_NOMBRE"].'</td>';
										    	echo '<td><a href="BMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
