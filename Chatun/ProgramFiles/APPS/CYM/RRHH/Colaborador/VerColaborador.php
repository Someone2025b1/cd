							...
							<div class="row">
									...
									<div class="col-lg-4">
                                        ...
                                        <label for="Base">Salario Base</label>
											<input class="form-control" type="num" name="Base" id="Base" value="<?php echo $Base; ?>" readonly />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
                                        <label for="BonoLey">Bono Ley</label>
											<input class="form-control" type="num" name="BonoLey" id="BonoLey" value="<?php echo $BonoLey; ?>" readonly/>
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
                                        <label for="Bono">Bonificación Insentivo</label>
											<input class="form-control" type="num" name="Bono" id="Bono" value="<?php echo $Bono; ?>" readonly/>
										</div>
									</div>
									</div>
									</div>
