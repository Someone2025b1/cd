...
?>
<table class="table table-hover table-condensed" id="tbl_resultCortesia">
        <thead>
        ...
        <?php
            ...
            while($row = mysqli_fetch_array($Resultado))
            {
                ...
                <tr>             
                        ...
                        <td align="center"><button type="button" class="btn btn-danger btn-circle" onclick="eliminarCortesia(<?php echo "$Codigo"; ?>)"><i class="fa fa-times"></i>
                                </button> 
                                </td>
                    </tr>
                    <?php 
    ...
    var tf = setFilterGrid('tbl_resultCortesia', tbl_filtrado);
</script>
       
<script>
    function eliminarCortesia(idEvento)
    {
       $.ajax({
            url: 'Ajax/EliminarCortesia.php',
            type: 'POST',
            dataType: 'html',
