					...
					<div class="card">
						...
						<div class="card-body">
							<?php
								...
								if($PuntoVenta == 1)
								{
									$NombrePuntoVenta = 'Restaurante';
								}
								elseif($PuntoVenta == 2)
								{
									$NombrePuntoVenta = 'Souvenirs';
								}
								elseif($PuntoVenta == 3)
								{
									$NombrePuntoVenta = 'Helados';
								}
								elseif($PuntoVenta == 4)
								{
									$NombrePuntoVenta = 'Kiosko Restaurante';
								}
								elseif($PuntoVenta == 5)
								{
									$NombrePuntoVenta = 'Taquilla';
								}
								elseif($PuntoVenta == 7)
								{
									$NombrePuntoVenta = 'Restaurante Mirador';
								}
								elseif($PuntoVenta == 6)
								{
									$NombrePuntoVenta = 'Kiosko 2';
								}
								elseif($PuntoVenta == 8)
								{
									$NombrePuntoVenta = 'Eventos';
								}
								elseif($PuntoVenta == 9)
								{
									$NombrePuntoVenta = 'Tilapia';
								}
								elseif($PuntoVenta == 11)
								{
									$NombrePuntoVenta = 'Kiosko Oasis';
								}
								elseif($PuntoVenta == 10)
								{
									$NombrePuntoVenta = 'Juegos';
								}
								elseif($PuntoVenta == 17)
								{
									$NombrePuntoVenta = 'Souvenirs';
								}
								elseif($PuntoVenta == 16)
								{
									$NombrePuntoVenta = 'Taquilla';
								}
								elseif($PuntoVenta == 15)
								{
									$NombrePuntoVenta = 'Taquilla';
								}
								elseif($PuntoVenta == 18)
								{
									$NombrePuntoVenta = 'Kiosko Pasillo';
								}

								$Query = "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_TIPO = ".$PuntoVenta." AND ACC_FECHA = '".$Fecha."' AND ACC_ESTADO = 2";
								...
								{	
									...
									<form class="form" role="form" method="POST" action="CCModPro.php">
										<div class="row">
											...
											<div class="col-lg-4">
												<div class="form-group floating-label">
													<input class="form-control" type="text" name="NombrePuntoVenta" id="NombrePuntoVenta" value="<?php echo $NombrePuntoVenta ?>" required readonly/>
