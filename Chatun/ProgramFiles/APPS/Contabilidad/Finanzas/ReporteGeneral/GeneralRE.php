...
/*TITULOS*/
    $Titulo = array('col1'=>'Partida', 'col2'=>'Saldo Inicial', 'col3'=>'Cargos', 'col4'=>'Abonos', 'col5'=>'Total Mes', 'col6'=>'Saldo Final');
/*FIN TITULOS*/
...
$Data[] = array('col1'=>($NombreTit),'col2'=>number_format($SumaSaldoInicial+$Alter, 3, ".", ""), 'col3'=>number_format($SumaCargos, 3, ".", ""), 'col4'=>number_format($SumaAbonos, 3, ".", ""), 'col5'=>number_format($diferenciaCargosAbonos, 3, ".", ""), 'col6'=>number_format($SumaSaldoFinal+$Alter, 3, ".", ""));
...
$Data[]= array('col2'=>number_format($TotalesSalAnte, 3, ".", ""), 'col3'=>number_format($TotalesSumaCargos, 3, ".", ""), 'col4'=>number_format($TotalesSumaAbonos, 3, ".", ""), 'col5'=>number_format($TotalesDiferencia, 3, ".", ""), 'col6'=>number_format($TotalesSalActu, 3, ".", ""), 'col1'=>'TOTALES FINALES');
