						...
						<div class="card-body">
							<?php
                                ...
                                for($i=1; $i<$Contador; $i++)
                                {
									...
									{
										$ExistenciaSistema=$rowe["P_EXISTENCIA_SOUVENIRS"];

										}

                                    $sql2 = mysqli_query($db, "INSERT INTO Productos.CONTROL_INVENTARIO_DETALLE (CI_CODIGO, CID_CODIGO, P_CODIGO, CID_CONTEO_FECHA1, CID_SITEMA1, CID_CONSIGNACION1)
                                VALUES ('".$Uid."', '".$UidD."', ".$Prod.", ".$Can.", ".$ExistenciaSistema.", ".$Con.")");
