...
<body class="menubar-hoverable header-fixed menubar-pin ">
    ...
    <div id="base"> 
            <div class="container">
                <h1 class="text-center"><strong>Administración Alimentos</strong><br></h1>
                <br>
                <form class="form" id="FormEstanque">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-head style-primary">
                                <h4 class="text-center"><strong>Administración Alimentos</strong></h4>
                            </div>
                            <div class="card-body"> 
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group floating-label">
                                            ...
                                            <label for="Tipo">Tipo Alimento</label>
                                        </div>
                                    </div>
                                </div>  
                                <div class="row">
                                ...
                                <div class="col-lg-12" align="center">
                                    <button type="button" onclick="GuardarAlimento()" class="btn ink-reaction btn-raised btn-primary">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div> 
    ...
    <div class="container">
     <div class="row"> 
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-head style-primary">
                       <h2 class="text-center text-white">LISTADO DE ALIMENTOS</h2>
                    </div>
                    <div class="card-body"> 
                            <div class="row"> 
                                <div class="col-md-12"> 
            ...
            <div id="myTable_wrapper" class="dataTables_wrapper no-footer"> <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                                            ...
                                            <tbody> 
                                            <?php 
                                                $Sql_Ges_Creadas = mysqli_query($db, "SELECT * FROM Pisicultura.Producto_Pisicultura WHERE Estado = 1 AND Tipo = 1"); 
   ...
   function GuardarAlimento(){
    ...
    $.ajax({
        ...
        success: function(data){ 
            ...
            setTimeout(function(){location.href="IngresoAlimento.php"} , 1000);   
            }
            else
            {
