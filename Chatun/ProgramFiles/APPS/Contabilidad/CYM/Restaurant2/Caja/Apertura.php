	...
	<div id="base">
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Consulta = "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_ESTADO = 1 AND ACC_TIPO = 20";
								$ResultConsulta = mysqli_query($db,$Consulta) or die(mysqli_error($sql));
								...
								$ConteoApertura = mysqli_num_rows(mysqli_query($db, "SELECT *FROM Bodega.APERTURA_CIERRE_CAJA a 
										...
										WHERE a.ACC_FECHA = CURDATE() AND a.ACC_TIPO = 20 "));

								if($ConteoApertura < 2)
								{	

									$Query = "SELECT ACC_FECHA FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_ESTADO = 1 AND ACC_FECHA < CURRENT_DATE() AND ACC_TIPO = 20";
									...
									{ 
										...
										<div class="row">
											<div class="row text-center">
												<button disabled type="submit" class="btn btn-success" id="btnSubmit">
								...
								else
								{
									?>
									<div class="alert alert-callout alert-success" role="alert">
									 Ha excedido la cantidad de aperturas del día.
									</div>
									<?php
								}
		...
		<script>
			function CalcularTotalQ()
			{
				...
				if (parseFloat(Total)==parseFloat(TotalApertura)) 
				{
