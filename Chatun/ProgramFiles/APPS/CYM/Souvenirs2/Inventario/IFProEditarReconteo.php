...
<script>
	function EnviarForGuardar()
	{
		...
		$(Formulario).attr('action', 'IFProGuardarEditadoReconteo.php');
		$(Formulario).submit();	
							...
							<div class="card-body">
								...
								<table class="table table-hover table-condensed">
									...
									<tbody>
										...
										$QueryCuentas = "SELECT INVENTARIO_RECONTEO_DETALLE.P_CODIGO, INVENTARIO_RECONTEO_DETALLE.ID_CANTIDAD_CONTADA, UNIDAD_MEDIDA.UM_NOMBRE, PRODUCTO.P_NOMBRE 
												...
												<td>
													<div class="col-lg-10">
														<div class="form-group">
															...
															<input class="form-control" min="0" type="number" name="Fisico[]"  id="Fisico[]" value="<?php echo $row["ID_CANTIDAD_CONTADA"]; ?>" required/>
														</div>
													</div>
												</td>
											</tr>
								...
								<button type="button" class="btn ink-reaction btn-raised btn-primary" id="btnGuardar" onclick="EnviarForGuardar()">GUARDAR Y SEGUIR EDITANDO</button>
								</div>
								<br>
								<div class="row text-center">
								<button type="button" class="btn ink-reaction btn-raised btn-danger" id="Guardar" onclick="EnviarFormFinal()">ENVIAR</button>
								</div>
							</div>
						</div>
					</div>
