...
$TotalTarjetaCredito = number_format($_POST["TCCorte"], 2);

$TotalDepositos = number_format($_POST["DepositosCorte"], 2);
...
$TotalIngresos = number_format($_POST["EfectivoCorte"] + $_POST["Dolares1Corte"] + $_POST["Lempiras1Corte"] + $_POST["CreditoCorte"] + $_POST["TCCorte"] + $_POST["DepositosCorte"], 2);
...
$FaltanteSobranteTotal = (($_POST["EfectivoCorte"] + $_POST["Dolares1Corte"] + $_POST["Lempiras1Corte"]) + ($_POST["CreditoCorte"] - $_POST["NotaCreditoCredito"] + $_POST["NotaDebitoCredito"]) + ($_POST["TCCorte"] - $_POST["NotaCreditoTarjeta"] + $_POST["NotaDebitoTarjeta"]) + ($_POST["DepositosCorte"] - $_POST["NotaCreditoDeposito"] + $_POST["NotaDebitoDeposito"])) - ($_POST["FacturadoCorte"]) ;
