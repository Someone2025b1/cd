					...
					<div class="card">
						...
						<div class="card-body">
							...
							date_default_timezone_set('America/Guatemala');
								...
								$TotalMenosRetenciones = $TotalFactura - ($ISR + $IVA);
										  ...
										  <dte:SAT ClaseDocumento="dte">
										    <dte:DTE ID="DatosCertificados">
										      <dte:DatosEmision ID="DatosEmision">
										        <dte:DatosGenerales CodigoMoneda="GTQ" FechaHoraEmision="'.$FechaHoraHoy.'" Tipo="FESP"></dte:DatosGenerales>
										        <dte:Emisor AfiliacionIVA="GEN" CodigoEstablecimiento="1" CorreoEmisor="'.$CorreoEmisor.'" NITEmisor="'.$NITEmisor.'" NombreComercial="'.$NombreComercial.'" NombreEmisor="'.$NombreEmisor.'">
										          <dte:DireccionEmisor>
										        ...
										        <dte:Receptor CorreoReceptor="kelly.intecap@gmail.com" IDReceptor="'.$DPI.'" NombreReceptor="'.$NombreCompleto.'" TipoEspecial="CUI">
								...
								for($i=1; $i<$ContadorFE; $i++)
                    			{
									...
									{	
										...
										$query = mysqli_query($db, "INSERT INTO Contabilidad.DETALLE_FACTURA_ESPECIAL (DFE_CODIGO, TRA_CODIGO, DFE_CANTIDAD, DFE_DESCRIPCION, DFE_PRECIO, DFE_SUBTOTAL, DFE_TIPO, DFE_NIT)
															VALUES('".$UIDFE."', '".$UI."', ".$Can.", '".$Des."', ".$Pre.", ".$Sub.", '".$Tip."', '".$DPI."')");
										...
										$XMLEnviar .= '
								          <dte:Item BienOServicio="'.$Tip.'" NumeroLinea="'.$i.'">
								            ...
								            <dte:PrecioUnitario>'.number_format($Pre, 4, ".", "").'</dte:PrecioUnitario>
								...
								$XMLEnviar .= '
									        ...
									        <dte:Complementos>
									          <dte:Complemento IDComplemento="Especial" NombreComplemento="Especial" URIComplemento="http://www.sat.gob.gt/fel/especial.xsd">
									            <cfe:RetencionesFacturaEspecial xmlns:cfe="http://www.sat.gob.gt/face2/ComplementoFacturaEspecial/0.1.0" Version="1" xsi:schemaLocation="http://www.sat.gob.gt/face2/ComplementoFacturaEspecial/0.1.0 C:\Users\User\Desktop\FEL\Esquemas\GT_Complemento_Fac_Especial-0.1.0.xsd">
									              <cfe:RetencionISR>'.number_format($ISR, 2, ".", "").'</cfe:RetencionISR>
									              <cfe:RetencionIVA>'.number_format($IVA, 2, ".", "").'</cfe:RetencionIVA>
									              <cfe:TotalMenosRetenciones>'.number_format($TotalMenosRetenciones, 2, ".", "").'</cfe:TotalMenosRetenciones>
					...
					$url_servicio_firma = "https://signer-emisores.feel.com.gt/sign_solicitud_firmas/firma_xml";
								...
								if($response->body->resultado == 1)
								{
									...
									if($responseCerti->body->cantidad_errores == 0)
									{
										...
										$sql = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_NO_HOJA, TRA_FECHA_TRANS, TRA_SERIE, TRA_FACTURA, TRA_CONCEPTO, TC_CODIGO, TRA_TOTAL, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_CORRELATIVO, TRA_SALDO, TRA_TIPO_FACTURA_VENTA, PC_CODIGO, TRA_DTE, TRA_CAE, TRA_FECHA_CERTIFICACION, P_CODIGO, TRA_ISR, TRA_IVA)
														VALUES('".$UI."', '".$Comprobante."', '".$FechaFactura."', '".$responseCerti->body->serie."', '".$responseCerti->body->numero."', '".$Descripcion."', '".$TipoCompra."', ".$TotalFactura.", CURRENT_DATE(), CURRENT_TIMESTAMP(), '".$id_user."', 2, 19, ".$Correlativo.", ".$TotalFactura.", 'FES', ".$Periodo.", '".$responseCerti->body->uuid."', '".$responseCerti->body->numero."', '".$responseCerti->body->fecha."', '".$CodigoProveedor."', $ISR, $IVA)");
										...
										if($Centinela == true)
										{
											echo '<div class="col-lg-12 text-center">
												...
												<h2 class="text-light">La factura especial se ingresó correctamente.</h2><br>
											    ...
											    <a target="_blank" href="FactImp.php?Codigo='.$UI.'"><button type="button" class="btn btn-sm btn-success">
												    	<span class="glyphicon glyphicon-print"></span> Imprimir Factura
													</button></a>
												<a href="Factura_Especial.php"><button type="button" class="btn btn-sm btn-danger">
