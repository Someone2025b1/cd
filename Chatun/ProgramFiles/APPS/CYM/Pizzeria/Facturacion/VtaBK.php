...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA WHERE F_SERIE = '".$Serie."' ORDER BY F_NUMERO DESC LIMIT 1";
	...
	{
		$ConsultaNumeroFacturaInicial = "SELECT RES_DEL FROM Bodega.RESOLUCION WHERE RES_ESTADO = 1 AND RES_TIPO = 'TR'";
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 22";
								...
								<div class="card">
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="VtaPro.php" method="POST" role="form">
