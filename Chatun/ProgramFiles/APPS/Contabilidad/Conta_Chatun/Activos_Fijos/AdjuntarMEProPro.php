...
<head>
	...
	function Redireccionar()
	{
		...
		window.location.replace('AdjuntarMEPro.php?CodigoPoliza='+Codigo);
	}
	</script>
			...
			<div class="container">
				<div class="col-lg-12">
					...
					<div class="card">
						...
						$query = mysqli_query($db,"INSERT INTO Contabilidad.ACTIVO_FIJO(AF_CODIGO, AF_NOMBRE, AF_RESPONSABLE, AF_AREA, AF_OBSERVACIONES, AF_VALOR, AF_TRANSACCION, TA_CODIGO, AF_ESTADO, AF_VALOR_ACTUAL, AF_FECHA_ADQUISICION, AF_DEDUCIBLE)
						...
						if($query)
						{
							$Consulta = mysqli_query($db,"UPDATE Contabilidad.TRANSACCION SET TRA_SALDO = ".$SaldoActual2." WHERE TRA_CODIGO = '".$CodigoTrans."';");
							if($Consulta)
							{
								?>
									<script>
