				...
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<tbody>
									...
									AND ACTIVO_FIJO.AF_RESPONSABLE = ".$_POST["Colaborador"];
									...
									AND ACTIVO_FIJO_MENOR.AF_RESPONSABLE = ".$_POST["Colaborador"];
									$result = mysqli_query($db,$query);
									while($row = mysqli_fetch_array($result))
									{
										?>
			            ...
			            <div class="col-lg-12 text-center">
			            	<a href="HR.php?Usuario=<?php echo $_POST["Colaborador"]; ?>" target="_blank"><button type="button" class="btn btn-primary btn-lg">
							    <span class="glyphicon glyphicon-list-alt"></span> Hoja Responsabilidades
							</button></a>
			            </div>
			        </div>
			    </div>
