...
$FechaHora = date('d-m-Y H:i:s', strtotime('now'));
                ...
                $Query = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_USUARIO = $Usuario";
                ...
                $Query1 = "SELECT COUNT(F_CODIGO) AS FACTURAS_ANULADAS FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_ESTADO = 2 AND F_USUARIO = $Usuario";
                ...
                $Query3 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_TIPO = 2 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_DOLARES FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_TIPO = 1 AND F_MONEDA = 2 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_LEMPIRAS FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_TIPO = 1 AND F_MONEDA = 3 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                $Result4 = mysqli_query($db, $Query4);
                while($row4 = mysqli_fetch_array($Result4))
                {
                ...
                $Query5 = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_TIPO = 4 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query6 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_TIPO = 3 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query7 = "SELECT SUM(F_TOTAL) AS TOTAL_EFECTIVO FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_MONEDA = 1 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query9 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_LEMPIRA FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_MONEDA = 3 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."' AND F_MONEDA = 2 AND F_ESTADO = 1 AND F_USUARIO = $Usuario";
                ...
                $Query11 = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_KS_4 WHERE F_ESTADO = 1 AND F_USUARIO = $Usuario AND F_FECHA_TRANS = '".$FechaHoy."'";
                ...
                $QueryDocumentosEmitidos = mysqli_query($db, "SELECT F_CODIGO FROM Bodega.FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$FechaHoy."'");
