...
<div align="left">
    ...
    <div align="left">
		<a type="button" href="Ajax/DataKardexGeneralPDF.php?FechaInicio=<?php echo $FechaInicio ?>&FechaFin=<?php echo $FechaFin ?>" target="_blank" class="btn ink-reaction btn-raised btn-primary" id="BtnExportarTicketHotel">Exportar PDF</a>
	</div> 
	<br>
	<div style="overflow-x:auto;">
        ...
        <tr>
            ...
            <td><b>Cantidad</b></td>
            <td><b>Existencia General Anterior</b></td>
            <td><b>Existencia General Actual</b></td>
...
?>
		    	...
		    	<td><?php echo number_format($ExiGAnt, 2, ".", "") ?></td>
		    	<td><?php echo number_format($ExiGAct, 2, ".", "") ?></td>
