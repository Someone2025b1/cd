					...
					<tbody>
						<?php
							...
							while($Fila = mysqli_fetch_array($Query))
							{
								...
								$sqlRet2 = mysqli_query($db,"SELECT A.CLIC_DIAS 
                                FROM Contabilidad.CLIENTE_CREDITO AS A     
                                WHERE A.CLIC_NIT = ".$NIT); 
                                $rowret2=mysqli_fetch_array($sqlRet2);

                                $DiasCredito=$rowret2["CLIC_DIAS"];
								...
								?>
									<tr>
										...
										<td class="text-center"><h6 style="<?php if($Diferencia>$DiasCredito){echo "color:red;";} ?>"><?php echo $Diferencia ?></h6></td>
									</tr>
								<?php
