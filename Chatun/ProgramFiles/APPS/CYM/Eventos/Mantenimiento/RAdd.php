	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<form class="form" action="RAddPro.php" method="POST" role="form" enctype="multipart/form-data">
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
										...
										<div class="form-group">
											<select name="CategoriaMenuEventos" id="CategoriaMenuEventos" class="form-control" required>
												...
												<?php
                                                    ...
                                                    {
                                                        echo '<option value="'.$row["CME_CODIGO"].'">'.$row["CME_NOMBRE"].'</option>';
                                                    }
								...
								<div class="row">
									<div class="col-lg-2 col-lg-8">
										<div class="form-group">
											<label for="Precio">Fotografia</label>
											<input name="Fotografia" type="file" accept="image/*"/>
										</div>
									</div>
								</div>
