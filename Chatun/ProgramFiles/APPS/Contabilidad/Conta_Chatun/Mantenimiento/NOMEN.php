...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Nomenclatura</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
						<h4 class="text-center"><strong>Nomenclatura</strong></h4>
						</div>
						<div class="card-body">
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										if($row["N_TIPO"] == 'GM')
										{
											echo '<tr>';
										    	...
										    	echo '<td><a href="NOMENMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
