...
function CancelacionFun(z)
	{
		...
		var confirmar = confirm("¿Está seguro de que desea Cancelar este evento?");
		...
		$.ajax({
			type: "POST",
			url: "CancelacionEvento.php",
			data:"Codigo="+z,

			success: function(data) {
				alertify.error('El Evento fue cancelado con éxito');
				location.reload();
	...
	function RefacturarFun(t)
	{
		//alert('llega');
		
		var CodigoRequisicion = t.value;
		//Le pasamos el valor del input al ajax

		var confirmar = confirm("¿Está seguro de que desea refacturar este evento?");
		...
		$.ajax({
			type: "POST",
			url: "RefacturarEvento.php",
			data:"Codigo="+t,

			success: function(data) {
				alertify.success('El Evento Se puede refacturar con éxito');
				location.reload();
		...
		<div id="content">
			<div class="container">
				...
				<form class="form" method="POST" role="form">
					...
					?>
				<div class="col-lg-12" align="lefth">
				<?php
						...
						?>
					<button type="button" class="btn ink-reaction btn-raised btn-danger" id="btnCancelar" value="<?php echo $Codigo; ?>" onclick="CancelacionFun(this.value)">Cancelar Evento</button>
					<?php
					}
					if($Factura != NULL){
					?>

					<button type="button" class="btn ink-reaction btn-raised btn-info" id="btnRefacturar" value="<?php echo $Codigo; ?>" onclick="RefacturarFun(this.value)">Refacturar</button>
				</div>
								...
								<div id="accordion-2" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="MenuAdultoD">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoD" id="MenuAdultoD" value="<?php echo $MenuAdultoD?>" disabled="disabled"/>
                                        ...
                                        <label for="MenuNinoD">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoD" id="MenuNinoD" value="<?php echo $MenuNinoD?>" disabled="disabled"/>
								...
								<div id="accordion-1" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="MenuAdultoRAM">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoRAM" id="MenuAdultoRAM" value="<?php echo $MenuAdultoRAM?>" disabled="disabled"/>
                                        ...
                                        <label for="MenuNinoRAM">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoRAM" id="MenuNinoRAM" value="<?php echo $MenuNinoRAM?>" disabled="disabled"/>
								...
								<div id="accordion-3" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="MenuAdultoA">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoA" id="MenuAdultoA" value="<?php echo $MenuAdultoA?>" disabled="disabled"/>
                                        ...
                                        <label for="MenuNinoA">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoA" id="MenuNinoA" value="<?php echo $MenuNinoA?>" disabled="disabled"/>
								...
								<div id="accordion-4" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="CantidadAdultoRPM">Cantidad Adultos</label>
											...
											<div class="col-lg-4">
                                        <label for="MenuAdultoRAM">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoRPM" id="MenuAdultoRPM" value="<?php echo $MenuAdultoRPM?>" disabled="disabled"/>
                                        ...
                                        <label for="MenuNinoRPM">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoRPM" id="MenuNinoRPM" value="<?php echo $MenuNinoRPM?>" disabled="disabled"/>
								...
								<div id="accordion-5" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="MenuAdultoC">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoC" id="MenuAdultoC" value="<?php echo $MenuAdultoC?>" disabled="disabled"/>
                                        ...
                                        <label for="MenuNinoC">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoC" id="MenuNinoC" value="<?php echo $MenuNinoC?>" disabled="disabled"/>
