...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Clientes Credito</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								<thead>
									<th><strong>No. CLIENTE</strong></th>
									<th><strong>NIT</strong></th>
									<th><strong>NOMBRE</strong></th>
									<th><strong>EMPRESA</strong></th>
									<th><strong>CONSULTAR</strong></th>
								</thead>
								<tbody>
								<?php
									$Contador = 1;
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										$Codigo = $row["CLIC_NUM"];
										echo '<tr>';
										    	echo '<td style="font-size: 14px">'.$row["CLIC_NUM"].'</td>';               
										    	echo '<td style="font-size: 14px">'.$row["CLIC_NIT"].'</td>';
										    	echo '<td style="font-size: 14px">'.$row["CLIC_NOMBRE_COMPLETO"].'</td>';
										    	echo '<td style="font-size: 14px">'.$row["CLIC_NOMBRE_COMERCIAL"].'</td>';
										    	echo '<td style="font-size: 24px"><a href="VerCliente.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-info">
