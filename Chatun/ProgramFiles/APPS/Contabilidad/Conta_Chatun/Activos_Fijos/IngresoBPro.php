...
<head>
	...
	{
		var CodigoPoliza = $('#CodigoPolizaUI').val();
		window.location="DarBaja.php?CodigoPoliza="+CodigoPoliza;
	}
	</script>
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<?php
								...
								$CodigoPoliza = $_POST["CodigoPoliza"];
								$Fecha        = $_POST["Fecha"];
								...
								$sql = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_COMPROBANTE, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_CORRELATIVO, TRA_TOTAL, TRA_SALDO, PC_CODIGO)
													VALUES('".$UI."', '".$CodigoPoliza."', '".$Fecha."', '".$Concepto."', CURRENT_DATE(), CURRENT_TIMESTAMP(), '".$UserID ."', 2, 13, '".$Correlativo."', ".$TotalPoliza.", ".$TotalPoliza.", ".$Periodo.")");
