															...
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	...
																	if(isset($_POST["CodigoProducto"]) && isset($_POST["Cantidad"]) && isset($_POST["Valor"]) && isset($_POST["Total"]))
																	{
																		...
																		$Valor        = $_POST["Valor"];
																		$Total        = $_POST["Total"];
																		$Name = mysqli_fetch_array(mysqli_query($db, "SELECT P_NOMBRE FROM Bodega.PRODUCTO WHERE P_CODIGO = 1510"));
																		...
																		<tr>
							                                                ...
							                                                <input type="hidden" class="form-control" name="Producto[]" id="Producto[]" value="1510">
							                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" value="<?php echo $Name['P_NOMBRE'] ?>" readonly style="width: 500px" onchange="BuscarProducto(this)"></h6></td>
