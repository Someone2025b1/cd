...
$prestamo = mysqli_query($dbc, "SELECT a.cifcodcliente, a.cifdocident02, a.cifsexo, a.cifdocident06, a.cifdocident03 FROM bankworks.cif_generales a WHERE a.cifcodcliente = '$Criterio'") or die("error en buscar cif en condiciones diarias");
