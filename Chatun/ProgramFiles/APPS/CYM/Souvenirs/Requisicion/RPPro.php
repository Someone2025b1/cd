						...
						<div class="card">
							...
							<div class="card-body">
								...
								$sql = mysqli_query($db, "INSERT INTO Bodega.REQUISICION (R_CODIGO, R_FECHA, R_FECHA_NECESIDAD, B_CODIGO, R_OBSERVACIONES, RT_CODIGO, R_FECHA_HOY, R_HORA, R_USUARIO, R_ESTADO)
									VALUES('".$UI."', '".$Fecha."', '".$FechaNecesidad."', ".$Bodega.", '".$Concepto."', 2, CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$UserID .", 1)");
								...
								if($Centinela == true)
								{
									...
									<div class="row">
										<div class="col-lg-12 text-left"><a href="RP.php"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></div>
									</div>';
								}
							}
