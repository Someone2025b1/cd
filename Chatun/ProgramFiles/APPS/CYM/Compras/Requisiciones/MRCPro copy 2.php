											...
											$ResultDetalle = mysqli_query($db, $QueryDetalle);
                                            	...
                                            	while($row = mysqli_fetch_array($ResultDetalle))
                                            	{
													...
													<td align="center"><h6><?php echo $Cantidad ?></h6></td>
		                                                <td><h6> <?php echo $row['RD_PRODUCTO'].$j ?> </h6></td>
													...
													<!-- /Modal Detalle Pasivo Contingente -->
																					...
																					<?php
																						...
																						if($Estado==9){
																							if($id_user!=$Solicito){
																							?>
																							<button type="button" class="btn btn-success" value="<?php echo $RDCodigo; ?>" onclick="GuardarEditado(this.value)">Pedido Pagado</button>
