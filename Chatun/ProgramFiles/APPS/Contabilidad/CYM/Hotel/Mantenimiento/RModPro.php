			...
			<div class="container">
				...
				if($_POST["TipoReceta"] == 1)
				{
					...
					if(isset($_POST["EligeSabor"]))
					{
						...
						$sql = mysqli_query($db,  "UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."', RS_PRECIO = ".$_POST["Precio"].", RS_ELEGIR_SABOR = 1, RS_CANTIDAD_BOLAS = ".$CantidadBolas." WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
					}
					else
					{
						$sql = mysqli_query($db,  "UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."', RS_PRECIO = ".$_POST["Precio"].", RS_ELEGIR_SABOR = 0, RS_CANTIDAD_BOLAS = 0 WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
					}
				...
				elseif($_POST["TipoReceta"] == 2)
				{
					...
					$sql = mysqli_query($db,  "UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."' WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
