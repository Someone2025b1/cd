...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="ERGImp.php" method="POST" role="form" target="_blank">
					<div class="col-lg-12">
						<br>
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Estado de Resultados General</strong></h4>
							</div>
							<div class="card-body">
									...
									<div class="col-lg-3">
										<div class="form-group floating-label">
											<select name="TipoReporte" id="TipoReporte" class="form-control" required>
												...
												<option value="2">Sub-Grupos</option>
								...
								<div class="row text-center">
									...
									<div class="col-lg-3">
										<div class="form-group floating-label">
											<input type="text" name="Excepcion" id="Excepcion" class="form-control">
											<label for="Excepcion">Excepción de Comprobantes</label>
										</div>
									</div>
								</div>
