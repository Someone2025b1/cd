...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="DECPImp1.php" method="POST" role="form" target="_blank">
					<div class="col-lg-12">
						<br>
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Detalle de Existencia de Productos</strong></h4>
							</div>
							<div class="card-body">
										...
										<div class="col-lg-6 text-center">
											<div class="form-group">
												<select name="Producto" id="Producto" class="form-control" required>
													...
													<?php
	                                                    //Select para obtener los tipos de falta de la base de datos y creación de las opciones del input select
	                                                    $query = "SELECT * FROM Bodega.PRODUCTO WHERE CP_CODIGO = 'MPU' ORDER BY P_NOMBRE";
	                                                    $result = mysqli_query($db, $query);
	                                                    while($row = mysqli_fetch_array($result))
	                                                    {
	                                                        echo '<option value="'.$row["P_CODIGO"].'">'.$row["P_NOMBRE"].' - '.$row["CP_CODIGO"].'</option>';
	                                                    }
