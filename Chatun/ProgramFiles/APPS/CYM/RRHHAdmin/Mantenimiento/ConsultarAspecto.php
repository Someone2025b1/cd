...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Aspectos a Evaluar</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
						<h4 class="text-center"><strong>Aspectos</strong></h4>
						</div>
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<tbody>
								<?php
									$Consulta = "SELECT ASPECTOS_EVALUAR.*, AREA_EVALUAR.AR_NOMBRE, ASPECTOS_EVALUAR.P_CODIGO FROM RRHH.ASPECTOS_EVALUAR, RRHH.AREA_EVALUAR 
									WHERE AREA_EVALUAR.AR_CODIGO = ASPECTOS_EVALUAR.AR_CODIGO
									AND  AREA_EVALUAR.AR_CODIGO = 9
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										echo '<tr>';
										    	...
										    	echo '<td style="font-size: 10px">'.$NombrePuesto.'</td>';
