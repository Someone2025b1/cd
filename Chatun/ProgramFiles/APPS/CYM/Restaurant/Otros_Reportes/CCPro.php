...
WHERE b.ACC_FECHA = '".$_POST["FechaInicio"]."' AND b.ACC_TIPO = 1"));
		...
		<div id="content">
			<?php
				...
				$sql = "SELECT APERTURA_CIERRE_CAJA.*, CIERRE_DETALLE.* 
						...
						AND APERTURA_CIERRE_CAJA.ACC_TIPO = 1  $filtroOtro";
				...
				$Query = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
				...
				$Query1 = "SELECT COUNT(F_CODIGO) AS FACTURAS_ANULADAS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_ESTADO = 2";
				...
				$Query3 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_DOLARES FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_LEMPIRAS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 3";
				$Result4 = mysqli_query($db,$Query4);
				while($row4 = mysqli_fetch_array($Result4))
				{
				...
				$Query5 = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 4";
				...
				$Query6 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 3";
				...
				$Query7 = "SELECT SUM(F_TOTAL) AS TOTAL_EFECTIVO FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 1";
				...
				$Query9 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_LEMPIRA FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 3";
				...
				$Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 2";
				...
				$Query11 = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
			...
			<div class="container"> 
					<div class="col-lg-12">
						<div class="panel-group" id="accordion6">
							...
							$Query6P = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial' AND F_TIPO = 3";
							...
							$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial'";
							...
							$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial'";
							...
							$Query3p = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial' AND F_TIPO = 2";
							...
							$Query5P = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS1 FROM Bodega.FACTURA WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial' AND F_TIPO = 4";
											...
											<tbody>
												<?php
													$SqlFacturas = "SELECT FACTURA.* FROM Bodega.FACTURA
																	WHERE FACTURA.F_FECHA_TRANS = '".$_POST["FechaInicio"]."' $FiltroUser
