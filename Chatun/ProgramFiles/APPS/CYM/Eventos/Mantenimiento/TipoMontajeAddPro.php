						...
						<div class="card-body">
							<div class="row">
								<?php
									...
									$Query = mysqli_query($db, "INSERT INTO Bodega.TIPO_MONTAJE(TM_NOMBRE, TM_REFERENCIA, TM_ESTADO)VALUES('".$Nombre."', '".$CodigoUnico."', 1)");
			                        ...
			                        for($i=0; $i<count($_FILES['Fotografia']['name']); $i++) 
			                        {
			                            ...
			                            if ($tmpFilePath != "")
			                            {
			                                ...
			                                $newFilePath = "Images/";
			                                $newFilePath = $newFilePath . uniqid('TM_') . '.' . $extension;
