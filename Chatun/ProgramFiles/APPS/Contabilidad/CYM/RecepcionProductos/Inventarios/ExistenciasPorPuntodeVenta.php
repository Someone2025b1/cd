			...
			<div class="container">
				...
				<div class="card">
					<div class="card-head style-primary">
							<h3 class="text-center"><strong>Existencias Por Punto de Vneta</strong></h3>
						</div>
                        <div class="card-body">
                        <div class="row">
	...
	<script>
		function verDetalle()
		{
            ...
            var Bodega = $("#Bodega").val();
			 ...
			 $.ajax({
				url: 'Ajax/DataReporteGeneralPuntoDeVenta.php',
				type: 'POST',
				data: {Bodega:Bodega,fechaFinal:fechaFinal},
				beforeSend: function()
				{
					$('#GifCargando').show();
				},
