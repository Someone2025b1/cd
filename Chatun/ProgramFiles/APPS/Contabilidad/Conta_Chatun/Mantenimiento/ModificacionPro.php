					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<?php
								...
								$verperiodo= mysqli_query($db, "SELECT TRA_CORRELATIVO, PC_CODIGO FROM Contabilidad.TRANSACCION WHERE TRA_CODIGO = '".$CodigoPoliza."'");
								while ($VerPeriodo1 = mysqli_fetch_array($verperiodo))
								{
									if($VerPeriodo1["PC_CODIGO"]==$Periodo){

										$Correlativo=$VerPeriodo1["TRA_CORRELATIVO"];
								...
								$Query = mysqli_query($db, "UPDATE Contabilidad.TRANSACCION SET TRA_NO_HOJA = '".$Comprobante."', TRA_FECHA_TRANS = '".$Fecha."', PC_CODIGO = ".$Periodo.", TRA_CONCEPTO = '".$Concepto."', TRA_CORRELATIVO = '".$Correlativo."' WHERE TRA_CODIGO = '".$CodigoPoliza."'") or die (mysqli_error()); 
								...
								if($Centinela == true)
								{
									...
									<div class="row">
										<div class="col-lg-6 text-right"><a href="ImpPartida2.php?Codigo='.$UI.'" target="_blank"><button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-print"></span> Imprimir</a></div>
