				...
				****************************************************************************************/
				...
				else
				{
					for($i=0; $i<$Contador; $i++)
					{
						...
						$query = mysqli_query($db, "INSERT INTO Bodega.FACTURA_TQ_DETALLE (F_CODIGO, FD_CODIGO, FD_CANTIDAD, RS_CODIGO, FD_PRECIO_UNITARIO, FD_SUBTOTAL, FD_UNIDADES)
											VALUES('".$Uid."', '".$UidD."', '".$Can."', '".$Pro."', '".$Pre."', '".$Sub."', '".$UnidVn."')") or die('Error Factura TQ Detalle '.mysqli_error());
						}
