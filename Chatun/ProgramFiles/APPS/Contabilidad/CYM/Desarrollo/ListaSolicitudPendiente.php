...
<head>
	...
	<script>
    	...
    	{
            var respuesta = confirm("Estas seguro que quieres cambiar el estado de la Solicitud");
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Lista de Solicitudes de Desarrollo Pendientes</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						...
						<input type="hidden" name="TipoEvento" value="<?php echo $tipodereevento ?>">
							...
							<table class="table table-hover table-condensed" id="tbl_resultados">
								<thead>
                                    ...
                                    <th colspan="3"><strong  align="center"><h6 align="center"> CAMBIAR ESTADO</h1></strong></th>
								</thead>
                                
								<tbody>
								<?php
									$Contador = 1;
									$Consulta = "SELECT * FROM Desarrollo.DESARROLLO AS A WHERE A.ED_ESTADO = 0 ORDER BY A.D_FECHA ";
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										$US = $row['D_USUARIO'];
										    	...
										    	echo '<td><a href="CambiarEstadoSolicitud.php?Codigo='.$Codigo.'&Estado=1"><button type="button" class="btn btn-warning" onclick="return CambiarEstadoSolicitud()">
														     EN PROCESO
														  </button></a>
														</td>';
                                                echo '<td><a href="CambiarEstadoSolicitud.php?Codigo='.$Codigo.'&Estado=2"><button type="button" class="btn btn-success" onclick="return CambiarEstadoSolicitud()">
                                                         LISTA
                                                      </button></a>
                                                    </td>';
                                                echo '<td><a href="CambiarEstadoSolicitud.php?Codigo='.$Codigo.'&Estado=3&Usuario='.$US.'"><button type="button" class="btn btn-danger" onclick="return CambiarEstadoSolicitud()">
                                                     CANCELAR
                                                  </button></a>
                                                </td>';
										    echo '</tr>';
