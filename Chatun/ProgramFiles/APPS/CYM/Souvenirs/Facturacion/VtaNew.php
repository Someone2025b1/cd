...
<head>
	...
	<script>
        function BuscarProducto(x)
        {
				...
				var Inventario = document.getElementsByName('Inventario[]');
		            ...
		            success: function(data) {
		            	...
		            	else
		            	{
			                ...
			                $('.suggest-element').click(function(){
								...
								Existencia[Indice].value = $(this).attr('dataexistencia');
								Inventario[Indice].value = $(this).attr('dataInventario');
		...
		function CalcularTotal()
		{
			...
			{
				if(Precio[i].value>0){
				if(parseFloat(Cantidad[i].value) <= parseFloat(Existencia[i].value)){
				...
				Total = Total + SubTotalCalculado;
					...
					if(Inventario[i].value==1){

					alertify.error('No Hay Existencia Suficiente');
		            		$('#suggestions').html('');
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 2 AND ACC_ESTADO = 2";
								...
								<div class="card">
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="VtaNewPro.php" method="POST" id="FormularioPrincipal">
												...
												<div class="tab-content clearfix">
													...
													<div class="col-lg-3">
														...
														<div class="form-group">
															<div class="col-lg-3">
																<button type="button" class="btn btn-success btn-md" id="btnDes" onclick="AgregarDescuentoPrev()" disabled="disabled">
															...
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	<tr class="fila-base">
																		...
																		<td><h6><input type="hidden" class="form-control" name="Existencia[]" id="Existencia[]" style="width: 100px" min="0" value="0.00"></h6></td>
																		<td><h6><input type="hidden" class="form-control" name="Inventario[]" id="Inventario[]" style="width: 100px" min="0" value="0"></h6></td>
															...
															<div class="row">
																...
																<div class="col-lg-5 text-center">
																	...
																	<select class="form-control" name="TipoTarjeta" id="TipoTarjeta" 	required>
																		<option value="1">Tarjeta de Crédito VisaNet</option>
																		<option value="2">Tarjeta de Débito</option>
																		<option value="3">Tarjeta de Crédito Credomatic</option>
																    </select>
