			...
			<div class="container">
				...
				<form class="form" method="POST" role="form">
					<?php
						...
						$sql = mysqli_query($db, "INSERT INTO Productos.RECETA (R_CODIGO, R_NOMBRE, R_PRECIO, R_TERRAZAS, R_MIRADOR, R_CAFE, R_EVENTO, R_GUARNICION, R_CANTIDAD_BOLAS, R_DESCUENTO)
											VALUES ('".$CodR."', '".$Nombre."', '".$Total."','".$Terrazas."', '".$Mirador."', '".$Cafe."', '".$Evento."', '".$Guarnicion."', '".$CantidadBolas."', '".$Descuento."')");
