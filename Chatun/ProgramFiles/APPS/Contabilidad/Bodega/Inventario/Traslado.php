...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="TrasladoPro.php" method="POST" role="form">
									...
									<div class="col-lg-3">
										<div class="form-group">
											<select name="BodegaEnvia" id="BodegaEnvia" class="form-control" required>
												...
												$query = "SELECT * FROM Bodega.BODEGA ORDER BY B_NOMBRE";
											...
											<label for="BodegaEnvia">Bodega Envia</label>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											<select name="BodegaDestino" id="BodegaDestino" class="form-control" required>
												<option value="" disabled selected>Seleccione una opción</option>
												<?php
	                                                    //Select para obtener los tipos de falta de la base de datos y creación de las opciones del input select
												$query = "SELECT * FROM Bodega.BODEGA ORDER BY B_NOMBRE";
