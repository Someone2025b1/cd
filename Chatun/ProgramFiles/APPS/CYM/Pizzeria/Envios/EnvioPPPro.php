					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							#ESTO ES DE LA POLIZA, ingresa a transación y detallle de transacción
								...
								$QueryEncabezado = mysqli_query($db, "INSERT INTO Productos.EX_PUNTOS_ENVIOS (EPE_CODIGO, EPE_FECHA, EPE_PUNTO, EPE_HORA, EPE_ESTADO, EPE_DESCRIPCION, EPE_USUARIO)
																VALUES ('".$CodEN."',  CURRENT_DATE(), '".$Bodega."', CURRENT_TIMESTAMP(), 0, '".$Descripcion."', '".$UserID."')");
								...
								else
								{
									for($j=1; $j<$Contador; $j++)
									{
										...
										$queryd = mysqli_query($db, "INSERT INTO Productos.EX_PUNTOS_ENVIOS_DET (EPE_CODIGO, EPED_CORRELATIVO, P_CODIGO, EPED_CANTIDAD)
															VALUES('".$CodEN."', '".$j."', '".$Prod."', '".$Can."')");
