	...
	<div id="base">
		...
		<?php
			...
			if($TipoPago == 1)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_SV (F_CODIGO, F_ORDEN, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_FECHA_TRANS, F_HORA, F_USUARIO, F_MONEDA, F_EFECTIVO, F_CAMBIO, F_OBSERVACIONES, RES_NUMERO)
				...
				else
				{
					for($i=1; $i<$Contador; $i++)
					{
						...
						$query = mysqli_query($db, "INSERT INTO Bodega.FACTURA_SV_DETALLE (F_CODIGO, FD_CODIGO, FD_CANTIDAD, P_CODIGO, FD_PRECIO_UNITARIO, FD_SUBTOTAL)
			...
			elseif($TipoPago == 2)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_SV (F_CODIGO, F_ORDEN, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_OBSERVACIONES, F_NO_AUTORIZACION, RES_NUMERO)
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_SV (F_CODIGO, F_ORDEN, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO)
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_SV (F_CODIGO, F_ORDEN, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA)
