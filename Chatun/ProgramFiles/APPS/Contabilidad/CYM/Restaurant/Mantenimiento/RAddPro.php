			...
			<div class="container">
				...
				<form class="form" action="CTAAddPro.php" method="POST" role="form">
					<?php
						...
						if($TipoReceta == 1)
						{
							$sql = mysqli_query($db,"INSERT INTO Bodega.RECETA_SUBRECETA (RS_CODIGO, RS_NOMBRE, CM_CODIGO, RS_TIPO, RS_PRECIO, RS_BODEGA, RS_MODULO)
												VALUES ('".$UI."', '".$Nombre."', ".$Categoria.", ".$TipoReceta.", ".$Precio.", 'TR', 'RS')");
						...
						else
						{
							...
							$sql = mysqli_query($db,"INSERT INTO Bodega.RECETA_SUBRECETA (RS_CODIGO, RS_NOMBRE, CM_CODIGO, RS_TIPO, RS_BODEGA, RS_MODULO)
												VALUES ('".$UI."', '".$Nombre."', ".$Categoria.", ".$TipoReceta.", 'TR', 'RS')");
