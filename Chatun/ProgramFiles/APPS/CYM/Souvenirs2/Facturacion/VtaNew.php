...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 17 AND ACC_ESTADO = 2";
												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														...
														<div class="row">
															<div class="col-lg-12">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Direccion" id="Direccion" value="Ciudad" onkeyup="ComprobarAcentos(this)" readonly required/>
														...
														<div class="form-group">
															<div class="col-lg-3">
																<button type="button" class="btn btn-success btn-md" onclick="AgregarDescuentoPrev()" disabled="disabled">
