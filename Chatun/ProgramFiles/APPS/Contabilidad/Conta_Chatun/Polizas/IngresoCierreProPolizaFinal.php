					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<?php
								...
								$TotalPoliza  = 0;
								$Tipo         = $_POST["Tipo"];
								$CodigoTransaccionP  = $_POST["CodigoTransaccionP"];
								...
								{
									$DetPoli = "SELECT * FROM Bitacoras.POLIZA_CIERRE_DETALLE WHERE TRA_CODIGO ='$CodigoTransaccionP'";
										$resultDet = mysqli_query($db, $DetPoli);
										while($rowdet = mysqli_fetch_array($resultDet))
										{

										$Car = $rowdet["TRAD_CARGO_CONTA"];
										$Abo = $rowdet["TRAD_ABONO_CONTA"];
										$Raz ="";

										$NCue = $rowdet["N_CODIGO"];
