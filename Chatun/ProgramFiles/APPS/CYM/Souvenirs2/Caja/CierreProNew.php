			...
			<div class="container">
				<?php
					...
					if ($TipoCierre==2) 
					{
						...
						$sql = mysqli_query($db,"UPDATE Bodega.APERTURA_CIERRE_CAJA SET ACC_SALDO_FINAL = ".$TotalGeneral.", ACC_ESTADO = 2, ACC_HORA_CIERRE = CURRENT_TIME(), ACC_USUARIO_CIERRE = ".$id_user." WHERE ACC_CODIGO = '".$CodigoCierre."'") or die(mysqli_error($sq));
					...
					$sql1 = mysqli_query($db,"INSERT INTO Bodega.CIERRE_DETALLE (ACC_CODIGO, CD_Q_200, CD_Q_100, CD_Q_50, CD_Q_20, CD_Q_10, CD_Q_5, CD_Q_1, CD_M_1, CD_M_50, CD_M_25, CD_M_10, CD_M_5, CD_TOTAL_Q, CD_D_100, CD_D_50, CD_D_20, CD_D_10, CD_D_5, CD_D_1, CD_TOTAL_D, CD_L_500, CD_L_100, CD_L_50, CD_L_20, CD_L_10, CD_L_5, CD_TOTAL_L, CD_USUARIO)
							VALUES ('".$CodigoCierre."', ".$BQ200.", ".$BQ100.", ".$BQ50.", ".$BQ20.", ".$BQ10.", ".$BQ5.", ".$BQ1.", ".$MQ1.", ".$MQ50.", ".$MQ25.", ".$MQ10.", ".$MQ5.", ".$TCQ.", ".$BD100.", ".$BD50.", ".$BD20.", ".$BD10.", ".$BD5.", ".$BD1.", ".$TCD.", ".$BL500.", ".$BL100.", ".$BL50.", ".$BL20.", ".$BL10.", ".$BL5.", ".$TCL.", ".$id_user.")") or die(mysqli_error($sq));
					}
					
				    elseif ($TipoCierre==1)
					{ 
						$Consulta = "SELECT *FROM Bodega.APERTURA_CIERRE_CAJA a WHERE a.ACC_CODIGO = '$CodigoCierre'";
									$Resultado = mysqli_query($db, $Consulta);
									while($row = mysqli_fetch_array($Resultado))
									{
										$TotalIni=$row["ACC_SALDO_INICIAL"];
									}

									$TCQ=$TCQ-$TotalIni;


						$sql1 = mysqli_query($db,"UPDATE Bodega.APERTURA_CIERRE_CAJA SET ACC_TIENE_PARCIAL=1 WHERE ACC_CODIGO = '".$CodigoCierre."'") or die(mysqli_error($sq));

						$sql = mysqli_query($db,"INSERT INTO Bodega.CIERRE_DETALLE_PARCIAL (ACC_CODIGO, ACCP_CODIGO, ACCP_TOTAL, ACCP_HORA, CD_Q_200, CD_Q_100, CD_Q_50, CD_Q_20, CD_Q_10, CD_Q_5, CD_Q_1, CD_M_1, CD_M_50, CD_M_25, CD_M_10, CD_M_5, CD_TOTAL_Q, CD_D_100, CD_D_50, CD_D_20, CD_D_10, CD_D_5, CD_D_1, CD_TOTAL_D, CD_L_500, CD_L_100, CD_L_50, CD_L_20, CD_L_10, CD_L_5, CD_TOTAL_L, CD_USUARIO)
							VALUES ('".$CodigoCierre."', '".$ACCP."', ".$TotalGeneral.", CURRENT_TIME(), ".$BQ200.", ".$BQ100.", ".$BQ50.", ".$BQ20.", ".$BQ10.", ".$BQ5.", ".$BQ1.", ".$MQ1.", ".$MQ50.", ".$MQ25.", ".$MQ10.", ".$MQ5.", ".$TCQ.", ".$BD100.", ".$BD50.", ".$BD20.", ".$BD10.", ".$BD5.", ".$BD1.", ".$TCD.", ".$BL500.", ".$BL100.", ".$BL50.", ".$BL20.", ".$BL10.", ".$BL5.", ".$TCL.", ".$id_user.")");
