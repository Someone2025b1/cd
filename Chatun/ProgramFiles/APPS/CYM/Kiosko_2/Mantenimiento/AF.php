							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA_KS_2.*, CLIENTE.* 
														FROM Bodega.FACTURA_KS_2, Bodega.CLIENTE 
														WHERE FACTURA_KS_2.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA_KS_2.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA_KS_2.F_NUMERO = ".$_POST["Numero"]."
														ORDER BY FACTURA_KS_2.F_TOTAL ASC";
