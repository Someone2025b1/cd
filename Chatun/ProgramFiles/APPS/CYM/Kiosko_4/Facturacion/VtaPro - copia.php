...
<head>
	...
	<script>
		function Imprimir()
		{
			...
			printJS('<?php $_SERVER['DOCUMENT_ROOT']?>/html/Chatun/ProgramFiles/APPS/CYM/Kiosko_2/Facturacion/FactImp.php?Codigo='+Cod);
				...
				else
				{
					...
					****************************************************************************************/
					...
					$SqlContableD2 = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '4.01.03.005', 0.00, ".number_format($VentaSinIVA, 2, ".", "").")");
				}
