...
for ($cont=2005;$cont<$ano+14;$cont++){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Función que escribe en la página un formulario preparado para introducir una fecha y enlazado con el calendario para seleccionarla comodamente
////////////////////////////////////////////////////////////////////////////////////////////////////////////
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario){
	global $raiz;
	$hoy =  date("dmY") ;
	echo '
	<INPUT type="text" name="'.$nombrecampo.'" size="10" value="">
	<a href="javascript:;" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">	
	<img src="/portal/Script/calendario/calendar.gif" width="20" height="16" >
	</a>
	';	
}

function escribe_formulario_fecha_vacio2($nombrecampo,$nombreformulario, $c){
	global $raiz;
	$hoy =  date("dmY") ;
	echo '
	<INPUT type="text" name="'.$nombrecampo.'" size="10" value="'.$c.'">
	<a href="javascript:;" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')">	
	<img src="../../ProgramFiles/APPS/vehiculos/calendario/calendar.gif" width="20" height="16" />
	</a>
	';	
}
