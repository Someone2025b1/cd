...
$this->Cell(0,0,"-ACERCATE-",0,1,'C');
        ...
        $this->Cell(0,0,"Facturas Emitidas Kiosko Restaurante",0,1,'C');
...
$Consulta1 = "SELECT * FROM Bodega.FACTURA_KS WHERE F_FECHA_TRANS BETWEEN '".$FechaIni."' AND '".$FechaFin."' AND RES_NUMERO = '".$Resolucion."' ORDER BY F_FECHA_TRANS, F_SERIE, F_NUMERO";
$Resultado1 = mysqli_query($db, $Consulta1);
while($row1 = mysqli_fetch_array($Resultado1))
{
$Contador = $i;
$Serie = $row1["F_SERIE"];
$Numero = $row1["F_NUMERO"];
