...
$FechaHoy=date('d-m-Y', strtotime('now'));
?>
							...
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<?php
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										$Puesto = $row["P_CODIGO"];
										$Fecha = $row["ED_FECHA"];
										$FechaLimite = date("d-m-Y",strtotime($Fecha."+ 2 days"));
													...
													echo '<td style="font-size: 8px"><a href="ImpEvaluacion.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-dark">
														...
														echo '<td style="font-size: 8px"><a href="ImpEvaluacionPlanilla.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-dark">
														  ...
														  if($FechaLimite>=$FechaHoy){
															...
															echo '<td style="font-size: 8px"><a href="EditarEvaluacion.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning">
														    <span class="fa fa-pencil"></span>
														  </button></a>

														  ';
														}else{
														echo '<td style="font-size: 24px">Expirado
																</td>';
														}
