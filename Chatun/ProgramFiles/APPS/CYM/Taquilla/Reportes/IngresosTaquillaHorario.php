  ...
  <div class="panel-group" id="accordion">
	...
	<script>
		function verDetalle()
		{
			...
			{
			$.ajax({
				url: 'Ajax/DetalleIngresoTaquillaHora.php',
				type: 'POST',
				data: {mes:mes},
				beforeSend: function()
				{
			...
			{
			 $.ajax({
				url: 'Ajax/GrupIngresosTaquillaHora.php',
				type: 'POST',
				data: {fechaInicial:fechaInicial,fechaFinal:fechaFinal, dia: dia, anio: anio, hora: hora},
				beforeSend: function()
				{
					$('#GifCargando').show();
				},
