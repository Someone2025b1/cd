						...
						<div class="row">
							<div class="col-lg-12">
                                ...
                                <div class="card-head style-primary">
                                    <h4 class="text-center"><strong>Fin de Inventario</strong></h4>
                                    </div>
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="FinalizarInventarioPro.php?Codigo=<?php echo $CodigoInventario ?>" method="POST" role="form" id="FormularioPrincipal" >
														...
														<div class="row">
															<table class="table" name="tabla" id="tabla">
                                                                ...
                                                                FROM Productos.EX_PUNTOS_PEQUENOS AS A,
