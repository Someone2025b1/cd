...
<head>
    ...
    $('select').selectpicker();
		...
		{
			var AbonoFac   = document.getElementsByName('AbonoFac[]');
			var MontoFac = document.getElementsByName('SaldoFac[]');
			var RestaFac = document.getElementsByName('RestaFac[]');
			var Resta = 0;
			var Total = 0;
			var RestaTotalCalculado = 0;
			for(i = 0; i < MontoFac.length; i++)
			{
				if (parseFloat(AbonoFac[i].value)>parseFloat(MontoFac[i].value)){

					AbonoFac[i].value = 0.00.toFixed(2);
					alert('Un Abono no puede ser mayor al monto de la factura pendiente');
					document.AbonoFac[i].value.focus();

				}else{
				RestaTotalCalculado = parseFloat(MontoFac[i].value) - parseFloat(AbonoFac[i].value);
				RestaFac[i].value = RestaTotalCalculado.toFixed(2);
				}
				Total = Total + parseFloat(AbonoFac[i].value);
			}
		...
		function SumaMixto()
		{
			...
			var MontoCheque     = $('#MontoCH').val();
			var MontoExp    = $('#MontoEx').val();
			var TotalSumaM  = 0;
			var MontoAnticipo = 0;
			...
			TotalSumaM =  parseFloat(MontoEfectivo) + parseFloat(MontoTarjeta) + parseFloat(MontoBanco) + parseFloat(MontoAnticipo) + parseFloat(MontoCheque) + parseFloat(MontoExp);
...
if($id_user==53711 | $id_user==22045 | $id_user==435849){
	...
	$CodigoNit=$_GET["Codigo"];
	$Consultac = "SELECT B.*
	FROM Bodega.CLIENTE AS B
	WHERE B.CLI_NIT=$CodigoNit";
	$Resultadoc = mysqli_query($db, $Consultac);
	while($rowc = mysqli_fetch_array($Resultadoc))
	{
		$NombreCliente=$rowc["CLI_NOMBRE"];
		$direccionCli=$rowc["CLI_DIRECCION"];
	}
	?>
								...
								<div class="card">
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="RegistrarPagoPro.php" method="POST" role="form" id="FormularioPrincipal">
												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														...
														<div class="row">
															<div class="col-lg-3">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="NIT" id="NIT" onchange="ComprobarNIT(this.value)" value="<?php echo $CodigoNit ?>" autofocus required readonly/>
															...
															<div class="col-lg-9">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Nombre" id="Nombre" value="<?php echo $NombreCliente ?>" onkeyup="ComprobarAcentos(this)" required readonly  />
														...
														<div class="row">
															<div class="col-lg-12">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Direccion" id="Direccion" value="<?php echo $direccionCli ?>" onkeyup="ComprobarAcentos(this)"  required readonly/>
														...
														<div class="row">
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	...
																	$Consulta = "SELECT A.*, B.CLI_NOMBRE, C.TRA_CONCEPTO, C.TRA_FECHA_HOY
																	...
																	AND A.CC_ESTADO=1
																	$Filtro
																	AND A.CC_NIT=$CodigoNit";
																	$Resultado = mysqli_query($db, $Consulta);
																	while($row = mysqli_fetch_array($Resultado))
																	{
																		
																		$MontoFac        = number_format($row["CC_TOTAL"], 2, ".", "");
																		$SaldoFac        = number_format($row["CC_TOTAL"]-$row["CC_ABONO"], 2, ".", "");

																		$CodigoFac = $row["CC_CODIGO"];               
										    	
																		$ConceptoFactura= $row["TRA_CONCEPTO"];
																		$FechaFacturaaa =$row["TRA_FECHA_HOY"];
																		
																		?>
																		<tr>
							                                                <td><h6><textarea class="form-control" name="DescripcionFac[]" id="DescripcionFac[]" required readonly style="width: 500px"><?php echo $ConceptoFactura ?></textarea></h6></td>
							                                                <input type="hidden" class="form-control" name="CodigoFac[]" id="CodigoFac[]" value="<?php echo $CodigoFac ?>">
							                                                <td><h6><input type="number" class="form-control" name="MontoFac[]" id="MontoFac[]" value="<?php echo $MontoFac ?>" readonly style="width: 100px"></h6></td>
							                                                <td><h6><input type="number" class="form-control" name="SaldoFac[]" id="SaldoFac[]" value="<?php echo $SaldoFac ?>" readonly style="width: 100px"></h6></td>
							                                                <td><h6><input type="number" class="form-control" name="AbonoFac[]" id="AbonoFac[]" value="0.00" onChange="CalcularTotal()" style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
							                                                <td><h6><input type="number" class="form-control" name="RestaFac[]" id="RestaFac[]" value="0.00"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" readonly></h6></td>
							                                            </tr>
							                                            <?php
																	}
																	?>
														...
														<div class="col-lg-2"></div>
															<div class="col-lg-4 text-center">
																		...
																		<div class="input-group">
																			...
																			<option value="" selected disabled>Seleccione Banco Boleta</option>
																			<?php
															...
															<div class="col-lg-3 text-center">
																		...
																		<div class="input-group">
																			<div class="input-group-content">
																			<select name="ChequeM" id="ChequeM" class="form-control">
																			<option value="" selected disabled>Seleccione Banco Cheque</option>
																			<?php

																			$QueryCB = "SELECT B_CODIGO, B_NOMBRE FROM Contabilidad.BANCO ORDER BY B_NOMBRE";
																			$ResultCB = mysqli_query($db, $QueryCB);
																			while($FilaCB = mysqli_fetch_array($ResultCB))
																			{
																				echo '<option value="'.$FilaCB["B_NOMBRE"].'">'.$FilaCB["B_NOMBRE"].'</option>';
																			}
																	...
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="MontoCH" name="MontoCH" onchange="SumaMixto()" value="0.00" step="any" required>
																				<label for="MontoCH">Monto Q.</label>
																		</div>
																		</div>
																		</div>
																	</div>
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="NumeroCheque" name="NumeroCheque" required>
																				<label for="NumeroCheque">No. Cheque</label>
																		</div>
																		</div>
																		</div>
																	</div>
															...
															<div class="col-lg-3 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="ExpIva" name="ExpIva" required value="Retención/Exepción de IVA" readonly>
																	...
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="MontoEx" name="MontoEx" onchange="SumaMixto()" value="0.00" step="any" required>
																				<label for="MontoEx">Monto Q.</label>
																		</div>
																		</div>
																		</div>
																	</div>
...
?>
														...
														<div class="col-lg-2"></div>
															<div class="col-lg-4 text-center">
																		...
																		<div class="input-group">
																			<div class="input-group-content">
																			<select name="CuentaGastoM" id="CuentaGastoM" data-live-search="true" class="selectpicker">
																			<option value="" selected disabled>Seleccione Cuenta Gasto</option>
																			<?php

																			$QueryCB = "SELECT N_CODIGO, N_NOMBRE FROM Contabilidad.NOMENCLATURA WHERE N_CODIGO BETWEEN '6.00.00.000' AND '7.99.99.999' ORDER BY N_NOMBRE";
																			$ResultCB = mysqli_query($db, $QueryCB);
																			while($FilaCB = mysqli_fetch_array($ResultCB))
																			{
																				echo '<option value="'.$FilaCB["N_CODIGO"].'">'.$FilaCB["N_CODIGO"].'/'.$FilaCB["N_NOMBRE"].'</option>';
																			}
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="MontoGasto" name="MontoGasto" onchange="SumaMixto()" value="0.00" step="any" required readonly>
																				<label for="MontoGasto">Monto Q.</label>
																		</div>
																		</div>
																		</div>
																	</div>
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="ObservacionGasto" name="ObservacionGasto" required>
																				<label for="ObservacionGasto">Observaciones</label>
																		</div>
																		</div>
																		</div>
																	</div>
