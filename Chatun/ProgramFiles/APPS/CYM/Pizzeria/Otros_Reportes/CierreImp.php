...
$Cod = mysqli_fetch_array(mysqli_query($db, "SELECT a.ACC_CODIGO  FROM Bodega.APERTURA_CIERRE_CAJA a WHERE a.ACC_FECHA = CURDATE() AND a.ACC_TIPO = 22"));
