...
$this->Cell(0,0,"-ACERCATE-",0,1,'C');
        ...
        $this->Cell(0,0,"Facturas Emitidas Terrazas",0,1,'C');
...
$SQLResolucion = "SELECT RES_NUMERO FROM Bodega.FACTURA GROUP BY RES_NUMERO";
...
$Consulta1 = "SELECT * FROM Bodega.FACTURA WHERE F_FECHA_TRANS BETWEEN '".$FechaIni."' AND '".$FechaFin."' AND RES_NUMERO = '".$Resolucion."' ORDER BY F_FECHA_TRANS, F_SERIE, F_NUMERO";
