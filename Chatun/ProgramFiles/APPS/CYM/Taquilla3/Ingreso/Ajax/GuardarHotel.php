...
$TotalAdultoM = $cantAdultoM * $PrecioNino["Precio"];
...
VALUES('$nombreHotel', $adultos, $cantNinos, $cantMen, $cantAdultoM, $vale, '$fechaHotel', $id_user, $PrecioAdulto[Precio], $PrecioNino[Precio], $PrecioNino[Precio], $TotalAdulto, $TotalNino, $TotalAdultoM, $Total)");
