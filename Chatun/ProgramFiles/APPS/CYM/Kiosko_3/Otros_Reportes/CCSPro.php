	...
	<div id="base">
		...
		<div id="content">
			<?php
				...
				$Query3 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_TIPO = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_DOLARES FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_TIPO = 1 AND F_MONEDA = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_LEMPIRAS FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_TIPO = 1 AND F_MONEDA = 3";
				$Result4 = mysqli_query($db,$Query4);
				while($row4 = mysqli_fetch_array($Result4))
				{
				...
				$Query5 = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_TIPO = 4";
				...
				$Query6 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_TIPO = 3";
				...
				$Query7 = "SELECT SUM(F_TOTAL) AS TOTAL_EFECTIVO FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_MONEDA = 1";
				...
				$Query9 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_LEMPIRA FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_MONEDA = 3";
				...
				$Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_MONEDA = 2";
				...
				$Query11 = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = '".$Fecha."'";
								...
								<div id="accordion6-3" class="collapse" aria-expanded="false" style="height: 0px;">
									<div class="card-body">
										<table class="table" id="tbl_resultados">
											...
											<tbody>
												<?php
													$SqlFacturas = "SELECT * FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = CURRENT_DATE() ORDER BY F_SERIE, F_NUMERO";
