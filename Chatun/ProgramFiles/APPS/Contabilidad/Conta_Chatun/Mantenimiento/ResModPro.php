	...
	?>
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<?php
					$sql = mysqli_query($db, "UPDATE Bodega.RESOLUCION SET RES_ESTADO = ".$Estado." WHERE RES_NUMERO = '".$Codigo."'");
					...
					if(!$sql) //Si el query tuvo algún problema que despligue error y que la ejecución del código se detenga
					{
						...
						echo '<div class="col-lg-12 text-center">
								...
								<h2 class="text-light">Lo sentimos, no se pudo modificar la resolución.</h2>
					...
					else
					{
							...
							echo '<div class="col-lg-12 text-center">
								...
								<h2 class="text-light">La resolución se modificó correctamente.</h2>
								<div class="row">
