...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA_PIZZA WHERE F_SERIE = '".$Serie."' ORDER BY F_NUMERO DESC LIMIT 1";
	...
	$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA_PIZZA WHERE F_FECHA_TRANS = CURRENT_DATE() ORDER BY F_ORDEN DESC LIMIT 1";
...
WHERE A.ACC_FECHA = CURRENT_DATE() AND ACC_TIPO = 22";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_TIPO = 22 AND ACC_ESTADO = 2";
