							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA.*, CLIENTE.* 
														FROM Bodega.FACTURA, Bodega.CLIENTE 
														WHERE FACTURA.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA.F_NUMERO = ".$_POST["Numero"]."
														ORDER BY FACTURA.F_TOTAL ASC";
