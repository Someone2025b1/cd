                                ...
                                <dte:SAT ClaseDocumento="dte">
                                  <dte:DTE ID="DatosCertificados">
                                    <dte:DatosEmision ID="DatosEmision">
                                      <dte:DatosGenerales CodigoMoneda="GTQ" FechaHoraEmision="'.$FechaHoraHoy.'" NumeroAcceso="100000000" Tipo="NDEB"></dte:DatosGenerales>
                                  ...
                                  {  
                                    ...
                                    $FechaCertificacion = $responseCerti->body->fecha;
									   ...
									   $QuerySaberPeriodo = "SELECT PC_CODIGO FROM Contabilidad.PERIODO_CONTABLE WHERE PC_MES = ".$Mes." AND PC_ANHO = ".$Anho;
										...
										$SqlBodega = mysqli_query($db, "INSERT INTO Bodega.TRANSACCION(TRA_CODIGO, TRA_FECHA_TRANS, B_CODIGO, E_CODIGO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, TT_CODIGO, TRA_OBSERVACIONES, F_CODIGO)VALUES('".$Uid."', CURRENT_DATE(), ".$Bodega.", 1, CURRENT_DATE, CURRENT_TIME(), ".$id_user.", 13, 'Nota de Débito por anulación de Nota de Crédito', '".$CodigoFactura."')");

										$SqlBodegaDetalle = mysqli_query($db, "INSERT INTO Bodega.TRANSACCION_DETALLE (TRAD_CODIGO, TRA_CODIGO, P_CODIGO, TRAD_ABONO_PRODUCTO)
																			SELECT '".$Uid."', '".$Uid."', A.P_CODIGO, A.TRAD_CARGO_PRODUCTO
																			FROM Bodega.TRANSACCION_DETALLE AS A
																			WHERE A.F_CODIGO = '".$CodigoFactura."'");

									   $SqlContable = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_TOTAL, TRA_CORRELATIVO, PC_CODIGO, TRA_DTE, TRA_CAE, TRA_TABLA_FACTURA_NOTA_CREDITO, TRA_FACTURA_NOTA_CREDITO_AFECTADA)
											 
											 VALUES('".$Uid."', CURRENT_DATE(), '".$Observaciones."',  CURRENT_DATE(), CURRENT_TIME(), ".$id_user .", 2, 18, ".$TotalTransaccion.", ".$Correlativo.", ".$Periodo.", '".$AutorizacionNotaCredito."', '".$SerieNotaCredito."-".$NumeroNotaCredito."', '".$Tabla."', '".$CodigoTransaccion."')") or die(mysqli_error());
									   ...
									   ?>
									   	<div class="row text-center">
											<div class="col-lg-12 text-center">
												...
												<h2 class="text-light">La Nota de Débito se ingresó con Éxito.</h2>
												<div class="row">
