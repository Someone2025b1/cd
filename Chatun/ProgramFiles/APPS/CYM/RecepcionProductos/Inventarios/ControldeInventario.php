                                ...
                                <div class="card-head style-primary">
									...
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="ControldeInventarioPro.php" method="POST" role="form" id="FormularioPrincipal" >
									...
									<div class="col-lg-6 col-lg-6">
										<div class="form-group">
											<select name="Bodega" id="Bodega" class="form-control" required>
												...
												$query = "SELECT * FROM CompraVenta.PUNTO_VENTA WHERE (PV_CODIGO=1 OR PV_CODIGO=3 OR PV_CODIGO=4) ORDER BY PV_NOMBRE";
																...
																<tbody>
																	<tr class="fila-base">
						                                                ...
						                                                <td><h6><input type="hidden" class="form-control" name="Producto[]" id="Producto[]"></h6>
						                                                	<h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 800px" onchange="BuscarProducto(this)"></h6></td>
