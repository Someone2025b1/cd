							...
							while($rowe = mysqli_fetch_array($resultsa))
							{
								...
								if($Envia=="BODEGA GENERAL"){
									...
									while($rowpr = mysqli_fetch_array($resultpr))
									{
										...
										$newcantsou=$rowpr["P_EXISTENCIA_KIOSCO"]+$CAN;
										$existenciasou=$rowpr["P_EXISTENCIA_KIOSCO"];
									...
									$QueryPU = mysqli_query($db, "UPDATE Productos.PRODUCTO SET
														...
														P_EXISTENCIA_KIOSCO = '".$newcantsou."'
														WHERE P_CODIGO = ".$Pro);
								...
								VALUES('".$KCod."', '".$CodEN."', '".$Pro."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Envío de producto interno de ".$Envia." a Kiosco Azados', '".$existenciagen."', '".$existenciagen."', 6, '".$existenciasou."', '".$newcantsou."', '-', '-', '-')");
								...
								VALUES('".$KCod."', '".$CodEN."', '".$Pro."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Envío de producto interno de ".$Envia." a Kiosco Azados', '".$existenciagen."', '".$existenciagen."', '".$Pun."', '".$existenciabode."', '".$newcantbo."', '-', '-', '".$ponderado."')");
