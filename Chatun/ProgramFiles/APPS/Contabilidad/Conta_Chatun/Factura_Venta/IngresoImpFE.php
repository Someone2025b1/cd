...
while($row = mysqli_fetch_array($Resultado))
{
    ...
    $Contabilizo            =$Usuario;
    $NombreContabilizo      = saber_nombre_colaborador($Usuario);
    $Puesto                 = saber_puesto($Usuario);
...
$pdf->Cell(0,0, "Fecha de Factura: ".$Fecha."                     Serie: ".$Serie."   Número: ".$Del,0,1,'L');
$pdf->Cell(0,0, "Concepto:              Factura Especial por ".$Concepto,0,1,'L');
$pdf->Cell(150,7, "",0,1,'R');
