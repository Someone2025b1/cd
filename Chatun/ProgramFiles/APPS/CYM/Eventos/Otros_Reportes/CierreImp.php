...
$Cod = mysqli_fetch_array(mysqli_query($db, "SELECT a.ACC_CODIGO  FROM Bodega.APERTURA_CIERRE_CAJA a WHERE a.ACC_FECHA = CURDATE() AND a.ACC_TIPO = 8"));
...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->Cell(0,0, "CAJA EVENTOS" ,0,1,'C');
    }
}
//***********************************************************
//***********************************************************
