...
<head>
	...
	function EnviarForm()
	{
        ...
        $(Formulario).attr('action', 'ConsultarControlesPro.php');
        $(Formulario).submit();
		}
	</script>
					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Consulta de Controles Inventarios</strong></h4>
							</div>
							<?php
							...
							<?php
								}else
								{
									echo '<div class="col-lg-12 text-center">
											...
											<h2 class="text-light">Lo sentimos Usted, no pudo ingresar a los Cotroles de Inventario.</h2>
										</div>';
