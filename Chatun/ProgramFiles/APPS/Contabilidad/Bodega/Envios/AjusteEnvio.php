                                ...
                                <div class="row">
                                    <table class="table" name="tabla" id="tabla">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $Pro = $row['P_CODIGO'];
                                                    $ListEvento = mysqli_query($db, "SELECT a.P_CODIGO, a.P_NOMBRE, a.P_EXISTENCIA_BODEGA FROM Productos.PRODUCTO a WHERE a.P_CODIGO =".$Pro);
												while ($RowEvento = mysqli_fetch_array($ListEvento))
												{
													$Producto =$RowEvento["P_CODIGO"]."/". $RowEvento["P_NOMBRE"];
													$ExistenciaBo =number_format($RowEvento["P_EXISTENCIA_BODEGA"]);
