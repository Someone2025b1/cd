					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Facturas Emitidas Souvenirs</strong></h4>
							</div>
							<div class="card-body">
								...
								<div class="col-lg-12" align="center">
									<button type="button" onclick="VerReporte()" class="btn ink-reaction btn-raised btn-primary" id="btnGuardar">Consultar</button>
								</div>
							</div>
						</div>
					</div>
		...
		<?php include("../MenuUsers.html"); 
		 ...
		 <script>
		 	...
		 	function VerReporte()
		 	{
		 		...
		 		if (TipoReporte==1) 
		 		{
			 	    window.location.href = 'FSImp.php?FechaInicio='+FechaInicio+'&FechaFin='+FechaFin;
				}
				else
				{
					window.location.href = 'FSSistema.php?FechaInicio='+FechaInicio+'&FechaFin='+FechaFin;
				}
		 	}
