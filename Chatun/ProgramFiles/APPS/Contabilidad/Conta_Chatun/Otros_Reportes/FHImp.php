...
$this->Cell(0,0,"-ACERCATE-",0,1,'C');
        ...
        $this->Cell(0,0,"Facturas Emitidas Helados",0,1,'C');
...
$SQLResolucion = "SELECT RES_NUMERO FROM Bodega.FACTURA_HS GROUP BY RES_NUMERO";
...
$Consulta1 = "SELECT * FROM Bodega.FACTURA_HS WHERE F_FECHA_TRANS BETWEEN '".$FechaIni."' AND '".$FechaFin."' AND RES_NUMERO = '".$Resolucion."' ORDER BY F_FECHA_TRANS, F_SERIE, F_NUMERO";
...
$SumaTotalTotal1 = 'Q. '.number_format($SumaTotalTotal, 2, '.', ',');
$tbl1 .= <<<EOD
    <tr>
    <td></td>
    <td></td>
    <td>TOTAL</td>
    <td>$SumaTotalTotal1</td>
    <td></td>
    </tr>
EOD;
