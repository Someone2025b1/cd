			...
			<div class="container">
				...
				<form class="form" action="CTAAddPro.php" method="POST" role="form">
					<?php
						...
						if(isset($_POST["Nomenclatura"]))
						{
							$sql = mysqli_query($db, "INSERT INTO Bodega.PRODUCTO (P_NOMBRE, P_STOCK_MINIMO, CP_CODIGO, UM_CODIGO, P_PRECIO, P_CODIGO_BARRAS, N_CODIGO)
											VALUES ('".$Nombre."', ".$StockMinimo.", '".$Categoria."', ".$UnidadMedida.", ".$Precio.", '".$CodigoBarras."', '".$CodigoContable."')");
						}
						else
						{
