					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Query = mysqli_query($db, "INSERT INTO Productos.INVENTARIO(I_CODIGO, I_PUNTO, I_FECHA, I_HORA, I_OBSERVACIONES, I_USER, I_ESTADO)
											VALUES ('".$UI."', ".$Bodega.", CURRENT_DATE(), CURRENT_TIMESTAMP(), '".$Observaciones."', '".$id_user."', 0)");
								...
								//QUERY PARA TRAER TODO EL MOVIMIENTO DE LAS CUENTAS EN EL RANGO DE FECHAS SELECCIONADO
										$QueryCuentas = "SELECT PRODUCTO.*, UNIDAD_MEDIDA.UM_NOMBRE 
										                FROM Productos.PRODUCTO, Bodega.UNIDAD_MEDIDA 
										                WHERE PRODUCTO.UM_CODIGO = UNIDAD_MEDIDA.UM_CODIGO
										                AND PRODUCTO.P_CAFE = 1
										                AND PRODUCTO.P_LLEVA_EXISTENCIA=1
										                ORDER BY PRODUCTO.P_CODIGO";
									...
									$QueryDetalle = mysqli_query($db, "INSERT INTO Productos.INVENTARIO_DETALLE(I_CODIGO, ID_CODIGO, P_CODIGO, ID_CANTIDAD_CONTADA)
																	VALUES('".$UI."', '".$UID."', ".$Producto.", 0)");
								}
								...
								else
								{
									echo '<div class="col-lg-12 text-center">
										...
										<h2 class="text-light">Lo sentimos, no se pudo procesar el conteo.</h2>
									</div>';
								}
