...
function CalcularTotal()
        {
            ...
            { 
                ...
                PrecioP[i].value = TotalSI.toFixed(2);
                TotalPeces = TotalPeces + TotalSI;
            }  
                     ...
                     <tr class="fila-base1">  
                        ...
                        <td> 
                            <div class="form-group">
                                ...
                                <input placeholder=" " class="form-control" step="any" type="number" min="1" name="PrecioTo[]" id="PrecioTo" />
                            </div> 
                        </td>
                        <td> 
                            <div class="form-group">
                                <label for="Capacidad">Total sin IVA</label>
                                <input placeholder=" " class="form-control" step="any" type="number" min="1" name="PrecioP[]" id="PrecioP" />
                            </div> 
                        </td>
                        <td class="eliminar1">
                            <button type="button" class="btn btn-danger btn-xs">
