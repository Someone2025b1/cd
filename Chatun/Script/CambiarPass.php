			...
			<div class="card-body">
				<div class="content-fluid">
					<div class="col-sm-6" style="left: 150px;" align="center" id="pwd-container">
						<br/>
						<br/>
						<h3><span class="text-lg text-bold text-primary text-center" style="font-size: 18px">Cambio de Contraseña</span></h3>
						<br/>
						<form class="form floating-label" action="CambiarPassPro.php"  accept-charset="utf-8" method="post">
							<div class="form-group">
								<input type="password" class="form-control" id="passwordactual" name="passwordactual" autofocus required>
							...
							<div class="form-group">
								...
								<label for="passwordconfimacion">Confirmar Contraseña Nueva</label>
							</div>
							<div class="form-group">
							...
							<div class="row">
								<div class="col-xs-12 text-center">
									<button class="btn btn-primary btn-raised" type="submit" disabled id="btnActualizar">Cambiar Contraseña</button>
								</div><!--end .col -->
							</div><!--end .row -->
						</form>
					</div><!--end .col -->
