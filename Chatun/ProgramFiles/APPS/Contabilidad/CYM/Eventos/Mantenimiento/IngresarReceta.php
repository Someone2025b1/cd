	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<form class="form" method="POST" role="form" id="FormularioEnviar" onkeypress="return anular(event)">
					<div class="col-lg-12">
						<div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <table class="table" name="tabla" id="tabla">
                                        ...
                                        <tbody>
                                            <tr class="fila-base">
                                                <td><h6><input type="number" class="form-control" name="Cantidad[]" id="Cantidad[]" onChange="CalcularTotal()" style="width: 100px" min="0" required readonly></h6></td>
                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 500px" onchange="BuscarProducto(this)" required readonly></h6></td>
                                                <td><h6><input type="number" class="form-control" name="Costo[]" id="Costo[]"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" readonly required readonly></h6></td>
                                                <td><h6><input type="number" class="form-control" name="SubTotal[]" id="SubTotal[]" onChange="CalcularTotal()" style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" required readonly></h6></td>
