...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaSerie = "SELECT RES_SERIE, RES_NUMERO FROM Bodega.RESOLUCION WHERE RES_ESTADO = 1 AND RES_TIPO = 'SV'";
	...
	$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA_SV_2 WHERE F_SERIE = '".$Serie."'  ORDER BY F_NUMERO DESC LIMIT 1";
	...
	{
		$ConsultaNumeroFacturaInicial = "SELECT RES_DEL FROM Bodega.RESOLUCION WHERE RES_ESTADO = 1 AND RES_TIPO = 'SV'";
	...
	$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA_SV_2 WHERE F_FECHA_TRANS = CURRENT_DATE ORDER BY F_ORDEN DESC LIMIT 1";
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 17";
	...
	echo '<input type="hidden" id="TasaCambioDolar" value="'.$TasaCambioDolar.'" >';
	echo '<input type="hidden" id="TasaCambioLempira" value="'.$TasaCambioLempira.'" >';
								...
								<div class="card">
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="VtaPro.php" method="POST">
												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														...
														<div class="row">
															...
															<div class="col-lg-3">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Nombre" id="Nombre" value="C/F"  required/>
														...
														<input class="form-control" type="hidden" name="DescuentoCodigo" id="DescuentoCodigo" value="2" required/>
																	...
																	<div class="form-group">
																		<div class="input-group">
																			...
																			<div class="input-group-content">
																				...
																				<input type="text" class="form-control" id="NombreMonedaPago" name="NombreMonedaPago" value="Quetzales" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">Q.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalFacturaCobrarEfectivoQuetzales" name="TotalFacturaCobrarEfectivoQuetzales" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">Q.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalEfectivo" name="TotalEfectivo" onchange="CalcularCambio()" >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">$.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="NombreMonedaPago" name="NombreMonedaPago" value="Dólares"  readonly >
																				<label for="NombreMonedaPago">Moneda</label>
																			</div>
																		</div>
																	</div>
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">Q.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalFacturaCobrarEfectivoDolares" name="TotalFacturaCobrarEfectivoDolares" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">$.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalFacturaCobrarEfectivoDolaresQuetzalizado" name="TotalFacturaCobrarEfectivoDolaresQuetzalizado" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">$.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalEfectivoDolares" name="TotalEfectivoDolares" onchange="CalcularCambioDolares()" >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">Q.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="CambioDolaresQuetzalizados" name="CambioDolaresQuetzalizados" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			...
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="NombreMonedaPago" name="NombreMonedaPago" value="Lempira"  readonly >
																				<label for="NombreMonedaPago">Moneda</label>
																			</div>
																		</div>
																	</div>
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">Q.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalFacturaCobrarEfectivoLempira" name="TotalFacturaCobrarEfectivoLempira" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">L.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalFacturaCobrarEfectivoLempiraQuetzalizado" name="TotalFacturaCobrarEfectivoLempiraQuetzalizado" readonly >
																...
																<div class="col-lg-2 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<span class="input-group-addon">L.</span>
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TotalEfectivoLempira" name="TotalEfectivoLempira" onchange="CalcularCambioLempiras()" >
														...
														<div class="col-lg-12" id="FormaPagoDeposito" style="display: none">
															...
															<div class="row">
																...
																<div class="col-lg-4 text-center">
																	<div class="form-group">
																		<select name="CuentaBancaria" id="CuentaBancaria" class="form-control">
		...
		<div class="modal-dialog" style="width: 50%">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					$query = "SELECT * FROM Bodega.DESCUENTO WHERE D_TIPO = 2 ORDER BY D_NOMBRE";
