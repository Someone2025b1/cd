						...
						<div class="card">
							...
							<?php
								...
								{ 
                                    ...
                                    $query = mysqli_query($db, "INSERT INTO Contabilidad.DETALLE_NOTA_CREDITO (DNC_CODIGO, TRA_CODIGO, DNC_CANTIDAD, DNC_DESCRIPCION, DNC_PRECIO, DNC_SUBTOTAL)
															VALUES('".$UIDFE."', '".$Uid."', ".$Cantidad[$i].", '".$NombreProducto[$i]."', ".$PrecioUnitario[$i].", ".$Total[$i].")");
									   ...
									   ?>
									   	<div class="row text-center">
											<div class="col-lg-12 text-center">
												...
												<div class="row">
													<div class="col-lg-6 text-center"><a href="NotaCredImp.php?Codigo=<?php echo $Uid ?>"><button type="button" class="btn btn-info btn-xs"><span class="glyphicon glyphicon-chevron-right"></span>Imprimir</a></div>
