                                   ...
                                   data-filter-control="true">
									...
									<tbody>
										<?php
											...
											JOIN Bodega.FACTURA_RS_DETALLE AS C ON  C.F_CODIGO = A.F_CODIGO
											...
											while($FilaDetalle = mysqli_fetch_array($QueryDescuentos))
											{
												...
												if($codf != $FilaDetalle["F_CODIGO"]){
													...
													H.FD_DESCUENTO, H.FD_CANTIDAD, H.FD_SUBTOTAL, I.RS_NOMBRE
													FROM Bodega.FACTURA_RS_DETALLE AS H
													JOIN Bodega.RECETA_SUBRECETA AS I ON H.RS_CODIGO = I.RS_CODIGO 
													...
													while($FilaDetalledes = mysqli_fetch_array($QueryDetalleDescuentos))
													{
														if($encabezado==0){
															...
															<tr>
																...
																<td align="center"></td>
																<td align="center"></td>
																<td align="center"><?php echo $FilaDetalledes["RS_NOMBRE"] ?></td>
