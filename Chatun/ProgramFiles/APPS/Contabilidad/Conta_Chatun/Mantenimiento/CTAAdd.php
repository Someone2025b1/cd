					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Datos Generales de la Cuenta Bancaria</strong></h4>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-lg-4">
										<div class="form-group floating-label" id="DIVCIF">
											<input class="form-control" type="text" name="CodigoCuenta" id="CodigoCuenta" required/>
											<label for="CodigoCuenta">Número de la Cuenta</label>
										</div>
									</div>
								</div>
								<div class="row">
