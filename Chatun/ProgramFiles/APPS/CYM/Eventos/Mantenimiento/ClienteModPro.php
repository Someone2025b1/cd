						...
						<div class="card-body">
							<div class="row">
								<?php
									...
									$Query = mysqli_query($db, "UPDATE Bodega.CLIENTE_EVENTO SET CE_NOMBRE = '".$Nombre."', CE_DIRECCION = '".$Direccion."', CE_CELULAR = '".$Celular."', CE_TELEFONO = '".$Telefono."', CE_EMAIL = '".$Email."' WHERE CE_CODIGO = ".$Codigo);


			                        echo '<div class="col-lg-12 text-center">
											<h1><span class="text-xxxl text-light">Bien! <i class="fa fa-check-circle text-success"></i></span></h1>
											<h2 class="text-light">El Cliente se modificó correctamente.</h2>
											<div class="row">
