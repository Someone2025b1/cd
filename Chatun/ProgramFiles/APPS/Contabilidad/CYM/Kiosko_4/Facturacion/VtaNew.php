...
<head>
	...
	<script>
		...
		function BuscarProducto(x)
        {
		        ...
		        var Descuento = document.getElementsByName('SiDescuento[]');
		        var Cantidad = document.getElementsByName('Cantidad[]'); 
				var TipoProd = document.getElementsByName('TipoProd[]');
		        var service = x.value;
				var llevad ="";
		            ...
		            success: function(data) {
		            	...
		            	else
		            	{
			                ...
			                $('.suggest-element').click(function(){
								...
								TipoProd[Indice].value = $(this).attr('dataDonde');

								if($(this).attr('dataDescuento')==1){

									llevad="SI";
								}else{
									llevad="NO";
								}
			                    Descuento[Indice].value = llevad;
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaApertura = "SELECT A.ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA A 
WHERE A.ACC_FECHA = CURRENT_DATE() AND ACC_TIPO = 18";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_TIPO = 18 AND ACC_ESTADO = 2";
															...
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	<tr class="fila-base">
						                                                ...
						                                                <td><h6><input type="hidden" class="form-control" name="Producto[]" id="Producto[]"> <input type="hidden" class="form-control" name="TipoProd[]" id="TipoProd[]"></h6>
						                                                ...
						                                                <td><h6><input type="text" class="form-control" name="SiDescuento[]" id="SiDescuento[]"  style="width: 100px" style="text-align: right" readonly></h6></td>
						                                                <td class="eliminar">
