...
<body class="menubar-hoverable header-fixed menubar-pin ">
				...
				<form class="form" role="form" id="FRMReporte" action="#" method="GET">
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-4"><label class="control-label">Fecha Inicial</label><input value="<?php echo $inicio?>" type="date" class="form-control" id="FechaInicial" name="FechaInicial"></div>
									<div class="col-md-4"><label class="control-label">Fecha Final</label><input type="date" class="form-control" id="FechaFinal" name="FechaFinal" value="<?php echo $fin?>"></div>
									<div class="col-md-4"> 
                                            <?php 
	...
	<script>
		function VerDetalle(IdEstanque)
		{
			...
			$.ajax({
			 	url: 'AJAX/DetalleIngreso.php',
			 	type: 'POST',
			 	dataType: 'html',
			 	data: {IdEstanque:IdEstanque, FechaInicial: FechaInicial, FechaFinal: FechaFinal},
