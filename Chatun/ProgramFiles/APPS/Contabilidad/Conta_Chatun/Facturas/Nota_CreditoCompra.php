	...
	function SelProveedor(x)
		...
		function LlenarPartida(x)
		{
			...
			else
			{
				...
				Cargos[3].value = x.value; 
				Abonos[1].value = TotalDeposito;
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="Nota_CreditoPro.php" method="POST" role="form" id="FormAEnviar">
					<div class="col-lg-12">
						<br>
						<div class="card">
								...
								<div class="row">
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<label for="Factura">No. de Nota de Crédito</label>
										</div>
									</div> 
								</div>
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											...
											<label for="Fecha">Fecha Nota de Crédito</label>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="row">
										<div class="col-lg-3 col-lg-9">
											<div class="form-group floating-label">
												...
												<label for="TotalFactura">Total de Nota de Crédito</label>
											</div>
										</div>
									</div>
								</div>
