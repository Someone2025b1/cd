...
<script>
		            ...
		            success: function(data) {
		            	...
		            	else
		            	{
			                ...
			                $('.suggest-element').click(function(){
			                    x.value = $(this).attr('id')+"/"+$(this).attr('data')+" Medida "+$(this).attr('UM');
		...
		function EnviarForm()
	{
		...
		$(Formulario).attr('action', 'NuevoPedidoPro.php');
		$(Formulario).submit();
					...
					<div>
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Nueva Solicitud de Compra de Producto</strong></h4>
							</div>
                            <div class="card-body">
                                <div class="row">
							<div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <table class="table" name="tabla" id="tabla">
                                        ...
                                        <tbody>
                                            <tr class="fila-base">
                                            <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 400px" onchange="BuscarProducto(this)" required></h6></td>
												...
												<td><textarea class="form-control" style="width: 400px" name="DescripcionProd[]" id="DescripcionProd[]" ></textarea></td>
                                                <td class="eliminar">
