...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA_SV WHERE F_SERIE = '".$Serie."'  ORDER BY F_NUMERO DESC LIMIT 1";
	...
	$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA_SV WHERE F_FECHA_TRANS = CURRENT_DATE ORDER BY F_ORDEN DESC LIMIT 1";
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 2";
