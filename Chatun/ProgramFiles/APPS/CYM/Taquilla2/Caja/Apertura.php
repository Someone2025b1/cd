					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Consulta = "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_ESTADO = 1 AND ACC_TIPO = 15";
								...
								$ConteoApertura = mysqli_num_rows(mysqli_query($db, "SELECT *FROM Bodega.APERTURA_CIERRE_CAJA a 
										...
										WHERE a.ACC_FECHA = CURDATE() AND a.ACC_TIPO = 15 "));

								if($ConteoApertura < 2)
								{	

									$Query = "SELECT ACC_FECHA FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_ESTADO = 1 AND ACC_FECHA < CURRENT_DATE() AND ACC_TIPO = 15";
