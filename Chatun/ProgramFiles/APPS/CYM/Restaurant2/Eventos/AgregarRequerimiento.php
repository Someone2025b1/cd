...
$queryRequerimiento = mysqli_query($db, "INSERT INTO Eventos.EV_PRODUCTOS_AYB (EV_CODIGO, EV_CODIGO_REQUERIMIENTO, EV_CANTIDAD, P_CODIGO, EV_FECHA_ESPERADA, EV_FECHA_SOLICITO, EV_HORA_PEDIDO, EV_FECHA_LIMITE, EV_ESTADO, EV_OBSERVACIONES_P)
