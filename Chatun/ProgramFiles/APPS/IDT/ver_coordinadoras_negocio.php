...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tamano14">
  ...
  <tr align="center" class="Negrita">
    ...
    <th width="86%" colspan="3" class="Tamano24"> COORDINADORAS DE NEGOCIO</th>
    </tr>
  <tr align="center" class="Negrita">
    <td colspan="4"><hr></td>
    </tr>
...
<?php
	$sql = "SELECT T_Agencias.id_agencia, T_Agencias.agencia, T_Coordinadoras.id_user, T_Usuarios.nombre FROM ".$base_general.".agencias AS T_Agencias LEFT JOIN ".$base_general.".coordinadores_negocios AS T_Coordinadoras ON T_Agencias.id_agencia = T_Coordinadoras.id_agencia LEFT JOIN ".$base_bbdd.".usuarios AS T_Usuarios ON T_Usuarios.id_user = T_Coordinadoras.id_user";
...
<table width="35%" border="1" align="center" cellpadding="0" cellspacing="0" class="Tamano14" id="Cajero_Generales">
  <tr align="center" bgcolor="#FFFF99">
    ...
    <td width="50%">Coordinadora de Negocio</td>
    <td width="1%">&nbsp;</td>
    </tr>
<?php
...
?>
  <tr>
    ...
    <td><a href="definir_coordinadoras_negocio.php?centinela=0&agencia=<?php echo $row["id_agencia"]; ?>"><img src="Imagenes/edit.png" alt="Editar..." width="16" height="16" border="0"></a></td>
  </tr>
<?php
	}
?>
