...
<?php
$sql = mysqli_query($db, "SELECT A.id_aplicacion, B.nombre, C.nivel, B.estado, C.id_nivel FROM ".$base_general.".define_aplicaciones_predeterminados AS A JOIN ".$base_bbdd.".aplicaciones AS B ON A.id_aplicacion = B.id_aplicacion JOIN ".$base_bbdd.".define_nivel AS C ON A.id_nivel = C.id_nivel ORDER BY B.nombre ASC") or die (mysqli_error());
?>
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tamano14">
  ...
  <tr align="center" class="Negrita">
    <td width="14%"><img src="Imagenes/database.png" width="64" height="64" alt="Definir Cajero General"></td>
    <th width="86%" colspan="3" class="Tamano24">APLICACIONES PREDETERMINADAS </th>
    </tr>
  <tr align="center" class="Negrita">
    <td colspan="4"><hr></td>
    </tr>
...
?>
  <tr>
    ...
    <td align="center"><a href="<?php echo $_SERVER['PHP_SELF'].'?centinela=3&idaplicacion='.$row[0] ?>" onClick="return confirmar('esta aplicacion')"><img src="Imagenes/borrar.png" alt="" width="16" height="16" border="0"></a></td>
  </tr>
<?php
	}
?>
...
<table width="30%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tamano14 Texto_Centrado" id="Resultado">
  ...
  <tr>
    <td align="center" class="Tamano10"><a href="<?php echo $_SERVER['PHP_SELF'].'?centinela=1' ?>">Agregar Aplicaci&oacute;n</a></td>
    </tr>
  <tr>
...
if ($_GET["centinela"] == '2') { 
	...
	$sql = mysqli_query($db, "INSERT INTO ".$base_general.".define_aplicaciones_predeterminados VALUES ($idaplicacion, $idnivel)") or die ("Ya existe esta aplicación en este grupo, si desea modificar, eliminelo primero y luego vuelvalo a ingresar...".mysqli_error());
...
if ($_GET["centinela"] == '3') { 
	...
	mysqli_query($db, "DELETE FROM ".$base_general.".define_aplicaciones_predeterminados WHERE id_aplicacion = $idaplicacion") or die (mysqli_error());
	header('Location: '.$_SERVER['PHP_SELF'].'?centinela=0');
}
?>
</div>
...
<tr>
  <td align="center"><a href="principal.php"><img src="Imagenes/Regresar.png" alt="Regresar" width="64" height="64" border="0"></a></td>
</tr>
<tr>
  <td align="center"><a href="principal.php">Regresar</a></td>
</tr>
</table>
</div>
</body>
