					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Query = mysqli_query($db, "INSERT INTO Bodega.CONTEO_INVENTARIO_FISICO (CIF_CODIGO, CIF_FECHA, B_CODIGO, CIF_OBSERVACIONES, CIF_FECHA_HOY, CIF_HORA, CIF_USUARIO, PC_CODIGO, CIF_ESTADO, CIF_FECHA_INICIO, CIF_FECHA_FIN)
											VALUES ('".$UI."', '".$FechaConteo."', ".$Bodega.", '".$Observaciones."', CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user.", ".$Periodo.", 0, '".$FechaInicio."', '".$FechaFin."')");
