					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$QueryNumero = "SELECT MAX(R_NUMERO) AS MAXIMO FROM Contabilidad.REQUISICION";
								...
								$sql = mysqli_query($db, "INSERT INTO Contabilidad.REQUISICION (R_CODIGO, R_FECHA, R_FECHA_NECESIDAD, R_OBSERVACIONES, R_FECHA_HOY, R_HORA, R_USUARIO, RE_CODIGO, AG_CODIGO, R_COLABORADOR, R_NUMERO, R_ULTIMA_MODIFICACION)
									VALUES('".$UI."', '".$Fecha."', '".$FechaNecesidad."', '".$Concepto."', CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$UserID .", 1, ".$AreaGasto.", ".$ColaboradorSolicita.", ".$Numero.", CURRENT_TIMESTAMP())");
