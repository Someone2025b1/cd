		...
		<div id="base">
			...
			<div id="content" style="margin-left: -125px">
				...
				<table class="table table-responsive" align="center" >
					<?php
						$sql = mysql_query("SELECT A.nombre, A.icono, A.LINK, B.id_departamento FROM info_bbdd.aplicaciones AS A, info_base.define_aplicaciones_departamentos AS B WHERE A.id_aplicacion = B.id_aplicacion AND B.id_departamento = ".$_GET["id_depto"]." ORDER BY A.nombre", $db);
						$i = 0;

						while ($permisos = mysql_fetch_row($sql)) 
						{
							$link = $permisos[2];
							$i++;
