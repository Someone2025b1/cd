...
$sql = "SELECT * FROM Bodega.FACTURA_TQ AS A LEFT JOIN Bodega.RESOLUCION AS B ON A.RES_NUMERO = B.RES_NUMERO WHERE A.F_CODIGO = '".$Factura."'";
...
while($rowD = mysqli_fetch_array($resultD))
{
    ...
    if($codigopr==2629|$codigopr==2628|$codigopr==2627|$codigopr==2626|$codigopr==2625|$codigopr==2624|$codigopr==2623 |$codigopr==2630){
        ...
        $Icono  = "../../Juegos/Icono/PartyNight.png";
