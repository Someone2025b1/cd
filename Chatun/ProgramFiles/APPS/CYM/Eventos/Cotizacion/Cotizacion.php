			...
			<div class="card">
				<div class="card-body">
					<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
						<form action="CotizacionPro.php" method="POST" class="form floating-label form-validation" role="form" novalidate="novalidate" id="FRMEnviar">
							<input type="hidden" name="RanchoSeleccionado" id="RanchoSeleccionado">
							<input type="hidden" name="MontajeSeleccionado" id="MontajeSeleccionado">
							<div class="form-wizard-nav">
								...
								<ul class="nav nav-justified nav-pills">
									...
									<li><a href="#step10" data-toggle="tab"><span class="step">10</span> <span class="title">FINALIZAR</span></a></li>
								</ul>
							...
							<div class="tab-content clearfix">
														...
														<div class="form-group ">
															...
															<select class="form-control" name="TipoEvento" id="TipoEvento">
																...
																<?php
																	...
																	{
																		?>
																			<option value="<?php echo $FilaTipoEvento[TE_CODIGO] ?>"><?php echo $FilaTipoEvento[TE_NOMBRE] ?></option>
																		<?php
																	}
																?>
															</select>
										...
										<div class="col-lg-10">
											<div class="col-lg-12">
												<div class="col-lg-4">
													<div class="form-group floating-label">
														<label>CUI</label>
														<input type="text" class="form-control" name="CUI" id="CUI" required onchange="ObtenerDatosCUI(this.value)">
													</div>
												</div>
												<div class="col-lg-4">
													<div class="form-group floating-label">
														<label>NIT</label>
														<input type="text" class="form-control" name="NIT" id="NIT" required onchange="ObtenerDatosNIT(this.value)">
													</div>
												</div>
											</div>
											<div class="col-lg-12">
										...
										<div class="col-lg-8">
											<div class="col-lg-12">
												<div class="col-lg-2">
													<div class="form-group floating-label">
														<label>Adultos</label>
														<input type="number" class="form-control" name="Adultos" id="Adultos" required>
													</div>
												</div>
											</div>
											<div class="col-lg-12">
												<div class="col-lg-2">
													<div class="form-group  floating-label">
														<label>Niños</label>
														<input type="number" class="form-control" name="Ninos" id="Ninos" required>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="tab-pane" id="step10">
									...
									<div class="col-lg-12 text-center">
										<button type="button" class="btn ink-reaction btn-raised btn-lg btn-primary" onclick="Confirmacion()">FINALIZAR</button>
									</div>
								</div><!--end #step4 -->
							</div><!--end .tab-content -->
						</form>
