...
<body class="menubar-hoverable header-fixed menubar-pin " onload="CalcularTotal()">
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 21";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 21 AND ACC_ESTADO = 2";
											...
											<form class="form form-validation" role="form" novalidate="novalidate" action="VtaDescripcionVPro.php" method="POST" role="form" id="FormularioPrincipal">
												...
												<div class="tab-content clearfix">
													...
													<input class="form-control" type="hidden" name="TipoDoc" id="TipoDoc"  required/>
														...
														<div class="row">
															...
															<select name="TipoFactura" id="TipoFactura" class="form-control" required >
																...
																<option value="4.01.08.002">Patrocinio</option>
																<option value="4.01.08.001">Inscripciones</option>
															</select>
													...
													<div class="tab-pane" id="step2">
														...
														<div class="col-lg-3" class="col-lg-3" class="col-lg-3" id="DivCredito" name="DivCredito" >
															<div class="card">
												...
												<ul class="pager wizard">
													...
													<button type="button" id="Siguiente" name="Siguiente" class="btn ink-reaction btn-raised btn-lg btn-accent-dark" href="javascript:void(0);"  ><li class="next" >Siguiente</li></button>
												</ul>
