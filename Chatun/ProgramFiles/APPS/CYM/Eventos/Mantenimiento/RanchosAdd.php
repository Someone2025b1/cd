	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<form class="form" action="RanchosAddPro.php" method="POST" role="form" enctype="multipart/form-data">
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group floating-label">
											<input class="form-control" type="number" step="any" name="Capacidad" id="Capacidad" required/>
