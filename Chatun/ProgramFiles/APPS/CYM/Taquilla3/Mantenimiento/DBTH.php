						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Query = mysqli_query($db, "SELECT A.*, B.H_NOMBRE
													...
													ON A.H_CODIGO = B.H_CODIGO GROUP BY A.H_CODIGO");
										...
										{ 
											...
											?>
												<tr>
													...
													<td><a href="DBTHPro.php?Codigo=<?php echo $fila["H_CODIGO"] ?>"><button type="button" class="btn btn-primary btn-sm">Consultar</button></td>
												</tr>
											<?php
											$i++;
										}
