					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Reporte de Facturas</strong></h4>
							</div>
							<div class="card-body">
								<div class="row text-center">
									...
									<div class="col-lg-12">
										<div class="form-group">
											<select name="TipoFacturas" style="width: 300px" id="TipoFacturas" class="form-control" required>
												<option value="" disabled selected>Seleccione una opción</option>
												<option value="2">Aprobadas</option>
												<option value="3">Rechazadas</option>
											</select>
											<label for="TipoFacturas">Tipo de Facturas</label>
										</div>
									</div>
								</div>
								</div>
