...
f.length;j<m;j++)if(a=f[j],d.isArray(a))o(b,a);else{e=c="";switch(a){case "ellipsis":c="&hellip;";e="unavailable";case "first":c=i.sFirst;e=a+(0<h?"":" unavailable");case "previous":c=i.sPrevious;e=a+(0<h?"":" unavailable");case "next":c=i.sNext;e=a+(h<l-1?"":" unavailable");case "last":c=i.sLast;e=a+(h<l-1?"":" unavailable");default:c=a+1,e=h===a?"current":""}c&&(n=d("<li>",{"class":r.sPageButton+" "+e,"aria-controls":g.sTableId,tabindex:g.iTabIndex,id:0===p&&"string"===
