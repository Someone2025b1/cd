					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Consulta = "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_ESTADO = 1 AND ACC_TIPO = 20 AND ACC_ESTADO = 1";
								$ResultConsulta = mysqli_query($db,$Consulta) or die(mysqli_error($db, $Consulta));
								...
								WHERE a.ACC_FECHA = CURDATE() AND b.CD_USUARIO = $id_user"));
											...
											<div class="col-lg-2">
												<div class="form-group ">
													<select onchange="Validar(this.value)" required name="TipoCierre" id="TipoCierre" class="form-control">
														...
														<!-- <option value="1" >Cierre Parcial</option> -->
