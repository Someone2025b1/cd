			...
			<div class="container">
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								<form action="ListaNegraAddPro.php" method="POST" class="form" enctype="multipart/form-data">
									<div class="row text-center">
										<div class="form-group col-lg-offset-4 col-lg-4">
											<input class="form-control" type="text" name="CriterioBusqueda" id="CriterioBusqueda" onchange="BusquedaAsociado(this)" required/>
									...
									<div class="row">
										<div id="ResultadoBusquedaAsociado"></div>
									</div>
									<div class="row">
										<div class="form-group col-lg-12">
											<textarea class="form-control" name="Razon" rows="5" required></textarea>
