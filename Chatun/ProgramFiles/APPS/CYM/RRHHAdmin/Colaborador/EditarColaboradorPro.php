						...
						<div class="card">
							...
							<div class="card-body">
								...
								if($extension==""){
									...
									$QueryColaborador = mysqli_query($db, "UPDATE RRHH.COLABORADOR SET C_NOMBRES='".$Nombres."', C_APELLIDOS ='".$Apellidos."', C_DPI = '".$DPI."',
									EC_CODIGO = '".$EstadoCivil."', C_FECHA_NACIMIENTO = '".$FechaNacimiento."', C_FECHA_INICIO = '".$FechaInicio."', C_CELULAR = '".$Celular."',
									C_DIRECCION = '".$Direccion."', C_NO_IGSS = '".$IGSS."', C_NIT = '".$NIT."', C_VEHICULO = '".$Vehiculo."',
									C_AUTOMOVIL = '".$Automovil."', C_MOTOCICLETA = '".$Motocicleta."', C_CASA = '".$Casa."',
									C_OBSERVACIONES = '".$ObservacionesGen."', C_TIPO_SANGRE = '".$TipoSangre."', P_CODIGO = '".$Puesto."', A_CODIGO = '".$Area."',
									C_ACTIVO = '".$EstadoCol."', C_TIPO_EMPLEADO = '".$TipoEmpleado."', C_JEFE = '".$Jefe."', C_EXTENDIDO = '".$Extendido."', C_NACIDO = '".$Nacido."',
									C_BASE = '".$Base."', C_BONOFICACION = '".$Bono."', C_BONO = '".$BonoLey."'
									...
									EC_CODIGO = '".$EstadoCivil."', C_FECHA_NACIMIENTO = '".$FechaNacimiento."', C_FECHA_INICIO = '".$FechaInicio."', C_CELULAR = '".$Celular."',
									C_DIRECCION = '".$Direccion."', C_NO_IGSS = '".$IGSS."', C_NIT = '".$NIT."', C_VEHICULO = '".$Vehiculo."',
									C_AUTOMOVIL = '".$Automovil."', C_MOTOCICLETA = '".$Motocicleta."', C_CASA = '".$Casa."', C_EXTENCION_FOTO = '".$extension."',
									C_OBSERVACIONES = '".$ObservacionesGen."', C_TIPO_SANGRE = '".$TipoSangre."', P_CODIGO = '".$Puesto."', A_CODIGO = '".$Area."',
									C_ACTIVO = '".$EstadoCol."', C_TIPO_EMPLEADO = '".$TipoEmpleado."', C_JEFE = '".$Jefe."', C_EXTENDIDO = '".$Extendido."', C_NACIDO = '".$Nacido."',
									C_BASE = '".$Base."', C_BONOFICACION = '".$Bono."', C_BONO = '".$BonoLey."'
									WHERE C_CODIGO = '".$CodigoColaborador."'");
