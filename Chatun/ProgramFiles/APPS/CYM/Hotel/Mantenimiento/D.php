...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Descuentos</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
						<h4 class="text-center"><strong>Descuentos</strong></h4>
						</div>
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<?php
									$Consulta = "SELECT * 
												FROM Bodega.DESCUENTO
												WHERE D_TIPO = 1
												ORDER BY DESCUENTO.D_NOMBRE";
									$Resultado = mysqli_query($db, $db, $db, $Consulta);
									while($row = mysqli_fetch_array($Resultado))
									{
										$Codigo = $row["D_CODIGO"];
										echo '<tr>';             
										    	echo '<td style="font-size: 10px">'.$row["D_NOMBRE"].'</td>';
										    	echo '<td style="font-size: 10px">'.$row["D_PORCENTAJE"].' %</td>';
										    	echo '<td><a href="DMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
