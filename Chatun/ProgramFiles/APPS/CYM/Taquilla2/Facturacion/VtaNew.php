...
<head>
	...
	<script>
		...
		function BuscarProducto(x)
        {
		        ...
		        var service = x.value;
		        var dataString = 'service='+service+'&Tilapia='+Tilapia;
...
<body class="menubar-hoverable header-fixed menubar-pin " onload="CalcularTotal()">
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 15";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 15 AND ACC_ESTADO = 2";
												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														<div class="row">
															...
															<div class="col-lg-2">
																 	<label for="Validar">Tilapia
																 		<input class="form-control" type="checkbox" step="any" onclick="ValidarTilapia()" name="Validar" id="Validar" />
																 	</label> 
															</div>
														</div>
														<div class="row">
														...
														<input type="hidden" value="1" id="Establecimiento" name="Establecimiento">
														<div class="row">
															<div class="col-lg-12">
																<div class="form-group" id="DIVCIF">
														...
														<div class="row">
															<table class="table" name="tabla" id="tabla">
																<thead>
																	<tr>
																		<th>Cantidad</th>
																		<th id="Titulo" style = "display:none" >Unidades</th>
																		<th id="Titulo3" style = "display:none" >Estanque</th>
																		<th>Producto</th>
																		<th>Precio</th>
																		<th>Descuento</th>
																		<th>Subtotal</th>
																...
																<tbody>
																	<tr class="fila-base">
						                                                ...
						                                                <td  id="Titulo1" style="display: none" ><h6><input type="number" step="any" class="form-control" name="UnidadesVendidas[]" id="UnidadesVendidas[]" value="0" min="1"></h6></td>
																		<td  id="Titulo4" style="display: none" ><h6><input type="number" step="any" class="form-control" name="Estanque[]" id="Estanque[]" value="0" min="1"></h6></td>
						                                            ...
						                                            <?php
																	if(isset($_POST["CodigoProducto"]) && isset($_POST["Cantidad"]) && isset($_POST["Precio"]) && isset($_POST["SubTotal"]))
																	{
																		$CodigoProducto = $_POST["CodigoProducto"];
																		$Cantidad     = $_POST["Cantidad"];
																		$Valor        = $_POST["Precio"];
																		$Total        = $_POST["SubTotal"];
																		$Name = mysqli_fetch_array(mysqli_query($db, "SELECT P_NOMBRE FROM Bodega.PRODUCTO WHERE P_CODIGO = 15101"));
																		
																		?>
																		<input class="form-control" type="hidden" name="NombreNoAsociado" id="NombreNoAsociado" value="<?php echo $NombreNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="depto" id="depto" value="<?php echo $depto; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="municipio" id="municipio" value="<?php echo $municipio; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="SelectVisitaEsquipulas" id="SelectVisitaEsquipulas" value="<?php echo $SelectVisitaEsquipulas; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="EnteradoNoAsociado" id="EnteradoNoAsociado" value="<?php echo $EnteradoNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="EdadNoAsociado" id="EdadNoAsociado" value="<?php echo $EdadNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="SelectAsisteconNoAsociado" id="SelectAsisteconNoAsociado" value="<?php echo $SelectAsisteconNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="FrecuenciaVisitaNoAsociado" id="FrecuenciaVisitaNoAsociado" value="<?php echo $FrecuenciaVisitaNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="CorreoNoAsociado" id="CorreoNoAsociado" value="<?php echo $CorreoNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="NumeroTelefonoNoAsociado" id="NumeroTelefonoNoAsociado" value="<?php echo $NumeroTelefonoNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="SelectConociaParque" id="SelectConociaParque" value="<?php echo $SelectConociaParque; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="BuscaNoAsociado" id="BuscaNoAsociado" value="<?php echo $BuscaNoAsociado; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="Cantidadingreso[]" id="Cantidadingreso[]" value="<?php echo $Cantidad[0]; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="Cantidadingreso[]" id="Cantidadingreso[]" value="<?php echo $Cantidad[1]; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="Cantidadingreso[]" id="Cantidadingreso[]" value="<?php echo $Cantidad[2]; ?>"  readonly/>
																		<input class="form-control" type="hidden" name="Cantidadingreso[]" id="Cantidadingreso[]" value="<?php echo $Cantidad[3]; ?>"  readonly/>
																		<tr>
							                                                ...
							                                                <input type="hidden" class="form-control" name="Producto[]" id="Producto[]" value="2557"> 
							                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" value="Ingreso Adultos Mayores" readonly style="width: 500px" onchange="BuscarProducto(this)"></h6></td>
																		...
																		<tr>
							                                                <td><h6><input type="number" class="form-control" name="Cantidad[]" id="Cantidad[]" value="<?php echo $Cantidad[3] ?>" readonly onChange="CalcularTotal()" style="width: 100px" min="0"><input type="hidden" class="form-control" name="TipoProducto[]" id="TipoProducto[]"></h6></td>
							                                                ...
							                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]" value="<?php echo $Valor[3] ?>" onChange="CalcularTotal()" style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
							                                                <td><h6><input type="number" class="form-control InputDescuento" name="Descuento[]" id="Descuento[]" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" onchange="CalcularTotal()"></h6></td>
							                                                <td><h6><input type="number" class="form-control" name="SubTotal[]" id="SubTotal[]" value="<?php echo $Total[3] ?>"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" readonly></h6></td>
							                                            </tr>
						                                            ...
						                                            <tr>
						                                                <td><h6><input type="number" class="form-control" name="Cantidad[]" id="Cantidad[]" onChange="CalcularTotal()" style="width: 100px" min="0"><input type="hidden" class="form-control" name="TipoProducto[]" id="TipoProducto[]"></h6></td>
						                                                <td  id="Titulo2" style="display: none" ><h6><input type="number" step="any" class="form-control" name="UnidadesVendidas[]" id="UnidadesVendidas[]" value="0" min="1"></h6></td>
																		<td  id="Titulo5" style="display: none" ><h6><input type="number" step="any" class="form-control" name="Estanque[]" id="Estanque[]" value="0" min="1"></h6></td>
						                                                <input type="hidden" class="form-control" name="Producto[]" id="Producto[]">
						                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 500px" onchange="BuscarProducto(this)"></h6></td>
						                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]" onChange="CalcularTotal()"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
						                                                <td><h6><input type="number" class="form-control InputDescuento" name="Descuento[]" id="Descuento[]" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" onchange="CalcularTotal()"></h6></td>
...
<input type="hidden" class="form-control" id="TotalFacturaCobrarEfectivoQuetzales" name="TotalFacturaCobrarEfectivoQuetzales" readonly required>
