...
<head>
	...
	<?php
		$Query = mysqli_query($db, "SELECT * FROM Bodega.CATEGORIA_MOBILIARIO AS A WHERE A.CM_CODIGO = ".$_GET[Codigo]);

		$Fila = mysqli_fetch_array($Query);

		$Nombre         = $Fila[CM_NOMBRE];
		$Estado         = $Fila[CM_ESTADO];
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Mantenimiento de la Categoría de Mobiliario</strong><br></h1>
				<br>
				<form class="form" action="CategoriaMobiliarioModPro.php" method="POST" role="form">
