	...
	$(function() {
	 ...
	 //Función para agregar o eliminar filas en la tabla de construcciones
		...
		function Calcular()
		{
			...
			if(TotalAbonos > $('#SaldoPendiente').val() || TotalCargos > $('#SaldoPendiente').val())
			{
				alertify.alert("El Total de la Factura/Recibo excede el saldo del Anticipo.");
		...
		function SaberTipo(x)
		{
			if(x.value == 'F')
			{
				...
				$('#NoRecibo').attr("required");
				$('#FechaRecibo').attr("required");
				$('#ConceptoRecibo').attr("required");
				$('#TotalRecibo').attr("required");

				//NO Requeridos campos de factura
				$('#Nombre').attr("required", "required");
				$('#Impuesto').attr("required", "required");
				$('#CodigoProveedor').attr("required", "required");
				$('#NIT').attr("required", "required");
				$('#SerieFactura').attr("required", "required");
				$('#Factura').attr("required", "required");
				$('#FechaFactura').attr("required", "required");
				$('#Descripcion').attr("required", "required");
				$('#TipoCompra').attr("required", "required");
			}
			else
			{
				$('#DIVRecibo').show();
				$('#DIVFactura').hide();
				//Requeridos campos de recibo
				$('#NoRecibo').attr("required", "required");
				$('#FechaRecibo').attr("required", "required");
				$('#ConceptoRecibo').attr("required", "required");
				$('#TotalRecibo').attr("required", "required");

				//NO Requeridos campos de factura
				$('#Nombre').attr("required");
				$('#Impuesto').attr("required");
				$('#CodigoProveedor').attr("required");
				$('#NIT').attr("required");
				$('#SerieFactura').attr("required");
				$('#Factura').attr("required");
				$('#FechaFactura').attr("required");
				$('#Descripcion').attr("required");
				$('#TipoCompra').attr("required");
		...
		function TotalCombus(x)
		{
			...
			{
				TotalImpuesto = (parseFloat($('#TotalCombustible').val())/1.12) * parseFloat(Impuesto);
				TotalDeposito = parseFloat($('#TotalCombustible').val()) - parseFloat(TotalImpuesto);
				...
				Cuenta[2].value = '1.01.05.001/IVA Crédito Fiscal';
				Abonos[3].value = $('#TotalCombustible').val();
			}	
		...
		function LlenarPartidaRecibo(x)
		{
			var Cargos  = document.getElementsByName('Cargos[]');
			var Abonos  = document.getElementsByName('Abonos[]');
			var Cuenta  = document.getElementsByName('Cuenta[]');
					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Ingreso de Factura a Anticipo</strong></h4>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											<input class="form-control" type="text" name="SaldoPendiente" id="SaldoPendiente" value="<?php echo $_GET["Saldo"] ?>" required/>
								...
								<div class="row">
									...
									<label class="radio-inline radio-styled" >
										<input type="radio" value="F" name="TipoDocumento" onChange="SaberTipo(this)" required>
										<span>Factura</span>
									</label>
									<label class="radio-inline radio-styled">
										<input type="radio" value="R" name="TipoDocumento" onChange="SaberTipo(this)" required>
										<span>Recibo</span>
									</label>
									<input class="form-control" type="hidden" name="Anticipo" id="Anticipo" value="<?php echo $_GET["IDAnticipo"] ?>" required/>
									<input class="form-control" type="hidden" name="SaldoPendiente" id="SaldoPendiente" value="<?php echo $_GET["Saldo"] ?>" required/>
								</div>
								</div>
								<div id="DIVRecibo" style="display: none">
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												<input class="form-control" type="text" name="NoRecibo" id="NoRecibo"/>
									...
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												<input class="form-control" type="date" name="FechaRecibo" id="FechaRecibo" value="<?php echo date('Y-m-d'); ?>"/>
									...
									<div class="row">
										<div class="col-lg-10">
											<div class="form-group">
												<input class="form-control" maxlength="255" type="text" name="ConceptoRecibo" id="ConceptoRecibo"/>
									...
									<div class="row">
											<div class="col-lg-3 col-lg-9">
												<div class="form-group floating-label">
													<input class="form-control" type="number" step="any" name="TotalRecibo" id="TotalRecibo" min="0" onChange="LlenarPartidaRecibo(this)"/>
													<label for="TotalRecibo">Total de Recibo</label>
												</div>
											</div>
										</div>
								</div>
								<div id="DIVFactura" style="display: none">
									<div class="row">
										<div class="col-lg-6">
												<div class="form-group">
													<input class="form-control" type="text" name="Nombre" id="Nombre" placeholder="Click para seleccionar un proveedor" readonly onclick="SelProveedor(this)"/>
													<label for="Nombre">Proveedor</label>
													<input class="form-control" type="hidden" name="Impuesto" id="Impuesto" />
												</div>
										</div>
										<div class="col-lg-4">
												<div class="form-group">
													<input class="form-control" type="text" name="CodigoProveedor" id="CodigoProveedor" readonly onclick="SelProveedor(this)"/>
									...
									<div class="row">
										<div class="col-lg-2">
											<div class="form-group">
												<input class="form-control" type="text" name="SerieFactura" id="SerieFactura"/>
									...
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												<input class="form-control" type="date" name="FechaFactura" id="FechaFactura" value="<?php echo date('Y-m-d') ?>"/>
									...
									<div class="col-lg-12">
										<h5>Tipo</h5>
										<label class="radio-inline radio-styled" >
											<input type="radio" value="B" name="TipoCompra" onChange="ComprobarTipo(this)">
											<span>Bienes</span>
										</label>
										<label class="radio-inline radio-styled">
											<input type="radio" value="C" name="TipoCompra" onChange="ComprobarTipo(this)">
											<span>Combustible</span>
										</label>
										<label class="radio-inline radio-styled" >
											<input type="radio" value="I" name="TipoCompra" onChange="ComprobarTipo(this)">
											<span>Importación</span>
										</label>
										<label class="radio-inline radio-styled" >
											<input type="radio" value="S" name="TipoCompra" onChange="ComprobarTipo(this)">
											<span>Servicios</span>
										</label>
									</div>
									<div id="DivCombustibles" style="display: none">
										...
										<div class="row">
											<div class="col-lg-3 col-lg-9">
												<div class="form-group floating-label">
													<input class="form-control" type="number" step="any" name="CantidadGalones" id="CantidadGalones" onChange="TotalCombus(this)" min="0"/>
										...
										<div class="row">
											<div class="col-lg-3 col-lg-9">
												<div class="form-group floating-label">
													<input class="form-control" type="number" step="any" name="PrecioGalones" id="PrecioGalones" onChange="TotalCombus(this)" min="0"/>
