					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							while($rowe = mysqli_fetch_array($resultsa))
							{
								...
								VALUES('".$KCod."', '".$CodEN."', '".$Pro."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Envío de producto interno de ".$Envia." a Souvenir', '".$existenciagen."', '".$existenciagen."', 2, '".$existenciasou."', '".$newcantsou."', '-', '-', '-')");
								...
								VALUES('".$KCod."', '".$CodEN."', '".$Pro."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Envío de producto interno de ".$Envia." a Souvenir', '".$existenciagen."', '".$existenciagen."', 5, '".$existenciabode."', '".$newcantbo."', '-', '-', '".$ponderado."')");
