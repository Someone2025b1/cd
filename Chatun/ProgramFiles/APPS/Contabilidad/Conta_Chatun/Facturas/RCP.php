				...
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
							<h4 class="text-center"><strong>Requisiciones Pendientes de Seguimiento</strong></h4>
						</div>
						<div class="card-body">
							<div class="col-lg-12">
								<?php
									...
									if($Numero > 0)
									{
										...
										while($row = mysqli_fetch_array($Result))
										{
											...
											<tr>
												...
												<td><a href="RCConsulta.php?Numero=<?php echo $row["R_NUMERO"]; ?>">
														<button type="button" class="btn btn-warning btn-xs">
													    	<span class="glyphicon glyphicon-search"></span> Dar Seguimiento
														</button>
													</a>
												</td>
											</tr>
									...
									else
									{
										...
										<div class="alert alert-danger text-center" role="alert">
											<strong>No se encontró ninguna requisición pendiente de seguimiento</strong>
										</div>
										<?php
									}
								?>
