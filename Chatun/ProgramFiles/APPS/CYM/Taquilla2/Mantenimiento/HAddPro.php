					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<?php
								...
								$Query = mysqli_query($db, "INSERT INTO Taquilla.HOTEL (H_NOMBRE, H_DIRECCION, H_MUNICIPIO, H_DEPARTAMENTO, H_TELEFONO, H_TELEFONO_1, H_EMAIL, H_NOMBRE_FAC, H_NIT_FAC, H_DIRECCION_FAC, H_PUBLICIDAD, H_CONTACTO)
														VALUES('".$Nombre."', '".$Direccion."', '".$Municipio."', '".$Departamento."', '".$TelefonoPrincipal."', '".$TelefonoSecundario."', '".$Email."', '".$NombreFacturacion."', '".$NitFacturacion."', '".$DireccionFacturacion."', '".$Publicidad."', '".$Contacto."')")or die(mysqli_error($Query));
								if($Query)
								{
									echo '<div class="col-lg-12 text-center">
										<h1><span class="text-xxxl text-light">Bien! <i class="fa fa-check-circle text-success"></i></span></h1>
										<h2 class="text-light">El Hotel se modificó correctamente.</h2>
										<div class="row">
