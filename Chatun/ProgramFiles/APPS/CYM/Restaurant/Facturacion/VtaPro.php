...
<head>
	...
	<script>
		...
		function Imprimir()
		{
			...
			printJS('<?php $_SERVER['DOCUMENT_ROOT']?>/ProgramFiles/APPS/CYM/Restaurant/Facturacion/FactImp.php?Codigo='+Cod);
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<?php
			...
			if($TipoPago == 1)
			{
				$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA WHERE F_FECHA_TRANS = CURRENT_DATE() ORDER BY F_ORDEN DESC LIMIT 1";
