...
<head>
	...
	<script>
		...
		function CRD()
		{
			...
			var TotalFactura = parseFloat($('#Monto').val());
			...
			$('#Monto').val(TotalDescuento.toFixed(2));
		...
		function CalcularTotalDescuento()
		{
			...
			TotalDescuento = parseFloat($('#Monto').val()) - Total;
			$('#BoldDescuento').val(Total.toFixed(2));
			$('#Monto').val(TotalDescuento.toFixed(2));
			if($('#MonedaPagoInput').val() == 1)
			{
								...
								<div class="card">
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="AgregarAnticipoPro.php" method="POST" role="form" id="FormularioPrincipal">
												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														...
														<div class="row">
															...
															<div class="col-lg-10">
																<div class="form-group">
																	<input class="form-control" type="number" min="0" step="any" style="text-align: right" value="0.00" name="Monto" id="Monto"/>
