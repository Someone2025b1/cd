							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA_SV.*, CLIENTE.* 
														FROM Bodega.FACTURA_SV, Bodega.CLIENTE 
														WHERE FACTURA_SV.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA_SV.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA_SV.F_NUMERO = ".$_POST["Numero"];
