...
<script>
		...
		function EnviarForm()
	{
		...
		$(Formulario).attr('action', 'NotaAbonoPro.php');
		$(Formulario).submit();
					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Nueva Nota de Abono</strong></h4>
							</div>
                            <div class="card-body">
								<div class="row">
                                ...
                                <div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Productos a Abonar</strong></h4>
							</div>
                            <div class="card-body">
                                <div class="row">
