			...
			<div class="container">
				...
				<div class="card">
					<div class="card-head style-primary">
							<h3 class="text-center"><strong>Gráfica Ingresos Taquilla</strong></h3>
						</div>
						<div class="card-body">
	...
	<script>
		function verDetalle()
		{
			...
			var fechaFinal = $("#fechaFinal").val(); 
			 	 $.ajax({
				url: 'Ajax/GrupIngresosTaquillaGrafica.php',
				type: 'POST',
				data: {mes:mes, dia: dia, anio: anio, fechaInicial:fechaInicial, fechaFinal:fechaFinal},
				beforeSend: function()
				{
					$('#GifCargando').show();
				},
