					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Kardex de Producto</strong></h4>
							</div>
							<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="input-daterange input-group" id="demo-date-range">
												<div class="input-group-content">
													<input type="date" class="form-control" name="FechaInicio"  value="<?php echo $date_past?>" max="<?php echo $date_past?>">
													<label>Rango de Fechas</label>
												</div> 
												<span class="input-group-addon">al</span>
												<div class="input-group-content">
													<input type="date" class="form-control" name="FechaFin" value="<?php echo $date_past?>" max="<?php echo $date_past?>">
