...
$aCT = mysqli_query($db, "DELETE FROM Taquilla.FAC_HOTEL WHERE CH_Estado = 1");
$Insert = mysqli_query($db, "INSERT INTO Taquilla.FAC_HOTEL (CH_Fecha, CH_Colaborador, CH_Estado) VALUES (CURRENT_TIMESTAMP, $id_user, 1)");
	...
	<script>
		...
		function TipoPago(x)
		{
			...
			else if(x == 3)
			{
				...
				$('#FormaPagoEfectivoLempiras').hide();
				$('#NumeroAutorizacion').hide();
				var Total = $("#BoldTotal").val();
				$("#TotalFacturaCobrarCredito").val(Total);
			...
			else if(x == 4)
			{
				...
				$('#NumeroAutorizacion').hide();
				var Total = $("#BoldTotal").val();
				$("#TotalFacturaCobrarDeposito").val(Total);
			}
		}
									...
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="VtaPro.php" method="POST" role="form" id="FormularioPrincipal">
												<input type="hidden" value="<?php echo $IdCorte?>" id="IdCorte" name="IdCorte">
															...
															<!-- <table class="table" name="tabla" id="tabla">
																...
																<tbody>
						                                            ...
						                                            <tr>
						                                                ...
						                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 500px" onchange="BuscarProducto(this)"></h6></td>
						                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
						                                                <td><h6><input type="number" class="form-control InputDescuento" name="Descuento[]" id="Descuento[]" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" CantidadCantidad="CalcularTotal()"></h6></td>
						                                                <td><h6><input type="number" class="form-control" name="SubTotal[]" id="SubTotal[]"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" readonly></h6></td>
						                                                <td class="eliminar">
						                                                    <button type="button" class="btn btn-danger btn-lg" onclick="EliminarLinea(this)">
						                                                        <span class="glyphicon glyphicon-trash"></span>
