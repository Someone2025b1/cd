		...
		<div id="content">
			<div class="container">
				...
				if($_POST["TipoReceta"] == 1)
				{
					...
					$MostrarMenu    = $_POST["MostrarMenu"];

					$sql = mysqli_query($db, "UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."', CME_CODIGO = ".$_POST["CategoriaMenuEventos"].", RS_PRECIO = ".$_POST["Precio"].", RS_MOSTRAR_MENU = ".$_POST["MostrarMenu"]." WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
				...
				elseif($_POST["TipoReceta"] == 2)
				{
					...
					$sql = mysqli_query($db, "UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."', CME_CODIGO = ".$_POST["CategoriaMenuEventos"].", RS_MOSTRAR_MENU = ".$_POST["MostrarMenu"]." WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
