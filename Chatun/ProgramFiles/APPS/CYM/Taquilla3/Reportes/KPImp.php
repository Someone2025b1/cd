...
$Consulta = "SELECT TRANSACCION.*, TRANSACCION_DETALLE.*, TIPO_TRANSACCION.TT_NOMBRE, PRODUCTO.P_NOMBRE 
            ...
            AND (TRANSACCION.TT_CODIGO = 1 OR TRANSACCION.TT_CODIGO = 2 OR TRANSACCION.TT_CODIGO = 5 OR TRANSACCION.TT_CODIGO = 6 OR TRANSACCION.TT_CODIGO = 7 OR TRANSACCION.TT_CODIGO = 9 OR TRANSACCION.TT_CODIGO = 11)
