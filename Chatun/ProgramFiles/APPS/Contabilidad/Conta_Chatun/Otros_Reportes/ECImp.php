...
/*TITULOS*/
    $Titulo = array('col1'=>'Fecha', 'colFactura'=>'Factura', 'col2'=>'Tipo', 'col3'=>'Concepto', 'col4'=>'Cargos', 'col5'=>'Abonos', 'col6'=>'Total');
/*FIN TITULOS*/
...
while($FilaAnterior = mysqli_fetch_array($ResultAnterior))
{
    ...
    $Data[] = array('col1'=>'-----', 'colFactura'=>'-----', 'col2'=>'-----', 'col3'=>'Saldos Anteriores', 'col4'=>number_format($FilaAnterior["CARGOS"], 2, '.', ','), 'col5'=>number_format($FilaAnterior["ABONOS"], 2, '.', ','), 'col6'=>number_format($SaldoFinal, 2, '.', ','));
}
...
while($FilaAnterior = mysqli_fetch_array($ResultAnterior))
{
    ...
    $Data[] = array('col1'=>date('d-m-Y', strtotime($FilaAnterior["TRA_FECHA_TRANS"])), 'colFactura'=>$FilaAnterior["TRA_SERIE"].'-'.$FilaAnterior["TRA_FACTURA"], 'col2'=>utf8_decode($FilaAnterior["TT_NOMBRE"]), 'col3'=>utf8_decode($FilaAnterior["TRA_CONCEPTO"]), 'col4'=>number_format($FilaAnterior["CARGOS"], 2, '.', ','), 'col5'=>number_format($FilaAnterior["ABONOS"], 2, '.', ','), 'col6'=>number_format($SaldoFinal, 2, '.', ','));
}
