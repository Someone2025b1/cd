...
$pdf -> Cell (0,7, "ESTADO PATRIMONIAL, ".fecha_para_contratos(date('Y-m-d')),1,1,'C',1);
$pdf -> Ln(4);
...
$pdf -> Ln(4);
	if ($data1["ApellidoCasada"] == NULL) {
		$pdf -> Cell (0,0, utf8_decode($data1["Nombre1"]." ".$data1["Nombre2"]." ".$data1["Apellido1"]." ".$data1["Apellido2"]),0,0,'C',0);
	}else {
		$pdf -> Cell (0,0, utf8_decode($data1["Nombre1"]." ".$data1["Nombre2"]." ".$data1["Apellido1"]." ".$data1["Apellido2"]." de ".$data1["ApellidoCasada"]),0,0,'C',0);
	}
// ****** SEGUNDA HOJA *****
$pdf -> AddPage();
$pdf -> SetFont('Times', 'B', 14);
$pdf -> SetTextColor(255,255,255);
$pdf -> SetFillColor(0,0,0);
$pdf -> Cell (0,7, "DETALLE DEL ESTADO PATRIMONIAL, ".fecha_para_contratos(date('Y-m-d')),1,1,'C',1);
$pdf -> Ln(4);
