...
if ($fechaInicial != "" and $fechaFinal!="") 
{
 ...
 $filtroAsociados = "DATE(A.IA_FECHA_INGRESO) BETWEEN  '$fechaInicial' AND '$fechaFinal' AND IA_HORA_INGRESO >='$hora'";
 $filtroNoA = "DATE(a.INA_FECHA_INGRESO) BETWEEN  '$fechaInicial' AND '$fechaFinal' AND IA_HORA_INGRESO >='$hora'";
...
<head>
	...
	<div align="left">
		<a type="button" href="Ajax/DetReferenciacion.php?mesObtenido=<?php echo $mesObtenido?>&fechaInicial=<?php echo $fechaInicial?>&fechaFinal=<?php echo $fechaFinal?>&dia=<?php echo $dia?>&anio=<?php echo $anio?>" class="btn ink-reaction btn-raised btn-primary" id="BtnExportarTicketHotel" target="_blank">Exportar PDF</a>
	</div> <br>
	<div align="left">
		<a type="button" href="Ajax/DetReferenciacionAso.php?mesObtenido=<?php echo $mesObtenido?>&fechaInicial=<?php echo $fechaInicial?>&fechaFinal=<?php echo $fechaFinal?>&dia=<?php echo $dia?>&anio=<?php echo $anio?>" class="btn ink-reaction btn-raised btn-primary" id="BtnExportarTicketHotel" target="_blank">PDF Ingresos Asociados</a>
	</div>
	<br>
	<div style="overflow-x:auto;">
		<table class="table table-hover" id="TblTicketsHotel">
		    <thead>
		      <tr>
		      	<td class="text-center"><h1>INGRESO TAQUILLA <?php echo $texto." Hora: ".$hora ?></h1></td>
		      </tr>
		    </thead>
		    <tbody> 
		      <tr>
		    	...
		    	<td><?php echo $selectHotel["ADULTOSM"] ?></td>
		   	  </tr>
		   	  <tr>
		    	<td>HOTEL NIÑOS</td>
		    	...
		    	<td><?php
		    		$totalNoAsociado =$ContarTar["Cont"]+ $noAsociadosAdulto["SUMA"]+$noAsociadosAdultoM["SUMA"]+$noAsociadosNino["SUMA"]+$selectHotel["ADULTOS"]+$selectHotel["ADULTOSM"]+$selectHotel["MENORES"]+$selectTarj["ADULTOS"]+$selectTarj["NINOS"];
