							...
							<table class="table table-hover table-condensed">
								...
								<tbody>
									...
									$Query = "SELECT TRANSACCION.TRA_CODIGO, TRANSACCION.TRA_CONCEPTO, TRANSACCION.TRA_TOTAL, TIPO_TRANSACCION.TT_NOMBRE
									 ...
									 AND (TRANSACCION.TT_CODIGO <> 28 AND TRANSACCION.TT_CODIGO <> 6 AND TRANSACCION.TT_CODIGO <> 7 AND TRANSACCION.TT_CODIGO <> 8 AND TRANSACCION.TT_CODIGO <> 15 AND TRANSACCION.TT_CODIGO <> 9 AND TRANSACCION.TT_CODIGO <> 20 AND TRANSACCION.TT_CODIGO <> 21 AND TRANSACCION.TT_CODIGO <> 23)";
									 ...
									 while($row = mysqli_fetch_array($Result))
									 {
									 	?>
											...
											<tr>
												...
												<td><a href="PModProPro.php?Codigo=<?php echo $row['TRA_CODIGO']; ?>" Target="_blank"><button type="button" class="btn btn-sm btn-warning">
