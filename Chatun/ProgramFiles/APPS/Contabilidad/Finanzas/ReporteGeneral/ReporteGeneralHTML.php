			...
			<div class="container">
				...
				<div class="card">
					<div class="card-head style-primary">
							<h3 class="text-center"><strong>Reporte FInanciero</strong></h3>
						</div>
						<div class="card-body">
							<div > 
								<div >
								...
								<div id="divRango">
									...
									<div class="col-lg-4"> 
										<label for="TipoTitulo"><h3>Tipos de Datos</h3></label>
  ...
  <div class="panel-group" id="accordion">
	...
	<script>
		function verDetalle()
		{
			...
			var TipoDatos = $("#TipoTitulo").val();
			
			 $.ajax({
				url: 'Ajax/DataReporteGeneral.php',
				type: 'POST',
				data: {fechaInicial:fechaInicial,fechaFinal:fechaFinal, TipoDatos:TipoDatos},
				beforeSend: function()
				{
					$('#GifCargando').show();
				},
