			...
			<div class="container">
				...
				<div class="card">
					<div class="card-head style-primary">
							<h3 class="text-center"><strong>EVENTOS Y FORMACIÓN</strong></h3>
						</div>
						<div class="card-body">
  ...
  <div class="panel-group" id="accordion">
	...
	<script>
		function verDetalle()
		{
			...
			$.ajax({
				url: 'Ajax/DetalleEventosFormacion.php',
				type: 'POST',
				data: {mes:mes, fechaFinal: fechaFinal, fechaInicial: fechaInicial, anio: anio, dia:dia},
				beforeSend: function()
				{
					$('#GifCargando').show();
				},
