...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Categoría de Productos</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
						<h4 class="text-center"><strong>Categoría de Productos</strong></h4>
						</div>
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<tbody>
								<?php
									$Consulta = "SELECT * FROM Bodega.CATEGORIA_PRODUCTO ORDER BY CP_NOMBRE";
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										echo '<tr>';
										    	...
										    	echo '<td style="font-size: 10px">'.$row["CP_NOMBRE"].'</td>';
										    	echo '<td><a href="CPMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
