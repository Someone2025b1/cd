...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="IngresoBPro.php" method="POST" role="form">
					<div class="col-lg-12">
						<br>
						<div class="card">
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											<input class="form-control" type="text" name="CodigoPoliza" id="CodigoPoliza" value="<?php echo $Correlativo; ?>" required readonly/>
