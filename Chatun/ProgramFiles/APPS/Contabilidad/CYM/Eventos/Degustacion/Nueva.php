			...
			<div class="card">
				<div class="card-body">
					<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
						<form action="NuevaPro.php" method="POST" class="form floating-label form-validation" role="form" novalidate="novalidate" id="FRMEnviar">
							...
							<div class="form-wizard-nav">
								...
								<ul class="nav nav-justified nav-pills">
									...
									<li><a href="#step4" data-toggle="tab"><span class="step">4</span> <span class="title">FINALIZAR</span></a></li>
								</ul>
