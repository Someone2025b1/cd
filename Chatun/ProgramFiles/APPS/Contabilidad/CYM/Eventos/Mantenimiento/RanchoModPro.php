						...
						<div class="card-body">
							<div class="row">
								<?php
									...
									$Query = mysqli_query($db, "UPDATE Bodega.RANCHO SET R_NOMBRE = '".$Nombre."', R_ESTADO = ".$Estado.", R_PRECIO_UNITARIO = ".$PrecioUnitario." WHERE R_CODIGO = ".$Codigo);
			                        ...
			                        for($i=0; $i<count($_FILES['Fotografia']['name']); $i++) 
			                        {
			                            ...
			                            if ($tmpFilePath != "")
			                            {
			                                ...
			                                if(move_uploaded_file($tmpFilePath, $newFilePath)) //Comprobar si no existe un error en la subida
			                                {
			                                    ...
			                                    $sql = mysqli_query($db, "INSERT INTO Bodega.FOTOGRAFIA_RANCHO (R_REFERENCIA, FR_RUTA, FR_OBSERVACIONES) 
									...
									if($Query)
									{
										echo '<div class="col-lg-12 text-center">
											...
											<h2 class="text-light">El Rancho se ingresó correctamente.</h2>
											<div class="row">
												<div class="col-lg-12 text-center"><a href="Ranchos.php"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></div>
										</div>';
									}
									else
									{
										echo '<div class="col-lg-12 text-center">
												...
												<h2 class="text-light">Lo sentimos, no se pudo ingresar el Rancho.</h2>
											</div>';
