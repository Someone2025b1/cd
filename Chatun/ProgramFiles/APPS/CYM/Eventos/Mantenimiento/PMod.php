						...
						<div class="card">
							...
							<div class="card-body">
								...
								while($row = mysqli_fetch_array($Resultado))
								{
									...
									$Nomenclatura = $row["N_CODIGO"];
								}
								?>
								<div class="row">
									<div class="col-lg-1">
										<div class="form-group floating-label" id="DIVCIF">
										<input class="form-control" type="hidden" name="PoseeCodigo" id="PoseeCodigo" value="<?php echo $CodigoBarras; ?>" required readonly/>
										...
										<div class="form-group">
											<select name="Categoria" id="Categoria" class="form-control" required>
												<?php
                                                    ...
                                                    $query = "SELECT * FROM Bodega.CATEGORIA_PRODUCTO WHERE CP_CODIGO = 'EVE' ORDER BY CP_NOMBRE";
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group floating-label">
											<input class="form-control" type="number" step="any" name="Precio" id="Precio" value="<?php echo $Precio; ?>"  required/>
											...
											<select name="Nomenclatura" id="Nomenclatura" class="form-control" required>
												<?php
                                                    ...
                                                    while($row = mysqli_fetch_array($result))
                                                    {
                                                        ...
                                                        echo '<option value="'.$row["N_CODIGO"].'" '.$Selected.'>'.$row["N_CODIGO"].' - '.$row["N_NOMBRE"].'</option>';
                                                    }
									...
									<div class="row">
										<div class="col-lg-12">
											...
											<div class="row">
												<div>
													<div class="form-group floating-label">
														<input class="form-control" type="text" name="CodigoBarrasActual" id="CodigoBarrasActual" value="<?php echo $CodigoBarras; ?>" readonly />
														<label for="CodigoBarrasActual">Código Barras</label>
													</div>
													<canvas id="bcTarget2">   
												</div>
											</div>
