			...
			<div class="container">
				...
				<div class="card">
					<div class="card-head style-primary">
                        ...
                        <label  style="color:black"><h4 style="color:#8bc34a">Producto</h4></label>
						<br>
											<select name="Producto" id="Producto" data-live-search="true" class="selectpicker" required>
												<option value="" disabled selected>Seleccione Producto</option>
												<?php
	                                                    //Select para obtener los tipos de falta de la base de datos y creación de las opciones del input select
												$query = "SELECT * FROM Productos.PRODUCTO ORDER BY P_NOMBRE";
	...
	<script>
		function verDetalle()
		{
			...
			var Producto = $("#Producto").val();
			 ...
			 $.ajax({
				url: 'Ajax/DataKardexGeneralPP.php',
				type: 'POST',
				data: {fechaInicial:fechaInicial,fechaFinal:fechaFinal, Producto:Producto},
				beforeSend: function()
				{
					$('#GifCargando').show();
				},
