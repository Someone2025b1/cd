				...
				<form class="form" method="POST" role="form">
					<?php
						...
						$sql = mysqli_query($db, "INSERT INTO Productos.PRODUCCION_SUBRECETA (PR_CODIGO, PR_FECHA, PR_HORA, PR_USUARIO, PR_PUNTO)
											VALUES ('".$CodPR."', CURRENT_DATE(), CURRENT_TIMESTAMP(),'".$id_user."', 'CAFE')");
						...
						VALUES('".$KCod."', '".$CodPR."', '".$Prod."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Baja de producto por producción de Subreceta ', '".$existenciaGAn."', '".$cantidadgen."', 4, '".$existenciaAn."', '".$nuevaexistencia."')");
					...
					while($rowe = mysqli_fetch_array($result))
					{
						...
						$nuevaexistencia = $rowe["P_EXISTENCIA_CAFE"] + $CantidadP;
					...
					VALUES('".$KCod."', '".$CodPR."', '".$ProdP."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Aumento de producto por producción de Subreceta ', '".$existenciaGAn."', '".$cantidadgen."', 4, '".$existenciaAn."', '".$nuevaexistencia."', '".$PrecioAn."', '".$PrecioEntro."', '".$PrecioNuevoSubreceta."')");
					}
