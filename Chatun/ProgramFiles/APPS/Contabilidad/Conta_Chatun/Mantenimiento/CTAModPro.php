...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	?>
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Edición de Cuenta Bancaria</strong><br></h1>
				<br>
				<?php
					$sql = mysqli_query($db, "UPDATE Contabilidad.CUENTA SET CTA_NUMERO = '".$NumeroCuenta."', CTA_NOMBRE = '".$Nombre."', B_CODIGO = ".$Banco." WHERE CTA_CODIGO = '".$CodigoContable."'");
					...
					if(!$sql) //Si el query tuvo algún problema que despligue error y que la ejecución del código se detenga
					{
						...
						echo '<div class="col-lg-12 text-center">
								...
								<h4 class="text-light">Código de transacción: '.$CodigoContable.'</h4>
								</div>';
					...
					{
						$sql1 = mysqli_query($db, "UPDATE Contabilidad.NOMENCLATURA SET N_NOMBRE = '".$Nombre."' WHERE N_CODIGO = '".$CodigoContable."'");
