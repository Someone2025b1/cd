...
function Cezpdf($paper='a4',$orientation='portrait'){
	...
	if (!is_array($paper)){
		switch (strtoupper($paper)){
			case '4A0': {$size = array(0,0,76,297); break;}
			...
			case 'A2': {$size = array(0,0,396.00,612.00); break;}
      ...
      case 'A11': {$size = array(0,0,612.00,396.00); break;}
...
function ezTable(&$data,$cols='',$title='',$options=''){
  ...
  $defaults = array(
    'shaded'=>1,'showLines'=>1,'shadeCol'=>array(0.8,0.8,0.8),'shadeCol2'=>array(0.7,0.7,0.7),'fontSize'=>8,'titleFontSize'=>10
