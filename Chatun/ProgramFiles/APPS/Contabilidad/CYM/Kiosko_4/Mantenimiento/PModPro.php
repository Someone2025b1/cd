	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<?php
					$sql = mysqli_query($db,"UPDATE Bodega.PRODUCTO SET P_NOMBRE = '".$_POST["Nombre"]."', P_STOCK_MINIMO = ".$_POST["Stock"].", CP_CODIGO = '".$_POST["Categoria"]."'  WHERE P_CODIGO = '".$_POST["CodigoProducto"]."'");
