...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Clientes Eventos</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<?php
									...
									{
										$Codigo = $row["CE_CODIGO"];
										echo '<tr>';
										    	echo '<td style="font-size: 10px">'.$Contador.'</td>';               
										    	echo '<td style="font-size: 10px">'.$row["CE_CUI"].'</td>';
										    	echo '<td style="font-size: 10px">'.$row["CE_NIT"].'</td>';
										    	echo '<td style="font-size: 10px">'.$row["CE_NOMBRE"].'</td>';
										    	echo '<td><a href="ClienteMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
