...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Precios</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<tbody>
								<?php
									$Consulta = "SELECT * FROM Taquilla.PRECIO ORDER BY PRE_NOMBRE";
									$Resultado = mysqli_query($db, $Consulta);
									while($row = mysqli_fetch_array($Resultado))
									{
										$Codigo = $row["PRE_CODIGO"];
										echo '<tr>';
										    	echo '<td style="font-size: 10px">'.$row["PRE_NOMBRE"].'</td>';               
										    	echo '<td style="font-size: 10px">Q. '.number_format($row["PRE_PRECIO"], 2).'</td>';
										    	echo '<td><a href="PreciosMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
