...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Lista de Solicitudes de Desarrollo En Proceso</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						...
						<input type="hidden" name="TipoEvento" value="<?php echo $tipodereevento ?>">
							...
							<table class="table table-hover table-condensed" id="tbl_resultados">
								<thead>
									...
									<th><strong>FECHA EN PROCESO</strong></th>
								</thead>
                                
								<tbody>
								<?php
									$Contador = 1;
									$Consulta = "SELECT * FROM Desarrollo.DESARROLLO AS A WHERE A.ED_ESTADO = 1 ORDER BY A.D_FECHA ";
