			...
			<div class="card">
				<div class="card-body">
					<?php
						...
						$Query = mysqli_query($db, "UPDATE Bodega.COTIZACION SET C_FECHA_EVENTO = '".$Fecha."',
																		C_HORA_INICIO_EVENTO = '".$HoraInicio."',
																		C_HORA_FIN_EVENTO    = '".$HoraFin."',
																		TE_CODIGO            = '".$TipoEvento."',
																		...
																		CE_TELEFONO          = '".$Telefono."',
																		CE_EMAIL             = '".$Email."',
																		C_INVITADOS_ADULTOS  = '".$Adultos."',
																		C_INVITADOS_NINOS    = '".$Ninos."',
																		C_TIPO_MONTAJE       = '".$MontajeSeleccionado."',
																		C_RANCHO             = '".$RanchoSeleccionado."'
																		WHERE C_REFERENCIA   = '".$CodigoUnico."'")or die('Error 4'.mysqli_error());

						$QueryDelete = mysqli_query($db, "DELETE FROM Bodega.PLATILLO_EVENTO WHERE C_REFERENCIA = '".$CodigoUnico."'");
						...
						$QueryDelete = mysqli_query($db, "DELETE FROM Bodega.MOBILIARIO_EVENTO WHERE C_REFERENCIA = '".$CodigoUnico."'");
						...
						$QueryDelete = mysqli_query($db, "DELETE FROM Bodega.MOBILIARIO_EVENTO_ALQUILER WHERE C_REFERENCIA = '".$CodigoUnico."'");
						...
						$QueryDelete = mysqli_query($db, "DELETE FROM Bodega.SERVICIO_EVENTO_CONTRATADO WHERE C_REFERENCIA = '".$CodigoUnico."'");
					...
					<div class="col-lg-12 text-center">
						...
						<h2 class="text-light">La cotización se modificó correctamente.</h2>
						<div class="col-lg-12 text-center">
							<?php
								if($EnvioEmail == 1)
								{
									?>
										<a target="_blank" href="Cotizacion_Imp.php?Codigo=<?php echo $_POST[CodigoCoti] ?>&Envio=1"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span> Imprimir</button></a>
									<?php
								}
								else
								{
									?>
										<a target="_blank" href="Cotizacion_Imp.php?Codigo=<?php echo $_POST[CodigoCoti] ?>&Envio=0"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span> Imprimir</button></a>
									<?php	
								}
							?>
						</div>
