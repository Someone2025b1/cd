									...
									$Sancion = $_POST["Tipo"];
			                            ...
			                            if ($tmpFilePath != "")
			                            {
			                                ...
			                                if(move_uploaded_file($tmpFilePath, $newFilePath)) //Comprobar si no existe un error en la subida
			                                {
			                                    ...
			                                    $Query = mysqli_query($db, "INSERT INTO Taquilla.LISTA_NEGRA(LN_CIF_ASOCIADO, LN_OBSERVACIONES, LN_RUTA_ARCHIVO, LN_CIF_COLABORADOR, LN_TIPO, LN_ESTADO)
															VALUES('".$CIF."', '".$Razon."', '".$newFilePath."', '".$id_user."', '".$Sancion."', '".$Estado."')")or die(mysqli_error());
