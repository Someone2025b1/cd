...
$sql = "SELECT * FROM Bodega.FACTURA_TQ_4 AS A LEFT JOIN Bodega.RESOLUCION AS B ON A.RES_NUMERO = B.RES_NUMERO WHERE A.F_CODIGO = '".$Factura."'";
...
$sqlD = "SELECT * FROM Bodega.FACTURA_TQ_4_DETALLE WHERE F_CODIGO = '".$Factura."'";
