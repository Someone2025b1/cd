					...
					for($i=1; $i<$ContadorD; $i++)
					{
						...
						$query = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV_DESCRIPCION (F_CODIGO, FD_CODIGO, FD_CANTIDAD, FD_DESCRIPCION, FD_PRECIO_UNITARIO, FD_SUBTOTAL)
							...
							$SubNetoD = $SubD - $IVAProductoD;
								...
								$XMLEnviar .= '
						          <dte:Item BienOServicio="'.$TipoFactura.'" NumeroLinea="'.$i.'">
...
$QueryEvento= mysqli_query($db, "UPDATE Eventos.EVENTO SET
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO, F_DESCRIPCIONES)
...
$QueryEvento= mysqli_query($db, "UPDATE Eventos.EVENTO SET
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA, F_DESCRIPCIONES)
							...
							$SubNetoD = $SubD - $IVAProductoD;
								...
								$XMLEnviar .= '
						          <dte:Item BienOServicio="'.$TipoFactura.'" NumeroLinea="'.$i.'">
						            ...
						            <dte:UnidadMedida>UND</dte:UnidadMedida>
						            <dte:Descripcion>'.$ProD.'</dte:Descripcion>
						            <dte:PrecioUnitario>'.number_format($PreD, 6, '.', '').'</dte:PrecioUnitario>
						            <dte:Precio>'.number_format($SubD, 6, '.', '').'</dte:Precio>
						            <dte:Descuento>'.$Des.'</dte:Descuento>
						            <dte:Impuestos>
						              <dte:Impuesto>
						                <dte:NombreCorto>IVA</dte:NombreCorto>
