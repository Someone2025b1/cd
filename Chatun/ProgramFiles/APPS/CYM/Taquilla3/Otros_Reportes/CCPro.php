...
WHERE b.ACC_FECHA = '".$_POST["FechaInicio"]."' AND b.ACC_TIPO = 16"));

if(!$Conteo){
	
$Conteo = mysqli_num_rows(mysqli_query($db, "SELECT *FROM Bodega.CIERRE_DETALLE_PARCIAL a 
INNER JOIN Bodega.APERTURA_CIERRE_CAJA b ON a.ACC_CODIGO = b.ACC_CODIGO
WHERE b.ACC_FECHA = '".$_POST["FechaInicio"]."' AND b.ACC_TIPO = 16"));
}
		...
		<div id="content">
			<?php
				...
				$sql = "SELECT APERTURA_CIERRE_CAJA.*, CIERRE_DETALLE.* 
						...
						AND APERTURA_CIERRE_CAJA.ACC_TIPO = 16  $filtroOtro";
				...
				$Query = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
				...
				$Query1 = "SELECT COUNT(F_CODIGO) AS FACTURAS_ANULADAS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_ESTADO = 2";
				...
				$Query3 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_DOLARES FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_LEMPIRAS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 3";
				$Result4 = mysqli_query($db,$Query4);
				while($row4 = mysqli_fetch_array($Result4))
				{
				...
				$Query5 = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 4";
				...
				$Query6 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 3";
				...
				$Query7 = "SELECT SUM(F_TOTAL) AS TOTAL_EFECTIVO FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 1";
				...
				$Query9 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_LEMPIRA FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 3";
				...
				$Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 2";
				...
				$Query11 = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
			...
			<div class="container"> 
					<div class="col-lg-12">
						<div class="panel-group" id="accordion6">
							...
							$Query6P = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial' AND F_TIPO = 3";
							...
							$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial'";
							...
							$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial'";
							...
							$Query3p = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial' AND F_TIPO = 2";
							...
							$Query5p = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS = '$Fecha1' AND F_HORA <='$HoraParcial' AND F_TIPO = 4";
							$Result5p = mysqli_query($db,$Query5p);
							while($row5p = mysqli_fetch_array($Result5))
							{
								$TotalDeposito1 = $row5p["TOTAL_DEPOSITOS"];
							}	
