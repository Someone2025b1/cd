...
while($row = mysqli_fetch_array($ResultCuentas))
{
    ...
    while($fila = mysqli_fetch_array($rest))
    {
        ...
        if ($Producto==1199) {
           $CostoUnitarioExistencia = 14.31227;
        }
        else
        {
        ...
        if($Existencia != 0)
        {
            $Data[] = array('col1'=>$Producto, 'col2'=>utf8_decode($ProductoNombre), 'col3'=>$UnidadMedida, 'col4'=>$ExistenciaMost, 'col5'=>$CostoUnitarioMostrar, 'col6'=>$CostoTotalMostrar);
