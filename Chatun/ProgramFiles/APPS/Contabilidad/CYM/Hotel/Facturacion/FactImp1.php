...
$sql = "SELECT * FROM Bodega.FACTURA_HS WHERE F_CODIGO = '".$Factura."'";
$result = mysqli_query($db, $db, $db, $sql);
...
$resultCliente = mysqli_query($db, $db, $db, $sqlCliente);
...
$TablaProducto .= <<<EOD
    <tr>
    <td align="left" style="font-size: 35px; width: 80px;">1</td>
    <td align="left" style="font-size: 35px; width: 270px;">Hot Dog Chatun</td>
    <td align="right" style="font-size: 35px; width: 120px;">15.00</td>
    <td align="right" style="font-size: 35px; width: 120px;">15.00</td>
    </tr>
EOD;
...
$TablaProducto .= <<<EOD
    <tr>
    <td align="left" style="font-size: 35px; width: 80px;">1</td>
    <td align="left" style="font-size: 35px; width: 270px;">Coca Cola</td>
    <td align="right" style="font-size: 35px; width: 120px;">10.00</td>
    <td align="right" style="font-size: 35px; width: 120px;">10.00</td>
    </tr>
EOD;

$sqlD = "SELECT FACTURA_HS_DETALLE.*, RECETA_SUBRECETA.RS_NOMBRE AS NOMBRE
...
$resultD = mysqli_query($db, $db, $db, $sqlD);
while($rowD = mysqli_fetch_array($resultD))
{
    $Cantidad  = $rowD["FD_CANTIDAD"];
    $NombreProd  = $rowD["RS_NOMBRE"];
    $PrecioUnitario  = number_format($rowD["FD_PRECIO_UNITARIO"], 2, '.', ',');
    $Subtotal  = number_format($rowD["FD_SUBTOTAL"], 2, '.', ',');
    $TablaProducto .= <<<EOD
    <tr>
    <td align="left" style="font-size: 40px; width: 80px;">$Cantidad</td>
    <td align="left" style="font-size: 40px; width: 270px;">$NombreProd</td>
    <td align="right" style="font-size: 40px; width: 120px;">$PrecioUnitario</td>
    <td align="right" style="font-size: 40px; width: 120px;">$Subtotal</td>
    </tr>
EOD;
}
...
$ResultRes = mysqli_query($db, $db, $db, $SQLRes);
