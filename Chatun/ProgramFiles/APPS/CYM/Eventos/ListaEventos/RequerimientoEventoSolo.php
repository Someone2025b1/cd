			...
			<div class="container">
				...
				<div class="col-lg-12">
					...
					<div class="col-lg-12">
						...
						A.EV_HORA_INI, A.EV_HORA_FIN, A.EV_CANTIDAD_PERSONAS, A.EV_OBSERVACIONES, EV_NOMBRE, EV_FECHA_CRE,
						EV_FECHAMOD, EV_HORAINGRESO, EV_HORAMOD
						FROM Eventos.EVENTO AS A, Eventos.EV_DETALLE_MERCADEO AS B
						WHERE (A.EV_FECHA_EV >= NOW()) 
