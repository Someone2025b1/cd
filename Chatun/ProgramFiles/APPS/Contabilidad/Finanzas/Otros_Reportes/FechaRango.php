...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="ReporteHoraPDF.php" method="POST" role="form" target="_blank">
					<div class="col-lg-12">
						<br>
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Reporte Ventas</strong></h4>
							</div>
							<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="input-group-content" align="center">
												<label>Hora</label>
													...
													<div class="form-control-line" align="center"></div>
												</div>
												<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="ConFinDe" id="ConFinDe">
												<span>Incluir Fin De Semanas</span>
											</label>
										</div>
											</div>
											</div>
