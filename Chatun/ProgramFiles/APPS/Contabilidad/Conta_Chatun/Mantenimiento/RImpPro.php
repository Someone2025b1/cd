						...
						<div class="card-body">
							<table class="table table-hover table-condensed">
								...
								<tbody>
									...
									$Query = "SELECT TRANSACCION.TRA_CODIGO, TRANSACCION.TRA_CONCEPTO, TRANSACCION.TRA_NO_HOJA, TRANSACCION.TRA_TOTAL, TIPO_TRANSACCION.TT_NOMBRE
									 ...
									 AND (TRANSACCION.TT_CODIGO <> 4 AND TRANSACCION.TT_CODIGO <> 5 AND TRANSACCION.TT_CODIGO <> 6 AND TRANSACCION.TT_CODIGO <> 7 AND TRANSACCION.TT_CODIGO <> 8)";
									 ...
									 while($row = mysqli_fetch_array($Result))
									 {
									 	?>
											...
											<tr>
												<td><?php echo $row["TT_NOMBRE"].' '.$row["TRA_NO_HOJA"]; ?></td>
												<td><?php echo $row["TRA_CONCEPTO"]; ?></td>
												<td><?php echo 'Q. '.number_format($row["TRA_TOTAL"], 2, '.', ','); ?></td>
												<td><a href="ImpPartida2.php?Codigo=<?php echo $row['TRA_CODIGO']; ?>"><button type="button" class="btn btn-sm btn-warning">
