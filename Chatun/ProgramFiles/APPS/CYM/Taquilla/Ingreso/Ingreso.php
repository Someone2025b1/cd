...
<head>
    ...
    <script>
    	...
    	{
    		var CantidadMenor = $('#CantidadMenores').val();
			var CIFAsociado = $('#CIFAsociado').val();
			
    		
    		$.ajax({
    				url: 'AgregarAcompananteMenor.php',
    				type: 'post',
    				data: 'CantidadMenor='+CantidadMenor+'&CifAsignar='+CIFAsociado,
    				success: function (data) {
    					if(data == 1)
    					{
    						$('#FormularioAcompanantesMenores')[0].reset();
    						$('#DatosDemograficosAsociados').show();
							$('#ModalIngresoAsociadosMenores').modal('hide');
    						alertify.success('Acompañante Ingresado '+CantidadMenor);
    						LlenarTablaAsociados();
    					}
    					else
    					{
    	...
    	function EliminarAcompanante(x,y)
    	{
    		$.ajax({
    				url: 'EliminarAcompananteTemporal.php',
    				type: 'post',
    				data: 'Codigo='+x+'&Asociado='+y,
    				success: function (data) {
    					LlenarTablaAsociados();
    					MostrarAcompaniante();
		...
		function Imprimir(x)
		{
			...
			newwindow=window.open('ImpTiket.php?Cantidad='+x,'name','toolbar=1,scrollbars=1,location=1,statusbar=0,menubar=1,resizable=1,width=800,height=600');
		...
		function ConsultarVale(x)
        {
		        ...
		        $.ajax({
		            ...
		            beforeSend: function()
		            {
		            	$('#ResVale').html('<img src="../../../../../img/Preloader.gif" />');
		            },
		            success: function(data) {
		            	if(data == 0)
		            	{
							   ...
							   <div class="form-group col-lg-6" id="SIGuatemalaNoAsociado" style="display: none">
								...
								<div class="form-group" id="SiSalvador" style="display: none">
						  		...
						  		<div class="form-group" id="SiHonduras" style="display: none">
									...
									<table class="table table-hover">
										...
										<tbody>
										<?php
										$QueryProductosIngreso = mysqli_query($db, "SELECT * FROM Bodega.PRODUCTO WHERE (P_CODIGO = 821 OR P_CODIGO = 822 OR P_CODIGO = 823 OR P_CODIGO = 1510 OR P_CODIGO = 2557 ) ORDER BY P_NOMBRE");
                                ...
                                <div id="hoteles" style="display: none">
									...
									<div class="col-lg-2">
                                            ...
                                            <input type="text" step="any" min="0" class="form-control" id="ConVale" name="ConVale" onchange="ConsultarVale(this)" placeholder="CONSULTAR VALE">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
										...
										<div class="col-lg-4">
                                            <div class="form-group">
                                            <label for="cantAdultoM">Cantidad Adulto Mayor</label>
                                            <input type="number" step="any" min="0" class="form-control" id="cantAdultoM" name="cantAdultoM">
                                            </div>
                                        </div>
		...
		<div class="modal fade" id="ModalIngresoAsociadosMenores" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog" style="width: 80%">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form" id="FormularioAcompanantesMenores">
							<input type="hidden" name="CIFAsociado" id="CIFAsociado">
							<div class="row">
								<div class="form-group col-lg-6">
									...
									<div class="col-lg-12">
										<label>
											<input type="number" class="form-control" name="CantidadMenores" id="CantidadMenores">
										</label>
									</div><!--end .col -->
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header" align="center">
                        ...
                        <h2 class="modal-title">Resultados del Vále</h2>
                    </div>
                    <div class="modal-body">
                    	<div id="ResVale" class="text-center"></div>
                    </div>
                </div>
            </div>
        </div>
