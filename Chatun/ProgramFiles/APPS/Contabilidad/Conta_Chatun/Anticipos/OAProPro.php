					...
					<div class="card">
						...
						<?php
							...
							else
							{
								...
								<div class="row">
									<div class="col-lg-6 text-right"><a href="OAImpNew.php?Codigo='.$CodigoTransaccion.'" target="_blank"><button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-print"></span> Imprimir</a></div>
