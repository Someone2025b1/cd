...
$sqlD = "SELECT FACTURA_KS_2_DETALLE.*, PRODUCTO.P_NOMBRE 
                FROM Bodega.FACTURA_KS_2_DETALLE, Productos.PRODUCTO 
                WHERE FACTURA_KS_2_DETALLE.RS_CODIGO = PRODUCTO.P_CODIGO
