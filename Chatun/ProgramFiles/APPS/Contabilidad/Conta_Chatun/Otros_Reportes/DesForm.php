...
<head>
	...
	function EnviarForm()
	{
		...
		if(Opcion == 1)
		{
			$(Formulario).attr('action', 'DesTerrazas.php');
			$(Formulario).submit();
		}
		else if(Opcion == 2)
		{
			$(Formulario).attr('action', 'DesMirador.php');
			$(Formulario).submit();
		}
		else if(Opcion == 3)
		{
			$(Formulario).attr('action', 'DesCafe.php');
			$(Formulario).submit();
		}
		else if(Opcion == 4)
		{
			$(Formulario).attr('action', 'DesSouvenirs.php');
			$(Formulario).submit();
		}
		else if(Opcion == 5)
		{
			$(Formulario).attr('action', 'DesTilapia.php');
			$(Formulario).submit();
		}
					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Reporte Descuentos</strong></h4>
							</div>
							<div class="card-body">
									...
									<div class="col-lg-6">
										<div class="form-group">
											<select class="form-control" name="TipoCierre" id="TipoCierre">
												<option value="" disabled selected>Seleccione Restaurante</option>
												<option value="3">Café Los Abuelos</option>
												<option value="1">Las Terrazas</option>
												<option value="2">Mirador</option>
												<option value="4">Souvenirs</option>
												<option value="5">Tilapia</option>
											</select>
										</div>
									</div>	
									<div class="col-lg-3"></div>
