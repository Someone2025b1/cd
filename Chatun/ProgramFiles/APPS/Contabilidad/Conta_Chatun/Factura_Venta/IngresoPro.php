					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Ingreso de Factura de Venta</strong></h4>
							</div>
							<div class="card-body">
							<?php
								...
								if($SerieFactura == 'A' || $SerieFactura == 'BU')
								{
									$TipoTransaccion = 3;
								}
								elseif($SerieFactura == 'B')
								{
									$TipoTransaccion = 4;
								}
								elseif($SerieFactura == 'C')
								{
									$TipoTransaccion = 5;
								}
								...
								if($Tipo == 'NE')
								{
									...
									$sql = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_NO_HOJA, TRA_FECHA_TRANS, TRA_SERIE, TRA_FACTURA, TRA_FACTURA_AL, TC_CODIGO, TRA_CONCEPTO, TRA_TOTAL, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_CORRELATIVO, TRA_SALDO, TRA_TIPO_FACTURA_VENTA, PC_CODIGO)
														VALUES('".$UI."', '".$Comprobante."', '".$Fecha."', '".$SerieFactura."', '".$FacturaDel."', '".$FacturaAl."', '".$TipoCompra."', '".$Concepto."', ".$TotalFactura.", CURRENT_DATE(), CURRENT_TIMESTAMP(), '".$UserID ."', 2, ".$TipoTransaccion.", ".$Correlativo.", ".$TotalFactura.", 'NE', ".$Periodo.")");
								}
								else
								{
									$queryCorrelativo = "SELECT MAX(TRA_CORRELATIVO) AS CORRELATIVO FROM Contabilidad.TRANSACCION WHERE PC_CODIGO = ".$Periodo;
									...
									$sql = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_NO_HOJA, TRA_FECHA_TRANS, TRA_SERIE, TRA_FACTURA, TRA_FACTURA_AL, TC_CODIGO, TRA_CONCEPTO, TRA_TOTAL, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_CORRELATIVO, TRA_CIF_COLABORADOR, TRA_SALDO, TRA_TIPO_FACTURA_VENTA, PC_CODIGO)
														VALUES('".$UI."', '".$Comprobante."', '".$Fecha."', '".$SerieFactura."', '".$FacturaDel."', '".$FacturaAl."', '".$TipoCompra."', '".$Concepto."', ".$TotalFactura.", CURRENT_DATE(), CURRENT_TIMESTAMP(), '".$UserID ."', 2, ".$TipoTransaccion.", ".$Correlativo.", ".$CIFSolicitante.", ".$TotalFactura.", 'FE', ".$Periodo.")");
								}
