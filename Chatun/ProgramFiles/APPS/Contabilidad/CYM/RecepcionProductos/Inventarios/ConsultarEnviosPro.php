			...
			<div class="container">
				...
				<div class="col-lg-12">
					...
					<div class="col-lg-12">
                        ...
                        $CONT=1;
                        $Consulta = "SELECT A.*
                        FROM Productos.EX_PUNTOS_ENVIOS AS A
                        WHERE A.EPE_PUNTO = '$Punto' AND A.EPE_FECHA BETWEEN '$fecha_inicio' AND '$fecha_fin' ORDER BY A.EPE_FECHA ";
                        $Resultado = mysqli_query($db, $Consulta);
                        while($row = mysqli_fetch_array($Resultado))
                        {

                            $CodigoEnvio = $row["EPE_CODIGO"];
                            $Fecha1 = $row["EPE_FECHA"];
											...
											?> 	
												<table class="table table-hover table-condensed">
                                                    ...
                                                    <tr>
															...
															<td><h5><b>Canidad Había</b></h5></td>
															<td><h5><b>Cantidad Recibida</b></h5></td>
                                                    ...
                                                    FROM Productos.EX_PUNTOS_ENVIOS_DET AS B, Productos.PRODUCTO AS C
                                                    WHERE B.EPE_CODIGO = '$CodigoEnvio'
                                                    ...
                                                    while($row1 = mysqli_fetch_array($Resultado1))
                                                    {
                                                      ...
                                                      ?>
														<tr>
															...
															<td><h5><b><?php echo number_format($row1["EPED_CANTIDAD_ANTERIOR"], 2, '.', ','); ?></b></h5></td>
															<td><h5><b><?php echo number_format($row1["EPED_CANTIDAD"], 2, '.', ','); ?></b></h5></td>
															<td><h5><b><?php echo number_format($row1["EPED_CANTIDAD_QUEDO"], 2, '.', ','); ?></b></h5></td>
															</tr>
