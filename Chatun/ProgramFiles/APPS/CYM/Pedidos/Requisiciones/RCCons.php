									...
									<table class="table table-hover table-condensed" name="tabla" id="tabla">
                                        ...
                                        <tbody>
                                            <tr class="fila-base">
		                                                ...
		                                                <td><input align="right" type="text" class="form-control" name="Descripcion[]" id="Descripcion[]" value="<?php echo $row['RD_PRODUCTO'] ?>"></td>
														<td><h6><select name="Clasificacion" id="Clasificacion[]" class="form-control" style="width: 150px" required>
																		...
																		<div >
																							<input type="file" name="documento2[]" id="documento2[]">
																		...
																		<div >
																							<input type="file" name="documento3[]" id="documento3[]">
		                                                ...
		                                                <td><input align="right" type="text" class="form-control" name="Sugerencia[]" id="Sugerencia[]" value="<?php echo $row['RD_OBSERVACION'] ?>"></td>
		                                                <td class="eliminar">
