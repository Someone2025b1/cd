...
$SqlNit = "SELECT DFE_NIT FROM Contabilidad.DETALLE_FACTURA_ESPECIAL  
WHERE TRA_CODIGO = '$Factura'";
$ResulNit = mysqli_fetch_array(mysqli_query($db, $SqlNit));
$sqlCliente = "SELECT q.P_NOMBRE FROM Contabilidad.PROVEEDOR q WHERE q.P_DPI = '".$ResulNit["DFE_NIT"]."'";
$resultCliente = mysqli_query($db, $sqlCliente);
while($rowC = mysqli_fetch_array($resultCliente))
{
    $Nombre  = $rowC["P_NOMBRE"];
}
$NitRec = $ResulNit["DFE_NIT"];

$tbl2 .= <<<EOD
<table cellspacing="0" cellpadding="1" border="0">   
          <tr>  
            <td style="width:150px"><img src="logo.png"  width="90" height="50"></td>
            <td style="width:250px" align="center"><h3>Factura Especial</h3></td> 
          </tr>     
</table> 
EOD;
...
<table cellspacing="2" cellpadding="1" border="0">
    ...
    <td align="left" style="font-size: 8px; width: 200px;">Fecha y hora de emisión: $Fecha</td> 
    </tr>
    <tr>
    <td align="left" style="font-size: 9px; width: 400px;">NIT Receptor: $NitRec</td>
    <td align="left" style="font-size: 8px; width: 200px;">Fecha y hora de certificación: $FechaCert</td> 
    </tr>
    <tr>
...
$sqlD = "SELECT DFE_CANTIDAD, DFE_DESCRIPCION, DFE_PRECIO, DFE_SUBTOTAL, DFE_TIPO FROM Contabilidad.DETALLE_FACTURA_ESPECIAL  
WHERE TRA_CODIGO = '$Factura'";
...
while($rowD = mysqli_fetch_array($resultD))
{
    ...
    $Cantidad  = number_format($rowD["DFE_CANTIDAD"], 0, '.', ',');
    $NombreProd  = $rowD["DFE_DESCRIPCION"];
    $PrecioUnitario  = number_format($rowD["DFE_PRECIO"], 2, '.', ','); 
    $Subtotal  = number_format($rowD["DFE_SUBTOTAL"], 2, '.', ',');
    $Iva = number_format(($rowD["DFE_SUBTOTAL"]/1.12)*0.12,2);
    $Tipo = $rowD["DFE_TIPO"];
    if ($Tipo=='B') {
       $TipoD = "Bien";
    }
...
EOD;
    $TotalT += $rowD["DFE_SUBTOTAL"];
    $TotalI += ($rowD["DFE_SUBTOTAL"]/1.12)*0.12;
    $Cont++;
}
...
<table cellspacing="2" cellpadding="1" border="0">
    <tr>
    <td align="left" style="font-size: 9px; width: 200px;">Complemento *Retenciones factura especial*</td>
    </tr>
    <tr>
    <td align="left" style="font-size: 9px; width: 100px;">Retención de ISR:</td>
    <td align="left" style="font-size: 8px; width: 100px;">$ISR</td> 
    </tr>
    <tr>
    <td align="left" style="font-size: 9px; width: 100px;">Retención del IVA:</td>
    <td align="left" style="font-size: 8px; width: 100px;">$IVA</td> 
    </tr>
     <tr>
    <td align="left" style="font-size: 9px; width: 100px;">Total factura menos retenciones:</td>
    <td align="left" style="font-size: 8px; width: 100px;">$Total</td> 
    </tr> 
EOD;
//****************** CUSTOMIZACION **************************
//***********************************************************
