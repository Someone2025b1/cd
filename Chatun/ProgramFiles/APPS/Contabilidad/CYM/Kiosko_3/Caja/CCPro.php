								...
								<div id="accordion6-1" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="card panel"> 
										...
										<table class="table" id="tbl_resultados">
											...
											<tbody>
												<?php
													$SqlFacturas = "SELECT FACTURA_KS_3.* FROM Bodega.FACTURA_KS_3
																	WHERE FACTURA_KS_3.F_FECHA_TRANS = '".$_GET["FechaInicio"]."' AND FACTURA.F_USUARIO = '".$_GET["Usuario"]."'
																	ORDER BY FACTURA_KS_3.F_SERIE, FACTURA_KS_3.F_NUMERO";
