				...
				<form class="form" role="form">
					<div class="col-lg-12">
						...
						<div class="card">
							...
							$QueryEN = mysqli_query($db, "UPDATE Productos.ENVIOS SET EN_ESTADO = 2 WHERE EN_CODIGO = '$CodEN'");
...
if(!$QueryEN)
{
	...
	$Centinela = false;
							...
							$querysa = "SELECT * FROM Productos.ENVIOS_DETALLE WHERE EN_CODIGO = '$CodEN'";
							...
							while($rowe = mysqli_fetch_array($resultsa))
							{
								...
								VALUES('".$KCod."', '".$CodEN."', '".$Pro."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Envío de producto interno de ".$Envia." a Bodega General', '".$existenciagen."', '".$existenciagen."', 2, '".$existenciasou."', '".$newcantsou."', '-', '-', '-')");
								...
								VALUES('".$KCod."', '".$CodEN."', '".$Pro."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Envío de producto interno de ".$Envia." a Bodega General', '".$existenciagen."', '".$existenciagen."', 5, '".$existenciabode."', '".$newcantbo."', '-', '-', '-')");
