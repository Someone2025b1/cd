	...
	<?php
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<form class="form" action="EditarEventoPro.php" method="POST" role="form">
					<div class="col-lg-12">
						<div class="card">
                        <div class="card-body">
							...
							<div class="row">
									...
									<div class="col-lg-4">
										...
										<div class="col-lg-2">
										<div class="form-group floating-label">
                                        <label for="FechaCreo">Fecha Creo</label>
											<input class="form-control" type="text" name="FechaCreo" id="FechaCreo" value="<?php echo $FechaCreo ?>" readonly/>
											
										</div>
										</div>
										<div class="col-lg-2">
										<div class="form-group floating-label">
                                        <label for="HoraCreo">Hora Creo</label>
											<input class="form-control" type="text" name="HoraCreo" id="HoraCreo" value="<?php echo $HoraCreo ?>" readonly/>
											
										</div>
										</div>
										<div class="col-lg-2">
										<div class="form-group floating-label">
                                        <label for="FechaModifico">Fecha Modificado</label>
											<input class="form-control" type="text" name="FechaModifico" id="FechaModifico" value="<?php echo $FechaMod ?>" readonly/>
											
										</div>
										</div>
										<div class="col-lg-2">
										<div class="form-group floating-label">
                                        <label for="HoraMod">Hora Modificado</label>
											<input class="form-control" type="text" name="HoraMod" id="HoraMod" value="<?php echo $HoraMod ?>" readonly/>
							...
							<div class="row">
									<div class="col-lg-4">
                                        ...
                                        <label for="NombreDueno">Nombre del Dueño del Evento</label>
											<input class="form-control" type="text" name="NombreDueno" id="NombreDueno" value="<?php echo $Dueno ?>" required/>
									...
									<div class="col-lg-4">
                                        ...
                                        <label for="Celular">Número de Celular</label>
											<input class="form-control" type="text" name="Celular" id="Celular" value="<?php echo $Cel ?>" required/>
								...
								<div class="row">
									<div class="col-lg-6">
                                        ...
                                        <label for="Fecha">Fecha del Evento</label>
											<input class="form-control" type="date" name="Fecha" id="Fecha" value="<?php echo $FechaEvento ?>" required/>
										</div>
									</div>
									<div class="col-lg-3">
										<div class="form-group floating-label">
                                        <label for="HoraIni">Hora de Inicio</label>
											<input class="form-control" type="time" name="HoraIni" id="HoraIni" value="<?php echo $HoraIni ?>" required/>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <label for="HoraFin">Hora de Fiunalización</label>
											<input class="form-control" type="time" name="HoraFin" id="HoraFin" value="<?php echo $HoraFin ?>" required/>
								...
								<div class="row">
									<div class="col-lg-6">
                                        ...
                                        <label for="Personas">Cantidad de Personas</label>
											<input class="form-control" type="num" name="Personas" id="Personas" value="<?php echo $CantidadPersona ?>" required/>
										</div>
									</div>
									...
									<div class="col-lg-3">
										...
										<select name="Lugar" id="Lugar" class="form-control" onchange="Otro(this.value)">
                                                ...
                                                <option value="Salón Pilares" <?php if($Lugar=="Salón Pilares"){echo "selected"; $Otro=0;}?>>Salón Pilares</option>
                                    ...
                                    <div class="form-group floating-label" id="DIVOTRO" <?php if($Otro==0){ echo 'style="display: none;"';  }?>>
                                        <label for="Paga">Otro</label>
											<input class="form-control" type="text" name="OtroLugar" id="OtroLugar" value="<?php if($Otro==1){ echo $Lugar;}?>" />
                                ...
                                <div class="row">
									<div class="col-lg-12">
										...
										<textarea class="form-control" name="ObservacionesGen" id="ObservacionesGen" rows="2" cols="40"><?php echo $ObservacionesGen?></textarea>
								...
								<div id="accordion6-1" class="collapse" aria-expanded="false" style="height: 0px;">
									<div class="card-body">
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Bocina" id="Bocina" <?php if($Bocina==1){ echo 'checked';  } ?>>
												<span>Bocina</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Microfonos" id="Microfonos" <?php if($Microfonos==1){ echo 'checked';  } ?>>
												<span>Microfonos</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Musica" id="Musica" <?php if($Musica==1){ echo 'checked';  } ?>>
												<span>Música</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="MusicaInstrumental" id="MusicaInstrumental" <?php if($MusicaInstrumental==1){ echo 'checked';  } ?>>
												<span>Música Instrumental</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Proyector" id="Proyector" <?php if($Proyector==1){ echo 'checked';  } ?>>
												<span>Proyector</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Extenciones" id="Extenciones" <?php if($Extenciones==1){ echo 'checked';  } ?>>
                                ...
                                <div class="row">
									<div class="col-lg-12">
										...
										<textarea class="form-control" name="ObservacionesMerca" id="ObservacionesMerca" rows="2" cols="40"><?php echo $ObservacionesMercadeo?></textarea>
										</div>
									</div>
									</div>
											</div>
                            ...
                            <div class="card panel"><!-- Requerimientos Operaciones -->
								...
								<div id="accordion6-2" class="collapse" aria-expanded="false" style="height: 0px;">
                                    ...
                                    <div class="form-group floating-label" id="DIVOTROMONTAJE" <?php if($OtroEstilo==0){ echo 'style="display: none;"';  }?>>
                                        <label for="OtroMontaje">Otro</label>
											<input class="form-control" type="text" name="OtroMontaje" id="OtroMontaje"  value="<?php echo $TipoMontaje?>" />
									...
									<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Pizarra" id="Pizarra" <?php if($Pizarra==1){ echo 'checked';  } ?>>
												<span>Pizarra</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Pantalla" id="Pantalla" <?php if($Pantalla==1){ echo 'checked';  } ?>>
												<span>Pnatalla</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="MesaSonido" id="MesaSonido" <?php if($MesaSonido==1){ echo 'checked';  } ?>>
												<span>Mesa Sonido</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="ManteleriaCompleta" id="ManteleriaCompleta" <?php if($ManteleriaCompleta==1){ echo 'checked';  } ?>>
												<span>Manteleria Completa</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Tarima" id="Tarima" <?php if($Tarima==1){ echo 'checked';  } ?>>
												<span>Tarima</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="MesaProyector" id="MesaProyector" <?php if($MesaProyector==1){ echo 'checked';  } ?>>
												<span>Mesa Proyector</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="MesaAYB" id="MesaAYB" <?php if($MesaAyB==1){ echo 'checked';  } ?>>
												<span>Mesa Para AyB</span>
											</label>
										</div>
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="SobreMantel" id="SobreMantel" <?php if($SobreMantel==1){ echo 'checked';  } ?> onchange="Color(this)">
                                        ...
                                        <label for="ColorSobremantel">Color Sobremantel</label>
											<input class="form-control" type="text" name="ColorSobremantel" id="ColorSobremantel" value="<?php echo $ColorSobremantel?>" />
									...
									<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="MesasExtra" id="MesasExtra" <?php if($MesasExtra>0){ echo 'checked';  } ?> onchange="Mesas(this)">
                                        ...
                                        <label for="CantidadMesasExtra">Cantidad</label>
											<input class="form-control" type="number" name="CantidadMesasExtra" id="CantidadMesasExtra" value="<?php echo $MesasExtra?>"/>
											</div>
											<div class="col-lg-4">
                                        <label for="DescripcionMesas">Descripción</label>
											<input class="form-control" type="text" name="DescripcionMesas" id="DescripcionMesas" value="<?php echo $MesasPara?>"/>
									...
									<div class="form-group floating-label">
										...
										<textarea class="form-control" name="MesasSillas" id="MesasSillas" rows="2" cols="40"><?php echo $MesasSillas?></textarea>
									</div>
                                ...
                                <div class="row">
									<div class="col-lg-12">
										...
										<textarea class="form-control" name="ObservacionesOperaciones" id="ObservacionesOperaciones" rows="2" cols="40"><?php echo $ObservacionesOperaciones?></textarea>
                            ...
                            <div class="card panel"><!-- Requerimientos AyB -->
								...
								<div id="accordion6-3" class="collapse" aria-expanded="false" style="height: 0px;">
									<div class="card-body">
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="CheckDesayuno" id="CheckDesayuno" <?php if($CodigoDes){ echo 'checked';  } ?> onchange="Desayuno(this)">
												<span>Desayuno</span>
											</label>
										</div>
										</div>
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="CheckRefaAM" id="CheckRefaAM" <?php if($CodigoRefaAM){ echo 'checked';  } ?> onchange="RefaAM(this)">
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="CheckAlmuerzo" id="CheckAlmuerzo" <?php if($CodigoAl){ echo 'checked';  } ?> onchange="Almuerz(this)">
												<span>Almuerzo</span>
											</label>
										</div>
										</div>
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="CheckRefaPM" id="CheckRefaPM" <?php if($CodigoRefaPM){ echo 'checked';  } ?> onchange="RefaPM(this)">
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="CheckCena" id="CheckCena" <?php if($CodigoCen){ echo 'checked';  } ?> onchange="Cena(this)">
												<span>Cena</span>
											</label>
										</div>
										</div>
								...
								<div id="accordion-2" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="CodigoDes">Codigo del Desayuno</label>
											...
											<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="AdultoD" id="AdultoD" <?php if($AdultoD==1){ echo 'checked';  } ?> onchange="AdultoDes(this)">
												<span>Adulto</span>
											</label>
										</div>
                                        ...
                                        <label for="CantidadAdultoD">Cantidad Adultos</label>
											<input class="form-control" type="number" name="CantidadAdultoD" id="CantidadAdultoD" value="<?php echo $CantidadAdultoD?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuAdultoD">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoD" id="MenuAdultoD" value="<?php echo $MenuAdultoD?>" />
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="NinoD" id="NinoD" <?php if($NinoD==1){ echo 'checked';  } ?> onchange="NinoDes(this)">
												<span>Niño</span>
											</label>
										</div>
                                        ...
                                        <label for="CantidadNinoD">Cantidad Niños</label>
											<input class="form-control" type="number" name="CantidadNinoD" id="CantidadNinoD" value="<?php echo $CantidadNinoD?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuNinoD">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoD" id="MenuNinoD" value="<?php echo $MenuNinoD?>"/>
                                        ...
                                        <label for="HoraD">Hora de Servir</label>
											<input class="form-control" type="time" name="HoraD" id="HoraD" value="<?php echo $HoraD?>"/>
									...
									<div class="col-lg-4">
                                        <label for="EstiloD">Estilo</label>
											<input class="form-control" type="text" name="EstiloD" id="EstiloD" value="<?php echo $EstiloD?>"/>
											
											</div>

											<div class="col-lg-12">
                                        <label for="AdicionalesD">Adicionales</label>
										<textarea class="form-control" name="AdicionalesD" id="AdicionalesD" rows="2" cols="40"><?php echo $AdicionalesD?></textarea>
							...
							<!--Refaccion AM -->
							<div class="card panel"  id="DIVREFAAM"<?php if(!$CodigoRefaAM){ echo 'style="display: none;"';  }?>>
								...
								<div id="accordion-1" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="CodigoRefaAM">Codigo de la Refa a.m.</label>
											<input class="form-control" type="text" name="CodigoRefaAM" id="CodigoRefaAM" value="<?php echo $CodigoRefaAM ?>" readonly/>
											...
											<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="AdultoRAM" id="AdultoRAM" <?php if($AdultoRAM==1){ echo 'checked';  } ?> onchange="AdultoAM(this)">
												<span>Adulto</span>
											</label>
										</div>
										
										<div class="form-group floating-label" id="DIVADULTORAM" <?php if($AdultoRAM==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadAdultoRAM">Cantidad Adultos</label>
											<input class="form-control" type="number" name="CantidadAdultoRAM" id="CantidadAdultoRAM"  value="<?php echo $CantidadAdultoRAM?>"/>
											</div>
											<div class="col-lg-4">
                                        <label for="MenuAdultoRAM">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoRAM" id="MenuAdultoRAM" value="<?php echo $MenuAdultoRAM?>" />
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="NinoRAM" id="NinoRAM" <?php if($NinoRAM==1){ echo 'checked';  } ?> onchange="NinoAM(this)">
												<span>Niño</span>
											</label>
										</div>
										<div class="form-group floating-label" id="DIVNINORAM" <?php if($NinoRAM==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadNinoRAM">Cantidad Niños</label>
											<input class="form-control" type="number" name="CantidadNinoRAM" id="CantidadNinoRAM" value="<?php echo $CantidadNinoRAM?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuNinoRAM">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoRAM" id="MenuNinoRAM" value="<?php echo $MenuNinoRAM?>" />
                                        ...
                                        <label for="HoraRAM">Hora de Servir</label>
											<input class="form-control" type="time" name="HoraRAM" id="HoraRAM" value="<?php echo $HoraRAM?>"/>
									...
									<div class="col-lg-4">
                                        <label for="EstiloRAM">Estilo</label>
											<input class="form-control" type="text" name="EstiloRAM" id="EstiloRAM" value="<?php echo $EstiloRAM?>" />
											
											</div>

											<div class="col-lg-12">
                                        <label for="AdicionalesRAM">Adicionales</label>
										<textarea class="form-control" name="AdicionalesRAM" id="AdicionalesRAM" rows="2" cols="40"><?php echo $AdicionalesRAM?></textarea>
								...
								<div id="accordion-3" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="CodigoAl">Codigo del Almuerzo</label>
											<input class="form-control" type="text" name="CodigoAl" id="CodigoAl" value="<?php echo $CodigoAl ?>" readonly/>
											...
											<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="AdultoA" id="AdultoA"<?php if($AdultoA==1){ echo 'checked';  } ?> onchange="AdultoAl(this)">
												<span>Adulto</span>
											</label>
										</div>
										
										<div class="form-group floating-label" id="DIVADULTOA" <?php if($AdultoA==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadAdultoA">Cantidad Adultos</label>
											<input class="form-control" type="number" name="CantidadAdultoA" id="CantidadAdultoA" value="<?php echo $CantidadAdultoA?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuAdultoA">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoA" id="MenuAdultoA" value="<?php echo $MenuAdultoA?>" />
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="NinoA" id="NinoA" <?php if($NinoA==1){ echo 'checked';  } ?> onchange="NinoAl(this)">
												<span>Niño</span>
											</label>
										</div>
										<div class="form-group floating-label" id="DIVNINOA" <?php if($NinoA==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadNinoA">Cantidad Niños</label>
											<input class="form-control" type="number" name="CantidadNinoA" id="CantidadNinoA" value="<?php echo $CantidadNinoA?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuNinoA">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoA" id="MenuNinoA" value="<?php echo $MenuNinoA?>" />
                                        ...
                                        <label for="HoraA">Hora de Servir</label>
											<input class="form-control" type="time" name="HoraA" id="HoraA" value="<?php echo $HoraA?>" />
									...
									<div class="col-lg-4">
                                        <label for="EstiloA">Estilo</label>
											<input class="form-control" type="text" name="EstiloA" id="EstiloA" value="<?php echo $EstiloA?>" />
											
											</div>

											<div class="col-lg-12">
                                        <label for="AdicionalesA">Adicionales</label>
										<textarea class="form-control" name="AdicionalesA" id="AdicionalesA" rows="2" cols="40"><?php echo $AdicionalesA?></textarea>
								...
								<div id="accordion-4" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="CodigoRefaPM">Codigo de la Refa p.m.</label>
											<input class="form-control" type="text" name="CodigoRefaPM" id="CodigoRefaPM" value="<?php echo $CodigoRefaPM ?>" readonly/>
											...
											<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="AdultoRPM" id="AdultoRPM" <?php if($AdultoRPM==1){ echo 'checked';  } ?> onchange="AdultoPM(this)">
												<span>Adulto</span>
											</label>
										</div>
										
										<div class="form-group floating-label" id="DIVADULTORPM" <?php if($AdultoRPM==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadAdultoRPM">Cantidad Adultos</label>
											<input class="form-control" type="number" name="CantidadAdultoRPM" id="CantidadAdultoRPM" value="<?php echo $CantidadAdultoRPM?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuAdultoRAM">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoRPM" id="MenuAdultoRPM" value="<?php echo $MenuAdultoRPM?>"/>
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="NinoRPM" id="NinoRPM" <?php if($NinoRPM==1){ echo 'checked';  } ?> onchange="NinoPM(this)">
												<span>Niño</span>
											</label>
										</div>
										<div class="form-group floating-label" id="DIVNINORPM" <?php if($NinoRPM==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadNinoRPM">Cantidad Niños</label>
											<input class="form-control" type="number" name="CantidadNinoRPM" id="CantidadNinoRPM" value="<?php echo $CantidadNinoRPM?>"/>
											</div>
											<div class="col-lg-4">
                                        <label for="MenuNinoRPM">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoRPM" id="MenuNinoRPM" value="<?php echo $MenuNinoRPM?>"/>
                                        ...
                                        <label for="HoraRPM">Hora de Servir</label>
											<input class="form-control" type="time" name="HoraRPM" id="HoraRPM" value="<?php echo $HoraRPM?>"/>
									...
									<div class="col-lg-4">
                                        <label for="EstiloRPM">Estilo</label>
											<input class="form-control" type="text" name="EstiloRPM" id="EstiloRPM" value="<?php echo $EstiloRPM?>"/>
											
											</div>

											<div class="col-lg-12">
                                        <label for="AdicionalesRPM">Adicionales</label>
										<textarea class="form-control" name="AdicionalesRPM" id="AdicionalesRPM" rows="2" cols="40"><?php echo $AdicionalesRPM?></textarea>
								...
								<div id="accordion-5" class="collapse" aria-expanded="false" style="height: 0px;">
									...
									<div class="col-lg-12">
                                        ...
                                        <label for="CodigoCen">Codigo de la Cena</label>
											<input class="form-control" type="text" name="CodigoCen" id="CodigoCen" value="<?php echo $CodigoCen ?>" readonly/>
											...
											<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="AdultoC" id="AdultoC" <?php if($AdultoC==1){ echo 'checked';  } ?> onchange="AdultoCen(this)">
												<span>Adulto</span>
											</label>
										</div>
										
										<div class="form-group floating-label" id="DIVADULTOC" <?php if($AdultoC==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadAdultoC">Cantidad Adultos</label>
											<input class="form-control" type="number" name="CantidadAdultoC" id="CantidadAdultoC" value="<?php echo $CantidadAdultoC?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuAdultoC">Menu Adulto</label>
											<input class="form-control" type="text" name="MenuAdultoC" id="MenuAdultoC" value="<?php echo $MenuAdultoC?>"/>
										...
										<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="NinoC" id="NinoC" <?php if($NinoC==1){ echo 'checked';  } ?> onchange="NinoCen(this)">
												<span>Niño</span>
											</label>
										</div>
										<div class="form-group floating-label" id="DIVNINOC" <?php if($NinoC==0){ echo 'style="display: none;"';  }?>>
										
										<div class="col-lg-4">
                                        <label for="CantidadNinoC">Cantidad Niños</label>
											<input class="form-control" type="number" name="CantidadNinoC" id="CantidadNinoC" value="<?php echo $CantidadNinoC?>" />
											</div>
											<div class="col-lg-4">
                                        <label for="MenuNinoC">Menu Niño</label>
											<input class="form-control" type="text" name="MenuNinoC" id="MenuNinoC" value="<?php echo $MenuNinoC?>"/>
                                        ...
                                        <label for="HoraC">Hora de Servir</label>
											<input class="form-control" type="time" name="HoraC" id="HoraC" value="<?php echo $HoraC?>"/>
									...
									<div class="col-lg-4">
                                        <label for="EstiloC">Estilo</label>
											<input class="form-control" type="text" name="EstiloC" id="EstiloC" value="<?php echo $EstiloC?>"/>
											
											</div>

											<div class="col-lg-12">
                                        <label for="AdicionalesC">Adicionales</label>
										<textarea class="form-control" name="AdicionalesC" id="AdicionalesC" rows="2" cols="40"><?php echo $AdicionalesC?></textarea>
							...
							<div class="row">
									<div class="col-lg-12">
										...
										<textarea class="form-control" name="ObservacionesAyB" id="ObservacionesAyB" rows="2" cols="40"><?php echo $ObservacionesAyB?></textarea>
										</div>
									</div>
									</div>
