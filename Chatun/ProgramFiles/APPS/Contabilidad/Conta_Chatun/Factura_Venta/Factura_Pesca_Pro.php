			...
			if($TipoPago == 1)
			{
				...
				else
				{
					...
					for($i=0; $i<$Contador; $i++)
					{
						...
						$query = mysqli_query($db, "INSERT INTO Bodega.FACTURA_PS_DETALLE (F_CODIGO, FD_CODIGO, FD_CANTIDAD, RS_CODIGO, RS_NOMBRE, FD_PRECIO_UNITARIO, FD_SUBTOTAL, FD_DESCUENTO, FD_UNIDADES)
											VALUES('".$Uid."', '".$UidD."', ".$Can.", '".$Pro."', '".$Nom."', ".$Pre.", ".$SubFac.", ".$Des.", '".$UnidVn."')"); 
			...
			elseif($TipoPago == 4)
			{
				...
				else
				{
					...
					****************************************************************************************/
					...
					$SqlContableD = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '1.01.02.008', ".number_format($TotalFacturaFinal, 2, ".", "").", 0.00)");
