...
<head>
	...
	<script>
		...
		{
			var btn = document.querySelector('#btnDes');
			$.ajax({
				url: 'BuscarNIT.php',
				type: 'POST',
				data: 'id='+x,
		            ...
		            success: function(data) {
		            	...
		            	else
		            	{
			                ...
			                $('.suggest-element').click(function(){
			                    x.value = $(this).attr('dataProducto')+"/"+$(this).attr('data');
...
<body class="menubar-hoverable header-fixed menubar-pin " <?php if(isset($_GET["Mesa"])){echo 'onload="CalcularTotal()"';} ?>>
	...
	$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA_RS WHERE F_SERIE = '".$Serie."' ORDER BY F_NUMERO DESC LIMIT 1";
	...
	$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = CURRENT_DATE ORDER BY F_ORDEN DESC LIMIT 1";
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 7";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 7 AND ACC_ESTADO = 2";
												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														<?php
															if(isset($_GET["Mesa"]))
															{
																$Sql_DatosOrdenEncabezado = mysqli_query($db, "SELECT * FROM Bodega.MESA WHERE M_CODIGO = ".$_GET["Mesa"]);
																$Fila_DatosOrdenEncabezado = mysqli_fetch_array($Sql_DatosOrdenEncabezado);
															}
															else
															{
																$Fila_DatosOrdenEncabezado["M_NOMBRE_FACTURA"] = '';
																$Fila_DatosOrdenEncabezado["M_NIT_FACTURA"] = '';
																$Fila_DatosOrdenEncabezado["M_DIRECCION_FACTURA"] = '';
															}
														?>
														<div class="row">
														<div class="col-lg-12">
														...
														<label class="radio-inline radio-styled" >
															<input type="radio" value="N" name="TipoCompra" onChange="ComprobarTipo(this)" checked required>
															<span>NIT</span>
														</label>
														<label class="radio-inline radio-styled">
													...
													<input class="form-control" type="hidden" name="TipoDoc" id="TipoDoc" value="N" required/>
															...
															<div class="col-lg-9">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Nombre" id="Nombre" <?php if($Fila_DatosOrdenEncabezado["M_NOMBRE_FACTURA"] != ''){echo 'value="'.$Fila_DatosOrdenEncabezado[M_NOMBRE_FACTURA].'"';}else{echo 'value="Consumidor Final"';} ?> onkeyup="ComprobarAcentos(this)" required />
														...
														<div class="row">
															<div class="col-lg-12">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Direccion" id="Direccion" <?php if($Fila_DatosOrdenEncabezado["M_DIRECCION_FACTURA"] != ''){echo 'value="'.$Fila_DatosOrdenEncabezado[M_DIRECCION_FACTURA].'"';}else{echo 'value="Ciudad"';} ?> onkeyup="ComprobarAcentos(this)"  required />
														...
														<div class="form-group">
															<div class="col-lg-3">
																<button type="button" class="btn btn-success btn-md" id="btnDes" onclick="AgregarDescuentoPrev()">
																...
																<tbody>
																	<tr class="fila-base">
						                                                ...
						                                                <td><h6><input type="hidden" class="form-control" name="Producto[]" id="Producto[]"></h6>
						                                                	<h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 500px" onchange="BuscarProducto(this)"></h6></td>
						                                            ...
						                                            if(isset($_GET["Mesa"]))
						                                            {
						                                            	$Sql_DatosOrden = mysqli_query($db, "SELECT A.*, B.P_NOMBRE, B.P_PRECIO_VENTA
						                                            		...
						                                            		?>
									                                            <tr>
									                                                ...
									                                                <td><h6><input type="hidden" class="form-control" name="Producto[]" id="Producto[]" value="<?php echo $Fila_DatosOrden["RS_CODIGO"] ?>"></h6>
									                                                	<h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 500px" value="<?php echo $Fila_DatosOrden["RS_CODIGO"]."/".$Fila_DatosOrden["P_NOMBRE"] ?>" readonly></h6></td>
									                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]"  style="width: 100px" min="0" step="any" style="text-align: right" value="<?php echo $Fila_DatosOrden["P_PRECIO_VENTA"] ?>" readonly></h6></td>
									                                                <td><h6><input type="number" class="form-control InputDescuento" name="Descuento[]" id="Descuento[]" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" onchange="CalcularTotal()"></h6></td>
