	...
	<div id="base">
		...
		<div id="content">
			<?php
				...
				$Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA_KS_4FACTURA_KS_4 WHERE F_FECHA_TRANS = '".$Fecha."' AND F_MONEDA = 2";
