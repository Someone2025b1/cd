...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Mobiliario</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
								...
								<?php
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										echo '<tr>';
										    	...
										    	echo '<td style="font-size: 10px">'.$row["M_NOMBRE"].'</td>';
										    	echo '<td style="font-size: 10px">'.$row["TM_NOMBRE"].'</td>';
										    	echo '<td style="font-size: 10px">'.number_format($row["M_DISPONIBILIDAD_TOTAL"], 2).'</td>';
										    	echo '<td><a href="MobiliarioMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
