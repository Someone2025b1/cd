																...
																<tbody>
																	...
																	if(isset($_POST["CodigoProducto"]) && isset($_POST["Cantidad"]) && isset($_POST["Valor"]) && isset($_POST["Total"]))
																	{
																		...
																		<tr>
							                                                ...
							                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]" value="<?php echo $Valor[0] ?>" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
							                                            ...
							                                            <tr>
							                                                ...
							                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]" value="<?php echo $Valor[1] ?>" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
							                                            ...
							                                            <tr>
							                                                ...
							                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]" value="<?php echo $Valor[2] ?>" readonly style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
