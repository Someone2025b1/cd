			...
			<div class="container">
				<?php
						...
						{ 
							$Consulta = "SELECT *FROM Bodega.CIERRE_DETALLE_PARCIAL a WHERE a.ACC_CODIGO = '$CodigoCierre'";
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										$TCQ+=$row["CD_TOTAL_Q"];
										$TotalDolares+=$row["CD_TOTAL_D"];
										$TotalLempiras+=$row["CD_TOTAL_L"];
									}
					...
					{ 
						...
						$sql1 = mysqli_query($db,"UPDATE Bodega.APERTURA_CIERRE_CAJA SET ACC_TIENE_PARCIAL=1 WHERE ACC_CODIGO = '".$CodigoCierre."'") or die(mysqli_error());
