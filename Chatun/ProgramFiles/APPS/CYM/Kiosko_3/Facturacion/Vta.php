...
<head>
	...
	<script>
		...
		{	
			...
			TipoProd[Indice].value = $(x).attr('dataTipo');
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA_KS_3 WHERE F_SERIE = '".$Serie."' ORDER BY F_NUMERO DESC LIMIT 1";
	...
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 11";
															...
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	<tr class="fila-base">
						                                                ...
						                                                <td><h6><input type="hidden" class="form-control" name="Producto[]" id="Producto[]"></h6><input type="hidden" class="form-control" name="TipoProd[]" id="TipoProd[]"></h6>
					...
					<div class="col-lg-3 col-md-6">
						<div class="panel panel-primary">
							<div class="panel-heading">
								<div class="row">
									<div class="col-xs-12 text-center">
										<a onClick="AbrirModalResultados(999)" style="text-decoration: none; cursor: pointer"><div>Helados</div></a>
									</div>
								</div>
							</div>
						</div>
	...
	<div id="ModalResultados" class="modal fade" role="dialog">
		<div class="modal-dialog" style="width: 100%">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row" id="Resultados"  style="width:1250px; height: 400px; overflow: scroll;">
