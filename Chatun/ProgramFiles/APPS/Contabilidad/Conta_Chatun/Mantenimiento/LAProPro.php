				...
				<div class="col-lg-12">
					<div class="card">
						...
						<?php
							...
							$sql = mysqli_query($db, "UPDATE Contabilidad.ACTIVO_FIJO SET AF_NOMBRE = '".$NombreActivo."', AF_RESPONSABLE = ".$CIFResponsable.", AF_AREA = ".$Area.", TA_CODIGO = ".$TipoActivo.", AF_OBSERVACIONES = '".$Descripcion."' WHERE AF_CODIGO = '".$CodigoActivo."' ") or die(mysqli_error());
							...
							if($sql)
							{
								...
								<div class="row">
									<div class="col-lg-12 text-center"><a href="LA.php"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></div>
								</div>';
							}
							else
							{
