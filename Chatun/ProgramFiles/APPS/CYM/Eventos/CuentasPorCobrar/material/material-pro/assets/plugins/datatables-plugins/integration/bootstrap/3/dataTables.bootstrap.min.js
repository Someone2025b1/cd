...
c(a.currentTarget).hasClass("disabled")||q.page(a.data.action).draw(!1)};j=0;for(m=f.length;j<m;j++)if(a=f[j],c.isArray(a))o(b,a);else{e=d="";switch(a){case "ellipsis":d="&hellip;";e="disabled";case "first":d=i.sFirst;e=a+(0<h?"":" disabled");case "previous":d=i.sPrevious;e=a+(0<h?"":" disabled");case "next":d=i.sNext;e=a+(h<l-1?"":" disabled");case "last":d=i.sLast;e=a+(h<l-1?"":" disabled");default:d=a+1,e=h===a?"active":""}d&&(n=c("<li>",{"class":r.sPageButton+" "+
