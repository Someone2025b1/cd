...
$GuardarNoAsociado = mysqli_query($db, "INSERT INTO Taquilla.INGRESO_NO_ASOCIADO VALUES (NULL, '$NombreNoAsociado', 73, $depto, $municipio, $SelectVisitaEsquipulas, $EnteradoNoAsociado, $EdadNoAsociado, $SelectAsisteconNoAsociado, $FrecuenciaVisitaNoAsociado, '$CorreoNoAsociado', '$NumeroTelefonoNoAsociado', $SelectConociaParque, $BuscaNoAsociado, $id_user, CURDATE(), 0, 0, $CantidadMenor) ") or die("Error en guardar No Asociado".mysqli_error());
