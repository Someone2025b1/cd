...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Alquiler de Mobiliario</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
							...
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<?php
									...
									$Consulta = "SELECT A.*, B.TM_NOMBRE
													...
													ORDER BY A.MA_NOMBRE";
									$Resultado = mysqli_query($db, $Consulta);
									while($row = mysqli_fetch_array($Resultado))
									{
										$Codigo = $row["MA_CODIGO"];
										echo '<tr>';
										    	echo '<td style="font-size: 10px">'.$Contador.'</td>';               
										    	echo '<td style="font-size: 10px">'.$row["MA_NOMBRE"].'</td>';
										    	echo '<td style="font-size: 10px">'.$row["TM_NOMBRE"].'</td>';
										    	echo '<td><a href="MobiliarioAlqMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
