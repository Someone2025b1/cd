...
$Codigo = $row["N_CODIGO"];
$Nombre = $row["N_NOMBRE"];
$Cargos = number_format($row["TRAD_CARGO_CONTA"],2);
$Abonos = number_format($row["TRAD_ABONO_CONTA"],2);
$Cargos1 = $row["TRAD_CARGO_CONTA"];
$Abonos1 = $row["TRAD_ABONO_CONTA"];
...
EOD;
$TotalCargos = $TotalCargos + $Cargos1;
$TotalAbonos = $TotalAbonos + $Abonos1;
}
