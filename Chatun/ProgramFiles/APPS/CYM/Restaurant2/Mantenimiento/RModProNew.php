			...
			<div class="container">
				...
				<?php
					...
					$Nombre = $_POST["Nombre"];
						...
						$sql = mysqli_query($db, "UPDATE Productos.RECETA SET R_NOMBRE = '".$Nombre."', R_PRECIO = '".$Total."', R_CANTIDAD_BOLAS = '".$CantidadBolas."', R_TERRAZAS = '".$Terrazas."', R_MIRADOR = '".$Mirador."', R_CAFE = '".$Cafe."', R_EVENTO = '".$Eventos."', R_GUARNICION = '".$Guarnicion."', R_DESCUENTO = '".$Descuento."' WHERE R_CODIGO = '".$CodigoReceta."'");
