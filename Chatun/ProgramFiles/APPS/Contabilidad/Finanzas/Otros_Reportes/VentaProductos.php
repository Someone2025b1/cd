...
<h4 class="text-center"><strong>Venta de Proiductos</strong></h4>
</div>
<div class="card-body">
<div class="row text-center"> 
	...
	<div align="center">
					...
					<div class="col-lg-4"> 
			<label for="SelecPunto"><h3>Punto de Venta</h3></label>
			<select name="SelecPunto" class="form-control" id="SelecPunto" required>
			 <option disabled="" selected>Seleccione una opción</option> 
			 <option value="8">Todos Los Puntos</option> 		
			 <option value="1">Terrazas</option>
			 <option value="2">Mirador</option>
			 <option value="3">Helados</option>
			 <option value="4">Caafé Los Abuelos</option> 
			 <option value="5">Kiosco Azados</option> 
			 <option value="6">Kiosco Oasis</option> 
			 <option value="7">Kiosco Pasillo</option> 
			 <option value="9">Souvenirs</option> 
			 <option value="10">Juegos</option> 
			 <option value="11">Eventos</option> 
			 <option value="12">Taquilla</option> 
			 <option value="13">Pizzeria</option> 
			</select>
	</div>
...
<div id="detalle"></div>
		...
		<script>
			function verDetalle()
			{
				...
				var dia = $("#dia").val();
				var punto = $("#SelecPunto").val();
				$.ajax({
						url: 'Ajax/VentaProductosDetalle.php',
						type: 'post',
						data: {mes: mes, anio: anio, fechaInicial: fechaInicial, fechaFinal: fechaFinal, dia: dia, punto:punto},
						beforeSend: function()
						{
							$('#GifCargando').show();
						},
