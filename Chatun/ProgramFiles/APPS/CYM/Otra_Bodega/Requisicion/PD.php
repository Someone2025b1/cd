					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Solicitudes Pendientes de Despacho</strong></h4>
							</div>
							<div class="card-body">
								<div class="row text-center">
									...
									$query = "SELECT REQUISICION.*, BODEGA.B_NOMBRE
												...
												AND REQUISICION.RT_CODIGO = 2
												AND REQUISICION.R_ESTADO = 1
												AND REQUISICION.B_CODIGO = 6";
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											echo '<tr>';
												...
												echo '<td><a href="SolicitudDetalle.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
															<span class="glyphicon glyphicon-share-alt"></span> Despachar
														</button></a></td>';
												echo '<td><a href="CancelarRequisicion.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-danger btn-xs">
									...
									else
									{
										?>
											<div class="alert alert-callout alert-success" role="alert">
												Actualmente <strong>no hay</strong> solicitudes pendientes de despacho.
											</div>
										<?php
									}
