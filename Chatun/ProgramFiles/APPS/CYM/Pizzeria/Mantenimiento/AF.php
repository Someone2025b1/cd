							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA_PIZZA.*, CLIENTE.* 
														FROM Bodega.FACTURA_PIZZA, Bodega.CLIENTE 
														WHERE FACTURA_PIZZA.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA_PIZZA.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA_PIZZA.F_NUMERO = ".$_POST["Numero"]."
														ORDER BY FACTURA_PIZZA.F_TOTAL ASC";
