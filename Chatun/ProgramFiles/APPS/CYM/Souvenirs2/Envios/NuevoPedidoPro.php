					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							#ESTO ES DE LA POLIZA, ingresa a transación y detallle de transacción
								...
								$QueryEncabezado = mysqli_query($db, "INSERT INTO Productos.ENVIOS (EN_CODIGO, EN_ESTADO, EN_ENVIA, EN_RECIBE, EN_FECHA_SOLICITUD, EN_HORA_SOLICITUD, EN_DESCRIPCION, EN_USUARIO, EN_TOTAL_PRODUCTOS)
																VALUES ('".$CodEN."', 1, '".$Bodega."', 2, CURRENT_DATE(), CURRENT_TIMESTAMP(), '".$Descripcion."', '".$UserID."', '".$Total."')");
								...
								else
								{
									for($j=1; $j<$Contador; $j++)
									{
										...
										$queryd = mysqli_query($db, "INSERT INTO Productos.ENVIOS_DETALLE (EN_CODIGO, END_CODIGO, END_CORRELATIVO, P_CODIGO, END_CANTIDAD)
															VALUES('".$CodEN."', '".$CodEND."', '".$j."', '".$Prod."', '".$Can."')");
