								...
								<div class="card card-underline">
									...
									<div class="card-body tab-content">
										<div class="tab-pane active" id="first2">
											<form action="APPro.php" method="POST" role="form" class="form" >
												<div class="row">
													<div class="col-lg-3">
										...
										<div class="tab-pane" id="second2">
											<form action="APPartida.php" method="POST" role="form" class="form">
												<div class="row">
													<div class="col-lg-3">
														<div class="form-group">
															<input class="form-control" type="number" name="Partida" id="Partida" value="<?php echo date('Y-m-d'); ?>" required/>
