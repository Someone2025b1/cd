...
<body class="menubar-hoverable header-fixed menubar-pin " onload="Imprimir()">
	...
	<div id="base">
		...
		<?php
			...
			$ConsultaNumeroFactura = "SELECT F_NUMERO FROM Bodega.FACTURA_TQ_3 WHERE F_SERIE = '".$FacturaSerie."' ORDER BY F_NUMERO DESC LIMIT 1";
			...
			if($TipoPago == 1)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_TQ_3 (F_CODIGO, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_FECHA_TRANS, F_HORA, F_USUARIO, F_MONEDA, F_EFECTIVO, F_CAMBIO, F_OBSERVACIONES, RES_NUMERO)
			...
			elseif($TipoPago == 2)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_TQ_3 (F_CODIGO, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_OBSERVACIONES, F_NO_AUTORIZACION, RES_NUMERO)
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_TQ_3 (F_CODIGO, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO)
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_TQ_3 (F_CODIGO, F_SERIE, F_NUMERO, F_TIPO, CLI_NIT, D_CODIGO, F_CON_DESCUENTO, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA)
