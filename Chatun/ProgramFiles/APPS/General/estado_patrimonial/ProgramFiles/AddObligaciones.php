...
$sql = mysqli_query($db, "INSERT INTO Estado_Patrimonial.obligaciones_detalle (entidad_financiera, acreedor, garantia, vencimiento, monto_original, saldo_actual, frecuencia, monto_amortizacion, colaborador, fecha)
