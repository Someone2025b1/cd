...
$sql = "SELECT * FROM Bodega.FACTURA_2 AS A LEFT JOIN Bodega.RESOLUCION AS B ON A.RES_NUMERO = B.RES_NUMERO WHERE A.F_CODIGO = '".$Factura."'";
...
$sqlD = "SELECT FACTURA_2_DETALLE.*, PRODUCTO.P_NOMBRE 
                FROM Bodega.FACTURA_2_DETALLE, Productos.PRODUCTO 
                WHERE FACTURA_2_DETALLE.RS_CODIGO = PRODUCTO.P_CODIGO
                AND FACTURA_2_DETALLE.F_CODIGO = '".$Factura."'";
