...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="PorTitulo.php" method="POST" role="form" target="_blank">
					<div class="col-lg-12">
						<br>
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Reporte General Por Tema</strong></h4>
							</div>
							<div class="card-body">
										...
										<div class="form-group">
											...
											<div class="form-group">
												<select name="Titulo" id="Titulo" class="form-control" required>
													<option value="" selected disabled>Seleccione Titulo Reporte</option>
													<?php
													$QueryCB = "SELECT T_CODIGO, T_NOMBRE FROM Finanzas.TITULO ORDER BY T_NOMBRE";
													$ResultCB = mysqli_query($db, $QueryCB);
													while($FilaCB = mysqli_fetch_array($ResultCB))
													{
														echo '<option value="'.$FilaCB["T_CODIGO"].'">'.$FilaCB["T_NOMBRE"].'</option>';
													}
