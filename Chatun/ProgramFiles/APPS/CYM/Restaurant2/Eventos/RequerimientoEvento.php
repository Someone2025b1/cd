...
<head>
	...
	<script>
		...
		{
			var y = ModalAbierto1;
			var tabla1 = '#tabla-'+y+' tbody tr:eq(0)';
			var fila1 = 'fila-base-'+y;
			var dupli = '#tabla-'+y+' tbody';

			$(tabla1).clone().removeClass(fila1).appendTo(dupli);
		}
    	...
    	{
			var ModalAbierto =ModalAbierto1;
		    ...
		    var ObservacionesP = document.getElementsByName('ObservacionesP-'+ModalAbierto+'[]');
    		...
    		$.ajax({
    				...
    				type: 'post',
    				data: 'Producto='+Producto[i+1].value+'&Cantidad='+Cantidad[i+1].value+'&ObservacionesP='+ObservacionesP[i+1].value+'&FechaLimite='+FechaLimite+'&FechaEsperada='+FechaEsperada+'&CodigoDelTiempo='+CodigoDelTiempo+'&CodigoEv='+CodigoEv+'&Borrar='+Borrar,
							...
							<div class="row">
									...
									<div class="col-lg-4">
                                        ...
                                        <label for="CodigoEvento">Codigo del Evento</label>
											<input class="form-control" type="text" name="CodigoEvento" id="CodigoEvento" value="<?php echo $CodigoEvento ?>" readonly/>
							...
							<div class="row">
								...
								<div class="row">
									...
									<div class="col-lg-3">
										...
										<select name="Lugar" id="Lugar" class="form-control" onchange="Otro(this.value)" readonly disabled="disabled">
								...
								<div class="card-body">
									...
									<div class="col-lg-6">
										...
										<div class="col-lg-6">
											<button class="btn btn-success"  value="<?php echo $CONT."-".$TipoD; ?>" onclick="AgregarRequerimiento(this.value)"> Ver / Agregar Requerimineto de Productos <span class="fa fa-shopping-cart" aria-hidden="true"></span></button>
										</div>
										...
										<textarea class="form-control" name="Nombre" id="Nombre" rows="2" cols="40" disabled="disabled"><?php echo $MenuAdultoD?></textarea>
										...
										<textarea class="form-control" name="Nombre" id="Nombre" rows="2" cols="40" disabled="disabled"><?php echo $MenuNinoD?></textarea>
			...
			<div class="modal-dialog" style="width: 70%">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form" id="FormularioRequerimientoProductos-<?php echo $CONT."-".$TipoD; ?>">
							<div class="row">
							<div class="col-lg-6">
							<?php
                                        ...
                                        <label for="Fecha">Fecha Esperada</label>
											<input class="form-control" type="date" name="FechaEsperada-<?php echo $CONT."-".$TipoD; ?>" id="FechaEsperada-<?php echo $CONT."-".$TipoD; ?>" value="<?php echo $Esperada ?>" required/>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group floating-label">
                                        <label for="Fecha">Fecha Limite</label>
											<input class="form-control" type="date" name="FechaLimite-<?php echo $CONT."-".$TipoD; ?>" id="FechaLimite-<?php echo $CONT."-".$TipoD; ?>" value="<?php echo $Limite ?>" required/>
										</div>
									</div>
									<input type="hidden" name="CodigoDelTiempo-<?php echo $CONT."-".$TipoD; ?>" id="CodigoDelTiempo-<?php echo $CONT."-".$TipoD; ?>" value="<?php echo $CodigoDes ?>">
									<input type="hidden" name="CodigoEv-<?php echo $CONT."-".$TipoD; ?>" id="CodigoEv-<?php echo $CONT."-".$TipoD; ?>" value="<?php echo $CodigoEvento ?>">
											...
											?>
															...
															<table class="table" name="tabla-<?php echo $CONT."-".$TipoD; ?>" id="tabla-<?php echo $CONT."-".$TipoD; ?>">
																...
																<tbody>
																	<tr class="fila-base-<?php echo $CONT."-".$TipoD; ?>" >
																	<td><h6><input type="number" class="form-control" name="Cantidad-<?php echo $CONT."-".$TipoD; ?>[]" id="Cantidad-<?php echo $CONT."-".$TipoD; ?>[]"  style="width: 100px" min="0"></h6></td>
																	<td><h6> <input type="number" class="form-control" name="Producto-<?php echo $CONT."-".$TipoD; ?>[]" id="Producto-<?php echo $CONT."-".$TipoD; ?>[]" readonly disabled="disabled"></h6></td> 
																	<td><h6><input type="text" class="form-control" name="ProductoNombre-<?php echo $CONT."-".$TipoD; ?>[]" id="ProductoNombre-<?php echo $CONT."-".$TipoD; ?>[]" style="width: 400px" onchange="BuscarProducto(this)"></h6></td>
																	<td><h6><input type="text" class="form-control" name="ObservacionesP-<?php echo $CONT."-".$TipoD; ?>[]" id="ObservacionesP-<?php echo $CONT."-".$TipoD; ?>[]" style="width: 300px" ></h6></td>
						                                                <td class="eliminar">
																	...
																	while($rowreq = mysqli_fetch_array($resultreq))
																	{
																		...
																		?>
																		<tr>
																	<td><h6><input type="number" class="form-control" name="Cantidad-<?php echo $CONT."-".$TipoD; ?>[]" id="Cantidad-<?php echo $CONT."-".$TipoD; ?>[]"  style="width: 100px" min="0" value="<?php echo $Cantidad1 ?>"></h6></td>
																	<td><h6> <input type="number" class="form-control" name="Producto-<?php echo $CONT."-".$TipoD; ?>[]" id="Producto-<?php echo $CONT."-".$TipoD; ?>[]" readonly disabled="disabled" value="<?php echo $Producto1 ?>"></h6></td> 		                                                
						                                                <td><h6><input type="text" class="form-control" name="ProductoNombre-<?php echo $CONT."-".$TipoD; ?>[]" id="ProductoNombre-<?php echo $CONT."-".$TipoD; ?>[]" style="width: 400px" onchange="BuscarProducto(this)" value="<?php echo $NombreP ?>"></h6></td>
																	<td><h6><input type="text" class="form-control" name="ObservacionesP-<?php echo $CONT."-".$TipoD; ?>[]" id="ObservacionesP-<?php echo $CONT."-".$TipoD; ?>[]" style="width: 300px" value="<?php echo $ObservacionP ?>"></h6></td>
						                                                <td class="eliminar">
						                                                    <button type="button" class="btn btn-danger btn-lg" onclick="EliminarLinea(this)">
						                                                        <span class="glyphicon glyphicon-trash"></span>
						                                                    </button>
