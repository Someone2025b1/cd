...
<body class="menubar-hoverable header-fixed menubar-pin ">
    ...
    <div id="base"> 
            <div class="container">
                <h1 class="text-center"><strong>Administración Medicamento</strong><br></h1>
                <br>
                <form class="form" id="FormEstanque">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-head style-primary">
                                <h4 class="text-center"><strong>Administración Medicamento</strong></h4>
                            </div>
                            <div class="card-body"> 
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group floating-label">
                                            ...
                                            <label for="Tipo">Tipo Medicamento</label>
                                        </div>
                                    </div>
                                </div>   
                                  </form>  
                                <div class="col-lg-12" align="center">
                                    <button type="button" onclick="GuardarMedicamento()" class="btn ink-reaction btn-raised btn-primary">Guardar</button>
                                </div>
                            </div>
                        </div>
                    </div> 
  ...
  <!-- FIN DEL ENCABEZADO DE LA TARJETA --> 
    <div class="container">
     <div class="row"> 
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-head style-primary">
                       <h2 class="text-center text-white">LISTADO DE Medicamento</h2>
                    </div>
                    <div class="card-body"> 
                            <div class="row"> 
                                <div class="col-md-12"> 
            ...
            <div id="myTable_wrapper" class="dataTables_wrapper no-footer"> <table id="myTable" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="myTable_info">
                                                ...
                                                <tr>
                                                    ...
                                                    <th data-sortable="true" data-field="Capacidad" data-filter-control="input"><h6><strong>Alimento</strong></h6></th> 
                                            ...
                                            <tbody> 
                                            <?php 
                                                $Sql_Ges_Creadas = mysqli_query($db, "SELECT * FROM Pisicultura.Producto_Pisicultura WHERE Estado = 1 AND Tipo = 2"); 
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $Fila_Ges_Creadas["Precio"] ?></h6></td>
                                                <td><?php      $Estado = $Fila_Ges_Creadas["Estado"];
                                                 if($Estado == 1){
                                                  ?>
                                                  <a href="IngresoMedicamento.php?IdEstanqueMod=<?php echo $Fila_Ges_Creadas["IdProducto"] ?>&Acc=<?php echo 0 ?>"><button type="button" class="btn btn-info btn-circle"><i class="fa fa-check"></i> </button></a> 
                                                    
                                                  <?php
                                                 } else { ?>
                                                  <a href="IngresoMedicamento.php?IdEstanqueMod=<?php echo $Fila_Ges_Creadas["IdProducto"] ?>&Acc=<?php echo 1 ?>"><button type="button" class="btn btn-warning btn-circle"><i class="fa fa-times"></i> </button></a> 
                                                 <?php
                                                 }
                                                 ?> 
                                                </td> 
   ...
   function GuardarMedicamento(){
    ...
    $.ajax({
        url: 'AJAX/GuardarMedicamento.php',
        type: 'POST',
        ...
        success: function(data){ 
            ...
            setTimeout(function(){location.href="IngresoMedicamento.php"} , 1000);   
            }
            else
            {
