...
<?php 
$Query = mysqli_query($db, "UPDATE Taquilla.HOTEL SET H_ESTADO = 2 WHERE H_CODIGO = ".$Codigo)or die(mysqli_error($Query));

								if($Query)
								{
									echo '<div class="col-lg-12 text-center">
										<h1><span class="text-xxxl text-light">Bien! <i class="fa fa-check-circle text-success"></i></span></h1>
										<h2 class="text-light">El Hotel se eliminó correctamente.</h2>
										<div class="row">
