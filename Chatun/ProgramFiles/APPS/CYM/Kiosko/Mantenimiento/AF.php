							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA_KS.*, CLIENTE.* 
														FROM Bodega.FACTURA_KS, Bodega.CLIENTE 
														WHERE FACTURA_KS.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA_KS.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA_KS.F_NUMERO = ".$_POST["Numero"]."
														ORDER BY FACTURA_KS.F_TOTAL ASC";
