							...
							<div class="card-body">
								...
								<div class="col-lg-4">
									...
									<table class="table table-hover" id="TblTicketsHotelTotal">
									    ...
									    <tbody>
									    	<?php 
									    	 $TotalCobrar = mysqli_fetch_array(mysqli_query($db, "SELECT a.H_CODIGO, b.H_NOMBRE, SUM(a.IH_ADULTOS) AS ADULTOS, SUM(a.IH_ADULTO_MAYOR) AS ADULTOSM, SUM(a.IH_NINOS) AS NINOS, SUM(a.IH_TOTAL_ADULTO) AS TotalAdulto, SUM(a.IH_TOTAL_ADULTO_MAYOR) AS TotalAdultoM, SUM(a.IH_TOTAL_NINO) AS TotalNino
											FROM Taquilla.INGRESO_HOTEL a
											INNER JOIN Taquilla.HOTEL b ON a.H_CODIGO = b.H_CODIGO
											WHERE a.IH_VALE > 0 AND NOT EXISTS (SELECT *FROM Taquilla.DETALLE_VALE_FACTURA c 
											where a.IH_VALE = c.DVF_Vale AND a.H_CODIGO = c.DVF_Hotel AND c.DVF_Estado = 2)
												"));
									    	$totalEntrada =   $TotalCobrar["TotalNino"]+$TotalCobrar["TotalAdulto"]+$TotalCobrar["TotalAdultoM"];
										?>
									    	<tr>
									    		<td align="center"><?php echo $TotalCobrar['ADULTOS'] ?></td>
												<td align="center"><?php echo $TotalCobrar['ADULTOSM'] ?></td>
