...
for(m=l.length;i<m;i++)if(a=l[i],c.isArray(a))o(b,a);else{e=d="";switch(a){case "ellipsis":d="&hellip;";e="disabled";case "first":d=h.sFirst;e=a+(0<g?"":" disabled");case "previous":d=h.sPrevious;e=a+(0<g?"":" disabled");case "next":d=h.sNext;e=a+(g<k-1?"":" disabled");case "last":d=h.sLast;e=a+(g<k-1?"":" disabled");default:d=a+1,e=g===a?"active":""}d&&(n=c("<li>",{"class":s.sPageButton+" "+e,"aria-controls":f.sTableId,tabindex:f.iTabIndex,id:0===p&&"string"===typeof a?
