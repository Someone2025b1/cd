							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA_RS.*, CLIENTE.* 
														FROM Bodega.FACTURA_RS, Bodega.CLIENTE 
														WHERE FACTURA_RS.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA_RS.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA_RS.F_NUMERO = ".$_POST["Numero"]."
														ORDER BY FACTURA_RS.F_TOTAL ASC";
