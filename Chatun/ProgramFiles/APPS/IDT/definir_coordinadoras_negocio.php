...
<table width="40%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tamano14">
  ...
  <tr align="center">
    ...
    <th width="86%" colspan="3" class="Tamano24">DEFINIR COORDINADORA DE NEGOCIO PARA AG. <?php echo $row0["agencia"] ;?></th>
    </tr>
...
<form action="<?php echo $_SERVER['PHP_SELF'].'?centinela=1&agencia='.$id_agencia ?>" method="post" name="Buscar" id="Buscar">
...
"><a href="grabar_coordinadoras_negocio.php?cif=<?php echo $row1["id_user"] ?>&agencia=<?php echo $id_agencia ?>"><?php echo $row1["id_user"]; ?></a></td>
...
<tr>
  <td align="center"><a href="ver_coordinadoras_negocio.php"><img src="Imagenes/cerrar.png" alt="Regresar" width="64" height="64" border="0"></a></td>
</tr>
<tr>
  <td align="center"><a href="ver_coordinadoras_negocio.php">Cerrar</a></td>
</tr>
</table>
</div>
