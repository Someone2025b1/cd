						...
						<div class="card">
							...
							<?php
								...
								if($RegistrosResolucion > 0)
								{
									...
									?>
									<form action="Nota_Credito_Pro_Pro.php" method="POST">
														...
														while($FilaCuentaContable = mysqli_fetch_array($QueryCuentaContable))
														{
															?>
																<tr>
																	...
																	<td><input type="text" class="form-control" name="Cargo[]" id="Cargo[]" required  value="<?php echo $FilaCuentaContable[TRAD_ABONO_CONTA] ?>"></td>
																	<td><input type="text" class="form-control" name="Abono[]" id="Abono[]" required  value="<?php echo $FilaCuentaContable[TRAD_CARGO_CONTA] ?>"></td>
																</tr>
															<?php
														}
													?>
