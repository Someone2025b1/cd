								...
								<div class="card card-underline">
									<div class="card-head">
										<ul class="nav nav-tabs pull-right" data-toggle="tabs">
											...
											<li><a href="#second2">Por Área</a></li>
											<li><a href="#three">Por Puesto</a></li>
										</ul>
									...
									<div class="card-body tab-content">
										...
										<div class="tab-pane active" id="first2">
											<form action="AspectoGenPro.php" method="POST" role="form" class="form" >
												<div class="row">
													<div class="col-lg-12">
										...
										<div class="form-group">
											<select name="AreaGen" id="AreaGen" onchange="ObtenerDepartamentosLaborales(this.value)" class="form-control" >
												...
												$query = "SELECT * FROM RRHH.AREA_EVALUAR WHERE AREA_EVALUAR.AR_CODIGO <> 8 AND  AREA_EVALUAR.AR_CODIGO <> 9 ORDER BY AR_NOMBRE";
										...
										<div class="tab-pane" id="second2">
											<form action="AspectoArePro.php" method="POST" role="form" class="form">
												<div class="row">
