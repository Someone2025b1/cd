...
$sql = "SELECT * FROM Bodega.FACTURA_KS_3 AS A LEFT JOIN Bodega.RESOLUCION AS B ON A.RES_NUMERO = B.RES_NUMERO WHERE A.F_CODIGO = '".$Factura."'";
...
$sqlD = "SELECT FACTURA_KS_3_DETALLE.*, RECETA_SUBRECETA.RS_NOMBRE 
FROM Bodega.FACTURA_KS_3_DETALLE, Bodega.RECETA_SUBRECETA 
WHERE FACTURA_KS_3_DETALLE.RS_CODIGO = RECETA_SUBRECETA.RS_CODIGO
AND FACTURA_KS_3_DETALLE.F_CODIGO = '$Factura'
UNION ALL 
SELECT FACTURA_KS_3_DETALLE.*, PRODUCTO.P_NOMBRE 
FROM Bodega.FACTURA_KS_3_DETALLE, Bodega.PRODUCTO 
WHERE FACTURA_KS_3_DETALLE.RS_CODIGO = PRODUCTO.P_CODIGO
AND FACTURA_KS_3_DETALLE.F_CODIGO = '$Factura'";
