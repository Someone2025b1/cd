...
$NomTitulo = mysqli_query($db, "SELECT T_NOMBRE FROM Finanzas.TITULO WHERE TITULO.T_CODIGO='$CodTit'");
$rowtitulo = mysqli_fetch_array($NomTitulo);
...
$pdf->ezText($rowtitulo["T_NOMBRE"],16,array('justification'=>'center'));
