...
if($ConFin==1){
$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
...
$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_SV WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora'";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_SV WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_SV_2 WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora'";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_SV_2 WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
#$Data[] = array('col1'=>'SOUVENIRS #2', 'col2'=>$FacturasEmitidas1, 'col3'=>number_format($SubTotal, 2, '.', ','));

$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_KS WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_KS WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_TQ WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_TQ WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_TQ_2 WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_TQ_2 WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
#$Data[] = array('col1'=>'TAQUILLA #2', 'col2'=>$FacturasEmitidas1, 'col3'=>number_format($SubTotal, 2, '.', ','));

$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_TQ_3 WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
#$Data[] = array('col1'=>'TAQUILLA #3', 'col2'=>$FacturasEmitidas1, 'col3'=>number_format($SubTotal, 2, '.', ','));

$Queryp = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Resultp = mysqli_query($db,$Queryp);
while($rowp = mysqli_fetch_array($Resultp))
{
    $FacturasEmitidas1 = $rowp["FACTURAS_EMITIDAS"];
...
$Query11p = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS BETWEEN '$fecha_inicio' AND '$fecha_fin' AND F_HORA >='$Hora' ";
$Result11p = mysqli_query($db,$Query11p);
while($rowp = mysqli_fetch_array($Result11p))
{
    $SubTotal = $rowp["TOTAL_FACTURADO"];
...
#$Data[] = array('col1'=>'Mirador', 'col2'=>$FacturasEmitidas1, 'col3'=>number_format($SubTotal, 2, '.', ','));
