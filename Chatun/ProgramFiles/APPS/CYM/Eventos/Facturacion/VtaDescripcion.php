...
#purchaseOrder {
	...
	<script>
		...
		function CalcularTotal()
		{
			...
			var CantidadDes = $('#CantidadDes').val();
			...
			$('#SubTotalDes').val(Total.toFixed(2));

			
			$('#PrecioDes').val(Total2.toFixed(4));
								...
								<div class="card">
									<div class="card-body ">
										<div id="rootwizard2" class="form-wizard form-wizard-horizontal">
											<form class="form form-validation" role="form" novalidate="novalidate" action="VtaDescripcionPro.php" method="POST" role="form" id="FormularioPrincipal">
												...
												<div class="tab-content clearfix">
													...
													<input class="form-control" type="hidden" name="TipoDoc" id="TipoDoc"  required/>
														...
														<tr>
						                                                ...
						                                                <td><h6><input type="number" class="form-control" name="SubTotalDes" id="SubTotalDes"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" readonly></h6></td>
						                                            </tr>
																</tbody>
																</table>
																	</div>
													...
													<div class="tab-pane" id="step2">
														...
														<div class="col-lg-3" class="col-lg-3" id="DivCredito" name="DivCredito" style="display: none">
															<div class="card">
																<div class="card-body no-padding">
																	<div class="alert alert-callout alert-success no-margin">
																		<div>
