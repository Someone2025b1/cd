...
WHERE b.ACC_FECHA = '".$_POST["FechaInicio"]."' AND b.ACC_TIPO = 8"));
		...
		<div id="content">
			<?php
				...
				$sql = "SELECT APERTURA_CIERRE_CAJA.*, CIERRE_DETALLE.* 
						...
						AND APERTURA_CIERRE_CAJA.ACC_TIPO = 8  $filtroOtro";
				...
				$Query = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
				...
				$Query1 = "SELECT COUNT(F_CODIGO) AS FACTURAS_ANULADAS FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_ESTADO = 2";
				...
				$Query3 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_DOLARES FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_LEMPIRAS FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 3";
				$Result4 = mysqli_query($db,$Query4);
				while($row4 = mysqli_fetch_array($Result4))
				{
				...
				$Query5 = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 4";
				...
				$Query6 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 3";
				...
				$Query7 = "SELECT SUM(F_TOTAL) AS TOTAL_EFECTIVO FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 1";
				...
				$Query9 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_LEMPIRA FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 3";
				...
				$Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 2";
				...
				$Query11 = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_EV WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
				...
				$Total = ($TCQ + $TotalTarjetaCredito + $TotalDolaresQuetzalisados + $TotalLempirasQuetzalisados + $TotalDeposito + $TotalCreditos + $TotalAnticipo);
										...
										<div class="row">
											...
											<div class="col-lg-3">
												<div class="form-group">
													<div class="input-daterange input-group" id="demo-date-range">
														<div class="input-group-content">
															<label>Anticipos Emitidos</label><input type="number" class="form-control" name="AnticiposEmitidos" value="<?php echo $AnticiposEmitidos ?>" readonly>
											...
											<div class="col-lg-12">
												<table class="table table-hover table-condensed">
													<tbody>
														...
														<tr>
															<td><h5><b>Efectivo</b></h5></td>
															<td colspan="2" align="right"><h5><?php echo 'Q. '.number_format($TotalAnticipoEfe, 2, '.', ','); ?></h5></td>
														</tr>
														<tr>
															<td><h5><b>Tarjeta Credito</b></h5></td>
															<td colspan="2" align="right"><h5><?php echo 'Q. '.number_format($TotalAnticipoTar, 2, '.', ','); ?></h5></td>
														</tr>
											
														<tr>
															<td><h5><b>Depósitos</b></h5></td>
															<td colspan="2" align="right"><h5><?php echo 'Q. '.number_format($TotalAnticipoDep, 2, '.', ','); ?></h5></td>
														</tr>
														<tr>
															<td align="left"><h3><b>Total Anticipos</b></h3></td>
															<td colspan="2" align="right"><h3><?php echo 'Q. '.number_format($TotalAnticipo, 2, '.', ','); ?></h3></td>
														</tr>
														<tr>
								...
								<div id="accordion6-3" class="collapse" aria-expanded="false" style="height: 0px;">
									<div class="card-body">
										<table class="table" id="tbl_resultados">
											...
											<tbody>
												<?php
													$SqlFacturas = "SELECT FACTURA_EV.* FROM Bodega.FACTURA_EV
																	WHERE FACTURA_EV.F_FECHA_TRANS = '".$_POST["FechaInicio"]."' $FiltroUser
