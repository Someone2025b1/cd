...
<h4 class="text-center"><strong>Repoorte de Copras</strong></h4>
</div>
<div class="card-body">
<div class="row text-center"> 
	...
	<div align="center">
			...
			<select name="SelecPunto" class="form-control" id="SelecPunto" required>
			 <option disabled="" selected>Seleccione una opción</option> 
			 <option value="10">TODAS LAS ÁREAS</option> 		
			 ...
			 <option value="7">SOPORTE Y DESARROLLO TECNOLÓGICO</option> 
			 <option value="8">GESTIÓN DE TALENTO HUMANO</option> 
