...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="DespacharRequisicion.php" method="POST" role="form">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											...
											<input class="form-control" type="time" name="HoraRequisicion" id="HoraRequisicion" value="<?php echo $HoraEnvio; ?>" readonly required/>
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											<select name="BodegaEnvia" id="BodegaEnvia" class="form-control" required>
												<option value="" disabled selected>Seleccione una opción</option>
												<?php
	                                                 //Select para obtener los tipos de falta de la base de datos y creación de las opciones del input select
												$query = "SELECT * FROM Bodega.BODEGA WHERE B_CODIGO = 4 ORDER BY B_NOMBRE";
												$result = mysqli_query($db, $query);
												while($row = mysqli_fetch_array($result))
												{
									...
									<table class="table table-hover table-condensed" name="tabla" id="tabla">
                                        ...
                                        <tbody>
											...
											<select name="Producto[]" id="Producto[]" class="form-control" onchange="SaberStock(this)">
                                                ...
                                                <td><h6><input type="number" step="any" class="form-control" name="CantidadDespacho[]" id="CantidadDespacho[]" onChange="VerificarStock()" value="0.00" min="0"></h6></td>
                                                <td class="eliminar">
      								...
      								WHERE TRANSACCION_DETALLE.TRA_CODIGO = TRANSACCION.TRA_CODIGO
													...
													echo '<tr>';
														...
														echo '<td><input class="form-control" type="number" step="any" name="Stock[]"  value="'.$Stock.'" required readonly/></td>';
														echo '<td><input class="form-control" type="number" step="any" name="CantidadDespacho[]" id="CantidadDespacho[]" onChange="VerificarStock()" required/></td>';
													echo '</tr>';
													$i++;
												}
