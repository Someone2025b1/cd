...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="NCPro.php" method="POST" role="form">
					<div class="col-lg-12">
						<br>
						<div class="card">
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											...
											<label for="FechaSalida">Fecha de Ingreso Producto</label>
										</div>
									</div>	
								</div>
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											<select name="Bodega" id="Bodega" class="form-control" required>
												...
												$query = "SELECT * FROM Bodega.BODEGA WHERE B_CODIGO = 6 ORDER BY B_NOMBRE";
									...
									<table class="table table-hover table-condensed" name="tabla" id="tabla">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><strong>Cantidad Ingreso</strong></td>
                                        ...
                                        <tbody>
											...
											<select name="Producto[]" id="Producto[]" class="form-control" onchange="SaberStock(this)">
												...
												<?php
	                                                    //Select para obtener los tipos de falta de la base de datos y creación de las opciones del input select
												$query = "SELECT * FROM Bodega.PRODUCTO WHERE (CP_CODIGO = 'MT' OR CP_CODIGO = 'PU') ORDER BY P_NOMBRE";
												$result = mysqli_query($db, $query);
												while($row = mysqli_fetch_array($result))
												{
                                                ...
                                                <td><h6><input type="number" step="any" class="form-control" name="Costo[]" id="Costo[]" value="0.00" min="0"></h6></td>
                                                <td class="eliminar">
