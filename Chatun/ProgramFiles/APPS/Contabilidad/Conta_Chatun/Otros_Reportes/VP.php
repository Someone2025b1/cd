...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<form class="form" action="VPImp.php" method="POST" role="form" target="_blank">
					<div class="col-lg-12">
						<br>
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Ventas por Producto</strong></h4>
							</div>
							<div class="card-body">
											...
											<div class="form-group">
												<select name="Bodega" id="Bodega" class="form-control" required>
													...
													<?php
	                                                    ...
	                                                    $query = "SELECT * FROM Bodega.BODEGA WHERE B_CODIGO <> 6 AND B_CODIGO <> 4 ORDER BY B_NOMBRE ";
										...
										<div class="col-lg-3 text-center">
											<div class="form-group">
												<select name="Producto" id="Producto" class="form-control" required>
													...
													<?php
	                                                    //Select para obtener los tipos de falta de la base de datos y creación de las opciones del input select
	                                                    $query = "SELECT A.RS_CODIGO, A.RS_NOMBRE
	                                                    ...
	                                                    while($row = mysqli_fetch_array($result))
	                                                    {
	                                                        echo '<option value="'.$row["RS_CODIGO"].'">'.$row["RS_NOMBRE"].'</option>';
	                                                    }
