							...
							<div class="card-body">
								...
								$i=$Valori;
									...
									if ($_FILES["documento1".$i]["error"] === 0) {
										...
										$QueryColaborador = mysqli_query($db, "INSERT INTO CompraVenta.COTIZACION(R_CODIGO, RD_CODIGO, C_EXTENCION, C_NOMBRE)
										VALUES('".$Numero."', '".$RDCodigo."', '".$extension."', '".$archivo."')");
									}
								...
								elseif($Estado==2){
									...
									if($ClasificiacionRD!=2 | $ClasificiacionRD!=3 | $ClasificiacionRD!=4){
									$EstadoNuevo=5;
									...
									$EstadoNuevo=6;
									$Descripcion="El Ususario Recibio el Producto/Servicio";
								}
								...
								$QueryDetalle = mysqli_query($db, "INSERT INTO CompraVenta.SEGUIMIENTO_REQUICISION(R_CODIGO, RD_CODIGO, RD_ESTADO, SR_DESCRIPCIÓN, SR_FECHA, SR_HORA)
								VALUES('".$Numero."', '".$RDCodigo."', '".$EstadoNuevo."', '".$Descripcion."', CURRENT_DATE(), CURRENT_TIMESTAMP())");
