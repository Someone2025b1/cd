	...
	<head>
		...
		<script>
			function Redireccionar()
			{
				...
				if(PuestoLaboral == 4)
				{
					window.location.href = "MenuFinancieroContable.php";
				}
				else if(PuestoLaboral == 5)
				{
					window.location.href = "MenuTecnicoContabilidad.php";
				}
				else if(PuestoLaboral == 16)
				{
					window.location.href = "MenuInventarioAbastecimiento.php";
				}
				else
				{
					window.location.href = "MenuAdmin.php?id_depto=55";
				}
			}
		</script>
	</head>
