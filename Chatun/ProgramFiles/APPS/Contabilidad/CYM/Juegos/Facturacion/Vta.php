...
<head>
	...
	<script>
		...
		{	
			...
			Tipo[Indice].value = $(x).attr('dataTipo');
			if (Tipo[Indice].value==3) 
			{
				Cantidad[Indice].value = $(x).attr('dataCant');
			}
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	$ConsultaSerie = "SELECT RES_SERIE, RES_NUMERO FROM Bodega.RESOLUCION WHERE RES_ESTADO = 1 AND RES_TIPO = 'JG'";
	$ResultSerie = mysqli_query($db, $ConsultaSerie);
	$ExisteResolucion = mysqli_num_rows($ResultSerie);
	 

	  
	$ConsultaApertura = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 10";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE AND ACC_TIPO = 10 AND ACC_ESTADO = 2";
															...
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	<tr class="fila-base">
						                                                ...
						                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" style="width: 500px" onFocus="AbrirModalPrincipal(this)"></h6></td>
		                        ...
		                        <div class="panel-heading">
		                            <div class="row">
		                                <div class="col-xs-12 text-center"> <br>
		                                    <a onClick="AbrirModalResultados(1)" style="text-decoration: none; cursor: pointer"><div><h1>JUEGOS</h1></div></a>
		                                    <br>
		                                </div>
		                            </div>
		                        </div>
		                ...
		                <div class="col-lg-4">
		                    <div class="panel panel-primary">
		                        <div class="panel-heading">
		                            <div class="row">
		                                <div class="col-xs-12 text-center"> <br>
		                                    <a onClick="AbrirModalResultados(2)" style="text-decoration: none; cursor: pointer"><div><h1>COMBOS</h1></div></a>
		                                    <br>
		                                </div>
		                            </div>
		                        </div>
		               ...
		               <!-- <div class="col-lg-3 col-md-6">
		                    <div class="panel panel-primary">
		                        <div class="panel-heading">
		                            <div class="row">
		                                <div class="col-xs-12 text-center"> <br>
		                                    <a onClick="AbrirModalResultados(3)" style="text-decoration: none; cursor: pointer"><div><h1>CANOPY</h1></div></a>
		                                    <br>
		                                </div>
		                            </div>
		                        </div>
