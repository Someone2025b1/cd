...
$sqlD = "SELECT FACTURA_PIZZA_DETALLE.*, RECETA_SUBRECETA.RS_NOMBRE 
                FROM Bodega.FACTURA_PIZZA_DETALLE, Bodega.RECETA_SUBRECETA 
                WHERE FACTURA_PIZZA_DETALLE.RS_CODIGO = RECETA_SUBRECETA.RS_CODIGO
