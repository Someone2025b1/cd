															...
															<table class="table" name="tabla" id="tabla">
																...
																<tbody>
																	...
																	while($row = mysqli_fetch_array($Resultado))
																	{
																		...
																		$Valor        = $_POST["CC_TOTAL"];
																		$Total        = $row["CC_TOTAL"];

																		$CodigoFactura = $row["CC_CODIGO"];               
																		...
																		?>
																		<tr>
							                                                <td><h6><input type="number" class="form-control" name="Cantidad[]" id="Cantidad[]" value="<?php echo $Cantidad ?>" readonly onChange="CalcularTotal()" style="width: 100px" min="0"><input type="hidden" class="form-control" name="TipoProducto[]" id="TipoProducto[]"></h6></td>
							                                                <input type="hidden" class="form-control" name="Producto[]" id="Producto[]" value="821">
							                                                <td><h6><input type="text" class="form-control" name="ProductoNombre[]" id="ProductoNombre[]" value="<?php echo $ConceptoFactura ?>" readonly style="width: 500px" onchange="BuscarProducto(this)"></h6></td>
							                                                <td><h6><input type="number" class="form-control" name="Precio[]" id="Precio[]" value="<?php echo $Valor ?>" onChange="CalcularTotal()" style="width: 100px" min="0" step="any" style="text-align: right" value="0.00"></h6></td>
							                                                ...
							                                                <td><h6><input type="number" class="form-control" name="SubTotal[]" id="SubTotal[]" value="<?php echo $Total ?>"  style="width: 100px" min="0" step="any" style="text-align: right" value="0.00" readonly></h6></td>
							                                            </tr>
							                                            <?php
																	}
																	?>
																...
																<tfoot>
																	<tr style="display: none">
						                                                ...
						                                                <td style="text-align: left; vertical-align: text-top; font-size: 18px"><input class="form-cntrol" type="text" id="BoldDescuento" name="TotalFacturaConDescuento" value="0.00" readonly></td>
						                                                <td></td>
						                                            </tr>
																	<tr>
						                                                <td></td>
														...
														<div class="col-lg-12" id="FormaPagoMixto" style="display: none">
															...
															<div class="col-lg-4 text-center">
																	<div class="form-group">
																		<div class="input-group">
																			<div class="input-group-content">
																				<input type="text" class="form-control" id="TrejetaM" name="TrejetaM" required value="Trjeta de Credito/Devito" readonly>
															...
															<div class="col-lg-4 text-center">
																...
																<tbody>
																	<tr class="fila-base-anticipo">
						                                                ...
						                                                <td><h6><input type="text" class="form-control" name="NombreA[]" id="NombreA[]" style="width: 500px" onchange="BuscarAnticipo(this)"></h6></td>
