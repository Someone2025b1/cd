		...
		<div id="base">
			...
			<div id="content" style="margin-left: -125px">
				...
				<table class="table table-responsive" align="center" >
					<td align="center" ><a href="Restaurant"><img width="128" height="128" class="img-rounded" src="../../APPS/IDT/Imagenes/Aplicaciones/Restaurant.png"><br><h4>Restaurant</h4></a></td>
				</table>
			</div><!--end #content-->
			<!-- END CONTENT -->
