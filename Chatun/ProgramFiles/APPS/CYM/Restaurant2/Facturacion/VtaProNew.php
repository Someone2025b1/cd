...
<head>
	...
	<script>
		...
		function Imprimir()
		{
			...
			printJS('<?php $_SERVER['DOCUMENT_ROOT']?>/ProgramFiles/APPS/CYM/Restaurant2/Facturacion/FactImpNew.php?Codigo='+Cod);
...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<?php
			...
			if($TipoPago == 1)
			{
				$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA WHERE F_FECHA_TRANS = CURRENT_DATE()
				UNION
				SELECT F_ORDEN FROM Bodega.FACTURA_2 WHERE F_FECHA_TRANS = CURRENT_DATE()
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_2 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_FECHA_TRANS, F_HORA, F_USUARIO, F_MONEDA, F_EFECTIVO, F_CAMBIO, F_OBSERVACIONES, RES_NUMERO, F_ORDEN, F_CON_DESCUENTO)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 1, '".$NIT."', ".$TotalFacturaFinal.", CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user.", ".$Moneda.", ".$Efectivo.", ".$Cambio.", '".$Observaciones."', '".$NumeroResolucion."', '".$NumeroOrden."', '".$TotalDescuentoFactura."')");
				...
				$sqlAbono = mysqli_query($db,"INSERT INTO Bodega.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_OBSERVACIONES, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, B_CODIGO, F_CODIGO)
											 VALUES('".$UI."', CURRENT_DATE(), 'Vta. Restaurant Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 1, 9, 1, '".$Uid."')") or die(mysqli_error());
				...
				else
				{
					for($i=0; $i<$Contador; $i++)
					{
						...
						$query = mysqli_query($db,"INSERT INTO Bodega.FACTURA_2_DETALLE (F_CODIGO, FD_CODIGO, FD_CANTIDAD, RS_CODIGO, FD_PRECIO_UNITARIO, FD_SUBTOTAL, FD_DESCUENTO)
											VALUES('".$Uid."', '".$UidD."', ".$Can.", '".$Prod."', ".$Pre.", ".$SubFac.", ".$Des.")");

						$ConsultaProdReceta = "SELECT * FROM Bodega.RECETA_SUBRECETA_DETALLE WHERE RS_CODIGO = '".$Prod."'";
					...
					****************************************************************************************/
					...
					$SqlContable = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_SERIE, TRA_FACTURA, TRA_TOTAL, RES_NUMERO, TRA_CORRELATIVO, PC_CODIGO)
											 VALUES('".$Uid."', CURRENT_DATE(), 'Vta. Restaurant Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 2, 7, '".$SerieAutorizada."', '".$FacturaNumero."', ".$TotalFacturaFinal.", '".$NumeroResolucion."', ".$Correlativo.", ".$Periodo.")") or die(mysqli_error());
					...
					$SqlContableD = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '1.01.01.002', ".number_format($TotalFacturaFinal, 2, ".", "").", 0.00)");
					...
					$SqlContableD2 = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '4.01.03.001', 0.00, ".number_format($VentaSinIVA, 3, ".", "").")");
				}
					...
					for($i=1; $i<$Contador; $i++)
				{
					...
					WHERE P_CODIGO = ".$Prod);
						...
						if($rowe["R_CODIGO"]!=NULL){
							...
							while($rower = mysqli_fetch_array($resultr))
							{
								...
								VALUES('".$KCod."', '".$Uid."', '".$ProdR."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Venta de Producto Segun Factura de Terazas #2 Serie Número "."$SerieAutorizada"."  "."$FacturaNumero"."', '".$existenciaGAnR."', '".$cantidadgenR."', 1, '".$existenciaAnR."', '".$nuevaexistenciaR."')");
					...
					$querykardex = mysqli_query($db, "INSERT INTO Productos.KARDEX (K_CODIGO, TRA_CODIGO, P_CODIGO, K_FECHA, K_HORA, K_DESCRPCION, K_EXISTENCIA_ANTERIOR, K_EXISTENCIA_ACTUAL, K_PUNTO_VENTA, K_EXISTENCIA_ANTERIOR_PUNTO, K_EXISTENCIA_ACTUAL_PUNTO)
					VALUES('".$KCod."', '".$Uid."', '".$Prod."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Venta de Producto Segun Factura de Terazas #2 Serie Número "."$SerieAutorizada"."  "."$FacturaNumero"."', '".$existenciaGAn."', '".$cantidadgen."', 1, '".$existenciaAn."', '".$nuevaexistencia."')");
...
$TotalFacturaFinal=number_format($TotalFacturaFinal, 2, ".", "");
		...
		while($roweg = mysqli_fetch_array($resultg))
		{
			...
			if($EventoPertenece!="SINEVENTO"){
					   ...
					   $QueryUpdateFactura = mysqli_query($db,"UPDATE Bodega.FACTURA_2 SET F_SERIE = '".$responseCerti->body->serie."', F_CAE = '".$responseCerti->body->numero."', F_DTE = '".$responseCerti->body->uuid."', F_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE F_CODIGO = '".$Uid."'")or die(mysqli_error());

					   $QueryUpdateTransaccionBodega = mysqli_query($db,"UPDATE Bodega.TRANSACCION SET TRA_OBSERVACIONES = 'Vta. Restaurante Según Fact. ".$responseCerti->body->serie.' - '.$responseCerti->body->numero.' - '.$responseCerti->body->uuid."' WHERE F_CODIGO = '".$Uid."'");

					   $QueryUpdateTransaccionContabilidad = mysqli_query($db,"UPDATE Contabilidad.TRANSACCION SET TRA_CONCEPTO = 'Vta. Restaurante Según Fact. ".$responseCerti->body->serie.' - '.$responseCerti->body->numero.' - '.$responseCerti->body->uuid."', TRA_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE TRA_CODIGO = '".$Uid."'");
					}
					else
					{
							$QueryBitacora = mysqli_query($db, "INSERT INTO Bitacoras.FACTURA 
						SELECT FACTURA.F_CODIGO, '1', FACTURA.F_ORDEN, FACTURA.F_SERIE, FACTURA.F_NUMERO, FACTURA.F_TIPO, FACTURA.CLI_NIT, FACTURA.D_CODIGO, FACTURA.F_CON_DESCUENTO, FACTURA.F_TOTAL, FACTURA.F_EFECTIVO, FACTURA.F_CAMBIO, FACTURA.F_FECHA_TRANS, FACTURA.F_HORA, FACTURA.F_USUARIO, FACTURA.F_MONEDA, FACTURA.F_ESTADO, FACTURA.F_RAZON_ANULACION, FACTURA.F_NOMBRE_CREDITO, FACTURA.F_NO_BOLETA, FACTURA.F_OBSERVACIONES, FACTURA.F_NO_AUTORIZACION, FACTURA.RES_NUMERO, FACTURA.F_CUENTA_BANCARIA, FACTURA.F_REALIZADA, FACTURA.F_CAE, FACTURA.F_DTE, FACTURA.F_FECHA_CERTIFICACION, FACTURA.F_TIPO_TARJETA FROM Bodega.FACTURA 
						WHERE  FACTURA.F_CODIGO = '".$Uid."'")or die(mysqli_error());

							$QueryBitacora1 = mysqli_query($db, "INSERT INTO Bitacoras.FACTURA_DETALLE
							SELECT * FROM Bodega.FACTURA_2_DETALLE
							WHERE FACTURA_2_DETALLE.F_CODIGO = '".$Uid."'")or die(mysqli_error());
					 		
							$QueryUnoRestaurante = mysqli_query($db, "DELETE 
																FROM Bodega.FACTURA_2 
																WHERE FACTURA_2.F_CODIGO = '".$Uid."'")or die(mysqli_error());
			...
			elseif($TipoPago == 2)
			{
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_2 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_OBSERVACIONES, F_NO_AUTORIZACION, RES_NUMERO, F_ORDEN, F_TIPO_TARJETA, F_CON_DESCUENTO)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 2, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.", '".$Observaciones."', '".$NumeroAutorizacionTXT."', '".$NumeroResolucion."', '".$NumeroOrden."', '".$TipoTarjeta."', '".$TotalDescuentoFactura."')");

				$sqlAbono = mysqli_query($db,"INSERT INTO Bodega.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_OBSERVACIONES, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, B_CODIGO, F_CODIGO)
											 VALUES('".$UI."', CURRENT_DATE(), 'Vta. Restaurant Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 1, 9, 1, '".$Uid."')");
				...
				else
				{
					for($i=0; $i<$Contador; $i++)
					{
						...
						$QueryNombreProducto = mysqli_query($db,"SELECT A.RS_NOMBRE
															FROM Bodega.RECETA_SUBRECETA AS A
															WHERE A.RS_CODIGO = '".$Prod."'");
...
$TotalFacturaFinal=number_format($TotalFacturaFinal, 2, ".", "");
	...
	$QueryEvento= mysqli_query($db, "UPDATE Eventos.EVENTO SET
					   ...
					   $QueryUpdateFactura = mysqli_query($db,"UPDATE Bodega.FACTURA_2 SET F_SERIE = '".$responseCerti->body->serie."', F_CAE = '".$responseCerti->body->numero."', F_DTE = '".$responseCerti->body->uuid."', F_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE F_CODIGO = '".$Uid."'");
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_2 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO, F_ORDEN, F_CON_DESCUENTO)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 3, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NombreCredito."', '".$Observaciones."', '".$NumeroResolucion."', '".$NumeroOrden."', '".$TotalDescuentoFactura."')");
...
$TotalFacturaFinal=number_format($TotalFacturaFinal, 2, ".", "");
	...
	$QueryEvento= mysqli_query($db, "UPDATE Eventos.EVENTO SET
					   ...
					   $QueryUpdateTransaccionContabilidad = mysqli_query($db,"UPDATE Contabilidad.TRANSACCION SET TRA_CONCEPTO = 'Vta. Restaurante Según Fact. ".$responseCerti->body->serie.' - '.$responseCerti->body->numero.' - '.$responseCerti->body->uuid."', TRA_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE TRA_CODIGO = '".$Uid."'");
						...
						####ALMACENAR DATOS DE CREDITO EN LA NUEVA TABLA CUENTAS POR COBRARA
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_2 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA, F_ORDEN, F_CON_DESCUENTO)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 4, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NumeroBoleta."', '".$Observaciones."', '".$NumeroResolucion."', '".$CuentaBancaria."', '".$NumeroOrden."', '".$TotalDescuentoFactura."')");
...
$TotalFacturaFinal=number_format($TotalFacturaFinal, 2, ".", "");
	...
	$QueryEvento= mysqli_query($db, "UPDATE Eventos.EVENTO SET
					   ...
					   $QueryUpdateFactura = mysqli_query($db,"UPDATE Bodega.FACTURA SET F_SERIE = '".$responseCerti->body->serie."', F_CAE = '".$responseCerti->body->numero."', F_DTE = '".$responseCerti->body->uuid."', F_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE F_CODIGO = '".$Uid."'");
					...
					else
					{
						...
						WHERE  FACTURA.F_CODIGO = '".$Uid."'")or die(mysqli_error());
							...
							$QueryBitacora1 = mysqli_query($db, "INSERT INTO Bitacoras.FACTURA_2_DETALLE
							SELECT * FROM Bodega.FACTURA_2_DETALLE
							WHERE FACTURA_2_DETALLE.F_CODIGO = '".$Uid."'")or die(mysqli_error());
