									...
									if($NumeroResultados > 0)
									{
										...
										<table class="table">
											<thead>
												<tr>
													...
													<th class="text-center"><strong><h6>Total Anticipo</h6></strong></th>
										...
										while($row = mysqli_fetch_array($result))
										{
											...
											echo '<tr>';
												...
												echo '<td>'.number_format($row["TRA_SALDO"], 2, '.', ',').'</td>';
												echo '<td><a href="LAPro.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
															<span class="glyphicon glyphicon-pencil"></span> Liquidar
														</button></a></td>';
											echo '</tr>';
											$i++;
										}
									...
									else
									{
										?>
											<div class="alert alert-callout alert-success" role="alert">
												Actualmente <strong>no hay</strong> solicitudes pendientes por operar.
											</div>
										<?php
									}
