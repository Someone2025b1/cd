...
FROM Taquilla.INGRESO_ACOMPANIANTE AS A
WHERE $filtroAsociados AND A.IAT_EDAD <18
 "));
//no asociados
...
WHERE $filtroTar
"));
$TotalTar = $selectTarj['NINOS']+$selectTarj['ADULTOS'];
...
INNER JOIN Taquilla.CLASIFICADOR_EVENTO C ON C.CE_ID = A.CE_ID
WHERE $filtroRefer"));
$SumaEventos = $selectEventos1["SUMA"]+$selectEventos2["SUMA"];
...
$totalNoAsociado = $noAsociadosAdulto["SUMA"]+$noAsociadosNino["SUMA"]+$selectHotel["ADULTOS"]+$selectHotel["MENORES"]+$selectTarj["ADULTOS"]+$selectTarj["NINOS"];
...
<table cellspacing="0" cellpadding="1" border="0">   
          <tr>
          <td style="width:150"><img src="logo.png"  width="100" height="50"></td>
          <td style="width:300px" align="center">INGRESOS AL PARQUE: $texto </td>
          </tr>
            </table> 
EOD;
