												...
												<div class="tab-content clearfix">
													<div class="tab-pane active" id="step1">
														...
														<div class="row">
															<div class="col-lg-3">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="NIT" id="NIT" onchange="ComprobarNIT(this.value)" <?php if($Fila_DatosOrdenEncabezado["M_NIT_FACTURA"] != ''){echo 'value="'.$Fila_DatosOrdenEncabezado[M_NIT_FACTURA].'"';}else{echo 'value="CF"';} ?> autofocus required/>
															...
															<div class="col-lg-9">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Nombre" id="Nombre" <?php if($Fila_DatosOrdenEncabezado["M_NOMBRE_FACTURA"] != ''){echo 'value="'.$Fila_DatosOrdenEncabezado[M_NOMBRE_FACTURA].'"';}else{echo 'value="Consumidor Final"';} ?> onkeyup="ComprobarAcentos(this)" required readonly/>
														...
														<div class="row">
															<div class="col-lg-12">
																<div class="form-group" id="DIVCIF">
																	<input class="form-control" type="text" name="Direccion" id="Direccion" <?php if($Fila_DatosOrdenEncabezado["M_DIRECCION_FACTURA"] != ''){echo 'value="'.$Fila_DatosOrdenEncabezado[M_DIRECCION_FACTURA].'"';}else{echo 'value="Ciudad"';} ?> onkeyup="ComprobarAcentos(this)"  required readonly/>
