							...
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<tbody>
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										$Codigo = $row["P_CODIGO"];
										echo '<tr>';
												echo '<td style="font-size: 12px">'.$row["P_CODIGO"].'</td>';               
												echo '<td style="font-size: 12px">'.$row["P_NOMBRE"].'</td>';
												echo '<td style="font-size: 12px">'.$row["P_NIT"].'</td>';
												echo '<td style="font-size: 12px">'.$row["P_DIRECCION"].'</td>';
												echo '<td><a href="PROMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-primary btn-xs">
												 Consultar
													</button></a></td>';
										echo '</tr>';
									}
