...
$Consulta = "SELECT * FROM Estado_Patrimonial.obligacioneslp_detalle WHERE acreedor = 'Coosajo R.L.' AND colaborador =  ".$ID;
...
while($row = mysqli_fetch_array($Resultado))
{
	...
	$opciones.='<td><h6><button type="button" class="btn btn-DANGER btn-xs deleteRow" ID="'.$row["id"].'" onClick="EliminarObligacioneslp(this)"><span class="glyphicon glyphicon-minus-sign"></span> Eliminar</button></h6></td>';
	$opciones.='</tr>';
}
