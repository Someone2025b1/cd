							...
							<div class="card-body">
								...
								<div class="col-lg-4">
									...
									##### ESTO MODIFIQUE 07/12/2022
									    $Contador = 1;
									   $Tickets = mysqli_query($db, "SELECT a.H_CODIGO, b.H_NOMBRE, SUM(a.IH_ADULTOS) AS ADULTOS, SUM(a.IH_ADULTO_MAYOR) AS ADULTOSM, SUM(a.IH_NINOS) AS NINOS, SUM(a.IH_TOTAL_ADULTO) AS TotalAdulto, SUM(a.IH_TOTAL_ADULTO_MAYOR) AS TotalAdultoM, SUM(a.IH_TOTAL_NINO) AS TotalNino
											FROM Taquilla.INGRESO_HOTEL a
											INNER JOIN Taquilla.HOTEL b ON a.H_CODIGO = b.H_CODIGO
									    ...
									    while($TicketHotelResult = mysqli_fetch_array($Tickets))
									    	{
									    	$totalpend = $TicketHotelResult["TotalAdulto"]+$TicketHotelResult["TotalAdultoM"]+$TicketHotelResult["TotalNino"];
											$totalAdultospend += $TicketHotelResult['ADULTOS'];
											$totalAdultospendM += $TicketHotelResult['ADULTOSM'];
								    		$totalNinospend += $TicketHotelResult['NINOS'];
											}
									      ?>
