			...
			<div class="container">
				...
				<?php
					...
					$Nombre = $_POST["Nombre"];
						...
						$sql = mysqli_query($db, "UPDATE Productos.RECETA SET R_NOMBRE = '".$Nombre."', R_PRECIO = '".$Total."', R_CANTIDAD_BOLAS = '".$CantidadBolas."', R_TERRAZAS = '".$Terrazas."', R_MIRADOR = '".$Mirador."', R_CAFE = '".$Cafe."', R_EVENTO = '".$Eventos."', R_GUARNICION = '".$Guarnicion."', R_DESCUENTO = '".$Descuento."', R_VERIFICADA = '".$Verificada."' WHERE R_CODIGO = '".$CodigoReceta."'");

						$sqlp = mysqli_query($db, "UPDATE Productos.PRODUCTO SET P_NOMBRE = '".$Nombre."', P_PRECIO_VENTA = '".$PrecioVenta."', P_BOLA = '".$CantidadBolas."',  P_ESTADO ='".$Estado."', P_TERRAZAS = '".$Terrazas."', P_HELADOS = '".$Helados."', P_CAFE = '".$Cafe."' WHERE R_CODIGO = '".$CodigoReceta."'");
