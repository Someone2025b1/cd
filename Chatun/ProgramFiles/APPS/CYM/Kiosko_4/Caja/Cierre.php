					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Consulta = "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_ESTADO = 1 AND ACC_TIPO = 18 AND ACC_ESTADO = 1";
								...
								elseif($Registros > 0)
								{
									...
									if($RegistrosQuery == 0)
									{
										...
										WHERE a.ACC_FECHA = CURDATE() AND a.ACC_TIPO = 18"));
