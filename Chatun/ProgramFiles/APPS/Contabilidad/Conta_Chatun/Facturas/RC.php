						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<select class="form-control selectpicker" data-live-search="true" required id="ColaboradorSolicita" name="ColaboradorSolicita">
												...
												<?php
													...
													while($row = mysqli_fetch_array($Result))
													{
														...
														echo '<option data-tokens="'.$Nombre.'" value="'.$row["cif"].'">'.$Nombre.'</option>';
													}
												?>
											</select>
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<select class="form-control" required id="AreaGasto" name="AreaGasto">
												...
												<?php
													...
													{
														echo '<option data-tokens="'.$row1["AG_NOMBRE"].'" value="'.$row1["AG_CODIGO"].'">'.$row1["AG_NOMBRE"].'</option>';
													}
												?>
											</select>
									...
									<table class="table table-hover table-condensed" name="tabla" id="tabla">
                                        <thead>
                                            <tr>
                                                ...
                                                <td><strong>Sugerencia de Compra</strong></td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr class="fila-base">
