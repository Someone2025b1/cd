...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
									...
									<div class="col-lg-6">
										<div class="form-group">
											<select name="Mes" class="form-control" required>
												<option value="" disabled selected>Seleccione una Mes</option>
		...
		if(isset($_GET["Mes"]))
		{
			...
			{
				header('Location: LVImpD.php?Mes='.$_GET["Mes"].'&anho='.$_GET["anho"]);
			}
			else
			{
				header('Location: LVSistemaImpD.php?Mes='.$_GET["Mes"].'&anho='.$_GET["anho"]);
			}
		}
		?>
