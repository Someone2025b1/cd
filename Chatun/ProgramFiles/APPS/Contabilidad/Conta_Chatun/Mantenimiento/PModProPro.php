						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											<input class="form-control" type="text" name="Comprobante" id="Comprobante" value="<?php echo $NoHoja; ?>"  required/>
                                        ...
                                        $Consulta = "SELECT TRANSACCION_DETALLE.*, NOMENCLATURA.N_NOMBRE 
											...
											while($row = mysqli_fetch_array($Resultado))
											{
	                                            ...
	                                            <tr>
	                                                ...
	                                                <td><h6><input type="number" step="any" class="form-control" name="Cargos[]" id="Cargos[]"  onChange="Calcular()" style="width: 100px" value="<?php echo $row['TRAD_CARGO_CONTA']; ?>" min="0"></h6></td>
	                                                <td><h6><input type="number" step="any" class="form-control" name="Abonos[]" id="Abonos[]" onChange="Calcular()" style="width: 100px" value="<?php echo $row['TRAD_ABONO_CONTA']; ?>"  min="0"></h6></td>
