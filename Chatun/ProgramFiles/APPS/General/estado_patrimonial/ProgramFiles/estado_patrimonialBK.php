...
var TODAY =  d.getDate() + " de " + monthname[d.getMonth()] + " del " + d.getFullYear();s
//---------------   END LOCALIZEABLE   ---------------
function cerrar(){
...
function operar() {
	camposTexto = document.getElementById("estado_patrimonial").elements; 
    for (x=0; x < camposTexto.length; x++) {
	  if (document.estado_patrimonial.patrimonio.value < 0) {
			document.estado_patrimonial.submit();
	  } else {		
	  	if (camposTexto[x].value < 0 ){
...
function calculo_bono14() {
	var bono14 = parseFloat(document.estado_patrimonial.sueldos_salarios.value);
	bono14 =  (bono14 * 2);
	document.estado_patrimonial.bono14_aguinaldo.value = bono14;
}
...
<tr bgcolor="#CCFF99" class="LetraBlanca Tamaño10" id="dateformat2">
  ...
  <?php
	...
	$sql2="SELECT * FROM Estado_Patrimonial.detalle_estado_patrimonial WHERE id=$auxi and mes=$mes_periodo and anio=$anio_periodo";
...
<table width="600" border="0" align="center" id="Tabla_general" class="Tamaño12">
  ...
  <tr>
    ...
    <td><label for="subtotal_activocirculante"></label>
      <input name="subtotal_activocirculante" type="text" id="subtotal_activocirculante" style="background-color:#FF9" onBlur="calcular_subtotal_activocirculante()" value="<?php echo $row2["subtotal_activocirculante"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="button" name="Grabar4" id="Grabar4" value="Grabar..." onClick="operar()"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <?php
		...
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_bienes_inmuebles WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo";
	...
	?>
    <td><input name="terrenos" type="text" id="terrenos" value="<?php echo $sumatoria_terrenos ?>" readonly></td>
  ...
  <tr>
    ...
    <?php
		...
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_vehiculos WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
			$sumatoria_vehiculos = $sumatoria_vehiculos + $sumatoria["valor_vehiculo"];
		}
	?>
    <td><input name="vehiculos" type="text" id="vehiculos" value="<?php echo $sumatoria_vehiculos ?>" readonly></td>
  ...
  <tr>
	...
	<?php
		...
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_valor_acciones WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
			$sumatoria_valores = $sumatoria_valores + $sumatoria["valor_comercial"];
		}
	?>
    <td><input name="inversiones_valores" type="text" id="inversiones_valores" value="<?php echo $sumatoria_valores ?>" readonly></td>
  ...
  <tr>
    <td><b>SUB-TOTAL:</b></td>
    <td><input name="subtotal_activofijo" type="text" id="subtotal_activofijo" style="background-color:#FF9" onBlur="calcular_subtotal_activofijo()" value="<?php echo $row2["subtotal_activofijo"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><b>TOTAL DEL ACTIVO:</b></td>
    <td><input name="total_activo" type="text" id="total_activo" style="background-color:#CF3" onBlur="calcular_totalactivo()" value="<?php echo $row2["total_activo"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><input type="button" name="Grabar2" id="Grabar2" value="Grabar..." onClick="operar()"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <?php
    	$sumatoria_valores = 0.00;
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_obligaciones_corto_plazo WHERE  colaborador=$auxi AND acreedor = 'Coosajo R.L.' and mes=$mes_periodo and anio=$anio_periodo";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
			$sumatoria_valores = $sumatoria_valores + $sumatoria["saldo_actual"];
		}
	?>
    <td><input name="prestamos_coosajo_menor" type="text" id="prestamos_coosajo_menor" onBlur="Grabar1()" value="<?php echo $sumatoria_valores ?>" readonly></td>
  ...
  <tr>
	...
	?>
    <td><input name="prestamos_bancos_menor" type="text" id="prestamos_bancos_menor" value="<?php echo $sumatoria_valores ?>" readonly></td>
    <td><a href="obligaciones_cortoplazo.php"><img src="../Imagenes/Agregar.gif" alt="Agregar..." width="20" height="20" border="0"></a></td>
  </tr>
  <tr>
	<?php
    	$sumatoria_valores = 0.00;
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_tarjetas_credito WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
			$sumatoria_valores = $sumatoria_valores + $sumatoria["saldo_actual"];
		}
    ...
    <td><input name="tarjetas_credito" type="text" id="tarjetas_credito" value="<?php echo $sumatoria_valores ?>" readonly></td>
  ...
  <tr>
    <td><b>SUB-TOTAL:</b></td>
    <td><input name="subtotal_pasivocirculante" type="text" id="subtotal_pasivocirculante" style="background-color:#FF9" onBlur="calcular_subtotal_pasivocirculante()" value="<?php echo $row2["subtotal_pasivocirculante"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
	<?php
    	$sumatoria_valores = 0.00;
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_obligaciones_largo_plazo WHERE colaborador=$auxi AND acreedor = 'Coosajo R.L.' and mes=$mes_periodo and anio=$anio_periodo ";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
			$sumatoria_valores = $sumatoria_valores + $sumatoria["saldo_actual"];
		}
    ...
    <td><input name="prestamos_coosajo_mayores" type="text" id="prestamos_coosajo_mayores" onBlur="Grabar1()" value="<?php echo $sumatoria_valores ?>" readonly></td>
  ...
  <tr>
	...
	?>
    <td><input name="prestamos_bancos_mayores" type="text" id="prestamos_bancos_mayores" value="<?php echo $sumatoria_valores ?>" readonly></td>
    <td><a href="obligaciones_largoplazo.php"><img src="../Imagenes/Agregar.gif" alt="Agregar..." width="20" height="20" border="0"></a></td>
  </tr>
  <tr>
    <td>Otras deudas:</td>
  ...
  <tr>
    <td><b>SUB-TOTAL:</b></td>
    <td><input name="subtotal_pasivofijo" type="text" id="subtotal_pasivofijo" style="background-color:#FF9" onBlur="calculo_subtotal_pasivofijo()" value="<?php echo $row2["subtotal_pasivofijo"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><b>TOTAL DEL PASIVO:</b></td>
    <td><input name="total_pasivo" type="text" id="total_pasivo" style="background-color:#CF3" onBlur="calculo_totalpasivo()" value="<?php echo $row2["total_pasivo"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input name="patrimonio" type="text" id="patrimonio" style="background-color:#CF3" onBlur="calculo_patrimonio()" value="<?php echo $row2["patrimonio"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><input name="total_pasivo_patrimonio" type="text" id="total_pasivo_patrimonio" style="background-color: #C63" onBlur="suma_final()" value="<?php echo $row2["total_pasivo_patrimonio"] ?>" readonly></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td align="center">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td align="center"><input type="button" name="Grabar3" id="Grabar3" value="Grabar..." onClick="operar()"></td>
    </tr>
  <tr>
  </tr>
</table>
...
//select de proyeccion de ingresos y egresos
	$sql3="SELECT * FROM Estado_Patrimonial.detalle_proyeccion_ingresos_egresos WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo ";
...
?>
    ...
    <td align="left"><label for="sueldos_salarios"></label>
      <input name="sueldos_salarios" type="text" id="sueldos_salarios" value="<?php echo $row3["sueldos_salarios"] ?>" size="15" onBlur="calculo_bono14()"></td>
  ...
  <tr>
    ...
    <td align="left"><label for="sueldos_salarios"></label>
      <input name="bono14_aguinaldo" type="text" id="bono14_aguinaldo" value="<?php echo $row3["bono14_aguinaldo"] ?>" size="15" readonly></td>
  ...
  <tr>
	<?php
    	$sumatoria_valores = 0.00;
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_otros_ingresos WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo ";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
    ...
    <td align="left"><label for="sueldos_salarios"></label>
      <input name="otros_ingresos" type="text" id="otros_ingresos" value="<?php echo $sumatoria_valores ?>" size="15" readonly>
      <a href="otros_ingresos.php"><img src="../Imagenes/Agregar.gif" alt="Agregar..." width="20" height="20" border="0"></a></td>
	<?php
    	$sumatoria_valores = 0.00;
		$sql_contar="SELECT * FROM Estado_Patrimonial.detalle_otros_egresos WHERE colaborador=$auxi and mes=$mes_periodo and anio=$anio_periodo ";
		$contar=mysqli_query($db, $sql_contar);
		while ($sumatoria=mysqli_fetch_array($contar)) 	{ 
			$sumatoria_valores = $sumatoria_valores + $sumatoria["monto"];
		}
    ...
    <td align="left"><input name="otros_egresos" type="text" id="otros_egresos" value="<?php echo $sumatoria_valores ?>" size="15" readonly>
  ...
  <tr>
    ...
    <td align="left"><label for="sueldos_salarios"></label>
      <input name="total_ingresos" type="text" id="total_ingresos" style="background-color:#CF3" value="<?php echo $row3["total_ingresos"] ?>" size="15" readonly onBlur="calculo_total_ingresos()"></td>
    <td align="left"><b><i>Total de egresos:</i></b></td>
    <td align="left"><input name="total_egresos" type="text" id="total_egresos" style="background-color:#CF3" value="<?php echo $row3["total_egresos"] ?>" size="15" readonly onBlur="calculo_total_egresos()"></td>
    </tr>
  <tr>
    <td align="left">&nbsp;</td>
    <td align="left">&nbsp;</td>
...
<table width="81" border="0" align="center">
  <tr>
    <td height="62" align="center"><a href="informacion_base.php"><img src="../Imagenes/back.png" alt="Regresar..." width="128" height="128" border="0"></a></td>
    <td align="center"><a href="menu.php"><img src="../Imagenes/bienes_inmuebles.png" alt="Pantalla Principal" width="128" height="125" border="0"></a></td>
    </tr>
  <tr>
    <td height="25" align="center"><a href="informacion_base.php">ATRAS</a></td>
    <td height="25" align="center"><a href="menu.php">MENU PRINCIPAL</a></td>
    </tr>
</table>
  <!-- end #container -->	
</div>
