			...
			<div class="container">
				<form class="form" method="POST" role="form" id="FormularioEnviar">
					<div class="col-lg-12">
										...
										<div class="form-group">
											<?php 
                                                ...
                                                <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-3">
                                                            <div class="form-group">
                                                            <input class="form-control" type="text" name="Total" id="Total" value="<?php echo $row["EN_TOTAL_PRODUCTOS"]; ?>"  readonly/>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <table class="table" name="tabla" id="tabla">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = "SELECT ENVIOS_DETALLE.*, ENVIOS.EN_CODIGO FROM Productos.ENVIOS_DETALLE, Productos.ENVIOS WHERE ENVIOS.EN_CODIGO = ENVIOS_DETALLE.EN_CODIGO AND ENVIOS.EN_ESTADO <> 2 AND ENVIOS_DETALLE.EN_CODIGO ='$CodigoEnv'";
                                            $result = mysqli_query($db, $query);
                                            while($row = mysqli_fetch_array($result))
                                            {
                                                $Pro = $row['P_CODIGO'];
                                            ...
                                            <tr>
                                                ...
                                                <td><h6><input type="number" class="form-control" name="Cantidad[]" id="Cantidad[]" onChange="CalcularTotal()" style="width: 100px" min="0" value="<?php echo $row["END_CANTIDAD"]; ?>" required readonly></h6></td>
                                                <td class="eliminar">
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; vertical-align: text-top; font-size: 20px"><input class="form-control" type="text" id="BoldTotal" name="TotalFacturaFinal" value="<?php echo $total; ?>" readonly></td>
						...
						<button type="submit" onclick="EnviarForm()" class="btn ink-reaction btn-raised btn-primary" id="btnGuardar">Recivir</button>
							</div>
