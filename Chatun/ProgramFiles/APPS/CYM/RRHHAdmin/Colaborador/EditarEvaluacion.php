...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				...
				<br>
				<form action="EditarEvaluacionPro.php" method="POST" class="form" enctype="multipart/form-data">
				<div class="col-lg-12">
				<div class="col-lg-12">
					<div class="card">
	...
	LlenarTablaPuesto(15);
									...
									<div class="col-lg-3">
										<div class="form-group ">
										<label for="CodEvaluacion">Codigo Evaluación</label>
											<input class="form-control" type="text" name="CodEvaluacion" id="CodEvaluacion" value="<?php echo $CodigoE; ?>" readonly />
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group ">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							while($roweas = mysqli_fetch_array($resultAs))
							{
								...
								$CodigoAspecto=$roweas["AR_CODIGO"];
						        ...
						        <td><h6><input type="number" class="form-control" name="Punteo<?php echo $CodAre ?>[]" id="Punteo<?php echo $CodAre ?>[]" style="width: 50px"  max="100" min="0" onChange="CalcularTotal(<?php echo $CodAre ?>)" value="<?php echo $Punteo; ?>" ></h6></td>
								  </tr>		
								...
								while($roweas = mysqli_fetch_array($resultAs))
								{
									...
									$sqlRet = mysqli_query($db,"SELECT A.*
										...
										echo '<td><h6><input type="Text" class="form-control" name="Aspecto8[]" id="Aspecto8[]"  style="width: 800px" value="'.$NombreAspecto.'" readonly></h6></td>';
											...
											echo' <td><h6><input type="number" class="form-control" name="Punteo8[]" id="Punteo8[]" style="width: 50px" max="100" min="0" value="'.$Punteo.'" onChange="CalcularTotal('.$CodArea.')" ></h6></td>';
								...
								while($roweas = mysqli_fetch_array($resultAs))
								{
									...
									echo '<tr>';
										...
										echo '<td><h6><input type="Text" class="form-control" name="Aspecto9[]" id="Aspecto9[]"  style="width: 800px" value="'.$NombreAspecto.'" readonly></h6></td>';
											...
											echo' <td><h6><input type="number" class="form-control" name="Punteo9[]" id="Punteo9[]" style="width: 50px" value="'.$Punteo.'" max="100" min="0" onChange="CalcularTotal('.$CodArea.')" ></h6></td>';
