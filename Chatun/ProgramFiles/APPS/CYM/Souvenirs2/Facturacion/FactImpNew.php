...
$sqlD = "SELECT FACTURA_SV_2_DETALLE.*, PRODUCTO.P_NOMBRE, PRODUCTO.P_JUEGOS 
                FROM Bodega.FACTURA_SV_2_DETALLE, Productos.PRODUCTO 
...
//***********************************************************
//***********************************************************
$pdf = new MYPDF("P","pt", array(600, 3500), 'UTF-8', FALSE);
// Add a page
$pdf->AddPage();
...
$sqlD = "SELECT FACTURA_SV_2_DETALLE.*, PRODUCTO.P_NOMBRE, PRODUCTO.P_COMBO
        FROM Bodega.FACTURA_SV_2_DETALLE, Productos.PRODUCTO 
        WHERE FACTURA_SV_2_DETALLE.P_CODIGO = PRODUCTO.P_CODIGO
        AND FACTURA_SV_2_DETALLE.F_CODIGO = '".$Factura."' AND PRODUCTO.P_JUEGOS =1";
$resultD = mysqli_query($db, $sqlD);
