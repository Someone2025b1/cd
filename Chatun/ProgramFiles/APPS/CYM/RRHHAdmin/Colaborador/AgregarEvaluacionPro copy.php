						...
						while($row = mysqli_fetch_array($result))
						{
							...
							$NombreAre=$row["AR_NOMBRE"];
										...
										$PuntosPosibles  = $_POST["EsperadoAreaR".$CodAre];
											...
											$queryAbonoProd = mysqli_query($db, "INSERT INTO RRHH.EVALUACION_DES_RESUMEN (ED_CODIGO, AR_CODIGO, EVDR_PROMEDIO, EVDR_PUNTEO, EVDR_PUNTEO_POS)
											VALUES('".$CodEvaluacion."', '".$CodAre."', '".$Promedio."', '".$Punteo."', '".$PuntosPosibles."')");
