			...
			<div class="container">
				...
				<form class="form" action="CTAAddPro.php" method="POST" role="form">
					<?php
						...
						if($TipoReceta == 1)
						{
							$sql = mysqli_query($db, "INSERT INTO Bodega.RECETA_SUBRECETA (RS_CODIGO, RS_NOMBRE, CM_CODIGO, RS_TIPO, RS_PRECIO, RS_BODEGA)
												VALUES ('".$UI."', '".$Nombre."', ".$Categoria.", ".$TipoReceta.", ".$Precio.", 'TR')");
						...
						else
						{
							...
							$sql = mysqli_query($db, "INSERT INTO Bodega.RECETA_SUBRECETA (RS_CODIGO, RS_NOMBRE, CM_CODIGO, RS_TIPO, RS_BODEGA)
												VALUES ('".$UI."', '".$Nombre."', ".$Categoria.", ".$TipoReceta.", 'TR')");
							...
							$sql = mysqli_query($db, "INSERT INTO Bodega.PRODUCTO (P_NOMBRE, P_STOCK_MINIMO, CP_CODIGO, UM_CODIGO, P_CODIGO_SUBRECETA)
											VALUES ('".$Nombre."', ".$StockMinimo.", 'TR', ".$UnidadMedida.", '".$UI."')");
						}
