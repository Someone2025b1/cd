...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<?php
			...
			if($TipoPago == 1)
			{
				$ConsultaOrden = "SELECT F_ORDEN FROM Bodega.FACTURA_KS_3 WHERE F_FECHA_TRANS = CURRENT_DATE ORDER BY F_ORDEN DESC LIMIT 1";
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_KS_3 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_FECHA_TRANS, F_HORA, F_USUARIO, F_MONEDA, F_EFECTIVO, F_CAMBIO, F_OBSERVACIONES, RES_NUMERO, F_CON_DESCUENTO, F_ORDEN)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 1, '".$NIT."', ".$TotalFacturaFinal.", CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user.", ".$Moneda.", ".$Efectivo.", ".$Cambio.", '".$Observaciones."', '".$NumeroResolucion."', '".$TotalDescuentoFactura."', '".$NumeroOrden."')");
				...
				$sqlAbono = mysqli_query($db,"INSERT INTO Bodega.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_OBSERVACIONES, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, B_CODIGO, F_CODIGO)
											 VALUES('".$UI."', CURRENT_DATE(), 'Vta. Kiosko Oasis Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 1, 9, 1, '".$Uid."')") or die(mysqli_error());
				...
				else
				{
					...
					{ 
						...
						$query = mysqli_query($db,"INSERT INTO Bodega.FACTURA_KS_3_DETALLE (F_CODIGO, FD_CODIGO, FD_CANTIDAD, RS_CODIGO, FD_PRECIO_UNITARIO, FD_SUBTOTAL, FD_DESCUENTO, FD_TIPO)
											VALUES('".$Uid."', '".$UidD."', ".$Can.", '".$Prod."', ".$Pre.", ".$SubFac.", ".$Des.", '$TipoProd')");
						...
						if($TipoProd == 1)
						{
							...
							if($i != 0)
							{
								...
								$SqlContableD2 = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
															VALUES('".$Uid."', '".$UidD."', '4.01.03.009', 0.00, ".number_format($PrecioProductoNeto, 2, ".", "").")");
						...
						else
						{
							...
							$SqlContableD2 = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '".$FilaNomenclatura["N_CODIGO"]."', 0.00, ".number_format($PrecioProductoNeto, 2, ".", "").")");
					...
					****************************************************************************************/
					...
					$SqlContable = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_SERIE, TRA_FACTURA, TRA_TOTAL, RES_NUMERO, TRA_CORRELATIVO, PC_CODIGO)
											 VALUES('".$Uid."', CURRENT_DATE(), 'Vta. Kiosko Oasis Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 2, 28, '".$SerieAutorizada."', '".$FacturaNumero."', ".$TotalFacturaFinal.", '".$NumeroResolucion."', ".$Correlativo.", ".$Periodo.")") or die(mysqli_error());
					...
					$SqlContableD = mysqli_query($db,"INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '1.01.01.017', ".number_format($TotalFacturaFinal, 2, ".", "").", 0.00)");
					...
					for($i=1; $i<$Contador; $i++)
				{
					...
					WHERE P_CODIGO = ".$Prod);
						...
						if($rowe["R_CODIGO"]!=NULL){
							...
							while($rower = mysqli_fetch_array($resultr))
							{
								...
								VALUES('".$KCod."', '".$Uid."', '".$ProdR."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Venta de Producto Segun Factura de Kiosco Oasis Serie Número "."$SerieAutorizada"."  "."$FacturaNumero"."', '".$existenciaGAnR."', '".$cantidadgenR."', 1, '".$existenciaAnR."', '".$nuevaexistenciaR."')");
					...
					$querykardex = mysqli_query($db, "INSERT INTO Productos.KARDEX (K_CODIGO, TRA_CODIGO, P_CODIGO, K_FECHA, K_HORA, K_DESCRPCION, K_EXISTENCIA_ANTERIOR, K_EXISTENCIA_ACTUAL, K_PUNTO_VENTA, K_EXISTENCIA_ANTERIOR_PUNTO, K_EXISTENCIA_ACTUAL_PUNTO)
					VALUES('".$KCod."', '".$Uid."', '".$Prod."', CURRENT_DATE(), CURRENT_TIMESTAMP(), 'Venta de Producto Segun Factura de Kiosco Oasis Serie Número "."$SerieAutorizada"."  "."$FacturaNumero"."', '".$existenciaGAn."', '".$cantidadgen."', 1, '".$existenciaAn."', '".$nuevaexistencia."')");
...
######################## FIN KARDEX ####################
					   ...
					   $QueryUpdateFactura = mysqli_query($db,"UPDATE Bodega.FACTURA_KS_3 SET F_SERIE = '".$responseCerti->body->serie."', F_CAE = '".$responseCerti->body->numero."', F_DTE = '".$responseCerti->body->uuid."', F_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE F_CODIGO = '".$Uid."'");

					   $QueryUpdateTransaccionBodega = mysqli_query($db,"UPDATE Bodega.TRANSACCION SET TRA_OBSERVACIONES = 'Vta. Kiosko Oasis Según Fact. ".$responseCerti->body->serie.' - '.$responseCerti->body->numero.' - '.$responseCerti->body->uuid."' WHERE F_CODIGO = '".$Uid."'");

					   $QueryUpdateTransaccionContabilidad = mysqli_query($db,"UPDATE Contabilidad.TRANSACCION SET TRA_CONCEPTO = 'Vta. Kiosko Oasis Según Fact. ".$responseCerti->body->serie.' - '.$responseCerti->body->numero.' - '.$responseCerti->body->uuid."', TRA_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE TRA_CODIGO = '".$Uid."'");
					}
					else
					{
						$QueryBitacora = mysqli_query($db, "INSERT INTO Bitacoras.FACTURA 
						SELECT FACTURA_KS_3.F_CODIGO, '11', FACTURA_KS_3.F_ORDEN, FACTURA_KS_3.F_SERIE, FACTURA_KS_3.F_NUMERO, FACTURA_KS_3.F_TIPO, FACTURA_KS_3.CLI_NIT, FACTURA_KS_3.D_CODIGO, FACTURA_KS_3.F_CON_DESCUENTO, FACTURA_KS_3.F_TOTAL, FACTURA_KS_3.F_EFECTIVO, FACTURA_KS_3.F_CAMBIO, FACTURA_KS_3.F_FECHA_TRANS, FACTURA_KS_3.F_HORA, FACTURA_KS_3.F_USUARIO, FACTURA_KS_3.F_MONEDA, FACTURA_KS_3.F_ESTADO, FACTURA_KS_3.F_RAZON_ANULACION, FACTURA_KS_3.F_NOMBRE_CREDITO, FACTURA_KS_3.F_NO_BOLETA, FACTURA_KS_3.F_OBSERVACIONES, FACTURA_KS_3.F_NO_AUTORIZACION, FACTURA_KS_3.RES_NUMERO, FACTURA_KS_3.F_CUENTA_BANCARIA, FACTURA_KS_3.F_REALIZADA, FACTURA_KS_3.F_CAE, FACTURA_KS_3.F_DTE, FACTURA_KS_3.F_FECHA_CERTIFICACION, FACTURA_KS_3.F_TIPO_TARJETA FROM Bodega.FACTURA_KS_3 
						WHERE  FACTURA_KS_3.F_CODIGO = '".$Uid."'")or die(mysqli_error());

							$QueryBitacora1 = mysqli_query($db, "INSERT INTO Bitacoras.FACTURA_DETALLE SELECT F_CODIGO, FD_CODIGO, FD_CORRELATIVO, 5, FD_CANTIDAD, RS_CODIGO, FD_PRECIO_UNITARIO, FD_DESCUENTO, FD_SUBTOTAL FROM Bodega.FACTURA_KS_3_DETALLE WHERE FACTURA_KS_3_DETALLE.F_CODIGO = '".$Uid."'")or die(mysqli_error());
							...
							$QueryDosRestaurante = mysqli_query($db, "DELETE 
																...
																WHERE FACTURA_KS_3_DETALLE.F_CODIGO = '".$Uid."'")or die(mysqli_error());
			...
			elseif($TipoPago == 2)
			{
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_KS_3 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_OBSERVACIONES, F_NO_AUTORIZACION, RES_NUMERO, F_CON_DESCUENTO, F_TIPO_TARJETA, F_ORDEN)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 2, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.", '".$Observaciones."', '".$NumeroAutorizacionTXT."', '".$NumeroResolucion."', '".$TotalDescuentoFactura."', '".$TipoTarjeta."', '".$NumeroOrden."')");

				$sqlAbono = mysqli_query($db,"INSERT INTO Bodega.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_OBSERVACIONES, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, B_CODIGO, F_CODIGO)
											 VALUES('".$UI."', CURRENT_DATE(), 'Vta. Kiosko Oasis Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 1, 9, 1, '".$Uid."')");
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_KS_3 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO, F_CON_DESCUENTO, F_ORDEN)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 3, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NombreCredito."', '".$Observaciones."', '".$NumeroResolucion."', '".$TotalDescuentoFactura."' , '".$NumeroOrden."')");

				$sqlAbono = mysqli_query($db,"INSERT INTO Bodega.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_OBSERVACIONES, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, B_CODIGO, F_CODIGO)
											 VALUES('".$UI."', CURRENT_DATE(), 'Vta. Kiosko Oasis Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 1, 9, 1, '".$Uid."', '".$TotalDescuentoFactura."')");
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db,"INSERT INTO Bodega.FACTURA_KS_3 (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA, F_CON_DESCUENTO, F_ORDEN)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 4, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NumeroBoleta."', '".$Observaciones."', '".$NumeroResolucion."', '".$CuentaBancaria."', '".$TotalDescuentoFactura."', '".$NumeroOrden."')");
