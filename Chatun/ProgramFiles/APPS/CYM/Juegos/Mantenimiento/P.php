...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Juegos</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						<div class="card-head style-primary">
						<h4 class="text-center"><strong>Juegos</strong></h4>
						</div>
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								<thead>
									...
									<th><strong>Precio Especial</strong></th>
									<th><strong>Precio Combo</strong></th>
									<th><strong>Precio Escala</strong></th>
								...
								<?php
									...
									{
										$Codigo = $row["P_CODIGO"];
										$Escala = mysqli_num_rows(mysqli_query($db, "SELECT * FROM Bodega.ESCALA_PRODUCTO WHERE P_CODIGO = $row[P_CODIGO] and Estado = 1"));
										if ($Escala>0) {
											$texto = '<span class="fa fa-check"></span>';
										}
										else
										{
											$texto = "";
										}
										$Imagen = "../Icono/".$row["P_ICONO"];
										echo '<tr>';
										    	echo '<td>'.$row["P_CODIGO"].'</td>';               
										    	echo '<td>'.$row["P_NOMBRE"].'</td>'; 
										    	echo '<td>'.$row["P_PRECIO"].'</td>';
										    	echo '<td>'.$row["P_PRECIO_ESPECIAL"].'</td>';
										    	echo '<td>'.$row["P_PRECIO_COMBO"].'</td>';
										    	echo '<td align="center">'.$texto.'</td>';
										    	echo '<td><a href="'.$Imagen.'" target="_blank"><i class="fa fa-eye"></i></a>
														</td>';
