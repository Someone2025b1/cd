...
if($TipoDoc=="N"){
	...
	$XMLEnviar = '
			...
			if($TipoPago == 1)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_FECHA_TRANS, F_HORA, F_USUARIO, F_MONEDA, F_EFECTIVO, F_CAMBIO, F_OBSERVACIONES, RES_NUMERO, F_DESCRIPCION_FACTURA, F_CANTIDAD_DES, F_PRECIO_DES)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 1, '".$NIT."', ".$TotalFacturaFinal.", CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user.", ".$Moneda.", ".$Efectivo.", ".$Cambio.", '".$Observaciones."', '".$NumeroResolucion."', '".$DescripcionFac."', ".$CantidadDes.", ".$PrecioDes.")") or die('Encabezado Factura 1'.mysqli_error());
				...
				****************************************************************************************/
				...
				$SqlContable = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_SERIE, TRA_FACTURA, TRA_TOTAL, RES_NUMERO, TRA_CORRELATIVO, PC_CODIGO)
										 VALUES('".$Uid."', CURRENT_DATE(), 'Vta. Eventos Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 2, 21, '".$SerieAutorizada."', '".$FacturaNumero."', ".$TotalFacturaFinal.", '".$NumeroResolucion."', ".$Correlativo.", ".$Periodo.")") or die('Encabezado Conta 1'.mysqli_error());
				...
				else
				{
					for($i=1; $i<$Contador; $i++)
					{
						...
						if($Tip == 2)
						{
							...
							$SqlContableD2 = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
															VALUES('".$Uid."', '".$UidD."', '4.01.03.002', 0.00, ".number_format($PrecioProductoNeto, 4, ".", "").")");
						...
						else
						{
							...
							$SqlContableD2 = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION_DETALLE(TRA_CODIGO, TRAD_CODIGO, N_CODIGO, TRAD_CARGO_CONTA, TRAD_ABONO_CONTA) 
												VALUES('".$Uid."', '".$UidD."', '".$FilaNomenclatura["N_CODIGO"]."', 0.00, ".number_format($PrecioProductoNeto, 4, ".", "").")");
					...
					$IVAProducto = (($SubTotalDes / 1.12) * 0.12);
					$SubNeto = $SubTotalDes - $IVAProducto;
					$i=1;
					if($i != 0)
					{
						$MontoImpuesto = ($SubTotalDes * .12) / 1.12;
					$MontoGravable = $SubTotalDes - $MontoImpuesto;
					$Total = $MontoGravable + $MontoImpuesto;
					$Des=0;
					...
					$XMLEnviar .= '
						          <dte:Item BienOServicio="B" NumeroLinea="'.$i.'">
						            <dte:Cantidad>'.$CantidadDes.'</dte:Cantidad>
						            <dte:UnidadMedida>UND</dte:UnidadMedida>
						            <dte:Descripcion>'.$DescripcionFac.'</dte:Descripcion>
						            <dte:PrecioUnitario>'.number_format($PrecioDes, 3, '.', '').'</dte:PrecioUnitario>
						            <dte:Precio>'.number_format($SubTotalDes, 2, '.', '').'</dte:Precio>
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 2)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_OBSERVACIONES, F_NO_AUTORIZACION, RES_NUMERO, F_DESCRIPCION_FACTURA, F_CANTIDAD_DES, F_PRECIO_DES)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 2, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.", '".$Observaciones."', '".$NumeroAutorizacionTXT."', '".$NumeroResolucion."', '".$DescripcionFac."', ".$CantidadDes.", ".$PrecioDes.")") or die(mysqli_error());
				...
				****************************************************************************************/
				...
				$SqlContable = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_SERIE, TRA_FACTURA, TRA_TOTAL, RES_NUMERO, TRA_CORRELATIVO, PC_CODIGO)
										 VALUES('".$Uid."', CURRENT_DATE(), 'Vta. Eventos Según Fact. ".$SerieAutorizada." ".$FacturaNumero."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 2, 21, '".$SerieAutorizada."', '".$FacturaNumero."', ".$TotalFacturaFinal.", '".$NumeroResolucion."', ".$Correlativo.", ".$Periodo.")") or die(mysqli_error());
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO, F_DESCRIPCION_FACTURA, F_CANTIDAD_DES, F_PRECIO_DES)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 3, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NombreCredito."', '".$Observaciones."', '".$NumeroResolucion."', '".$DescripcionFac."', ".$CantidadDes.", ".$PrecioDes.")") or die(mysqli_error());
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA, F_DESCRIPCION_FACTURA, F_CANTIDAD_DES, F_PRECIO_DES)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 4, '".$NIT."', ".$TotalFacturaFinal.", 0.00, 0.00, CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NumeroBoleta."', '".$Observaciones."', '".$NumeroResolucion."', '".$CuentaBancaria."', '".$DescripcionFac."', ".$CantidadDes.", ".$PrecioDes.")") or die(mysqli_error());
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 5){
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA, F_NO_AUTORIZACION, F_EFECTIVO_M, F_TARJETA_M, F_BANCO_M, F_ANTICIPO_M, F_DESCRIPCION_FACTURA, F_CANTIDAD_DES, F_PRECIO_DES)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 5, '".$NIT."', ".$TotalFacturaFinal.", 0.00, ".$CambioM.", CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NumeroBoletaM."', '".$Observaciones."', '".$NumeroResolucion."', '".$CuentaBancariaM."', '".$AutorizacionM."', ".$MontoEfectivo.", ".$MontoTarjeta.", ".$MontoBanco.", ".$MontoAnticipo.", '".$DescripcionFac."', ".$CantidadDes.", ".$PrecioDes.")") or die(mysqli_error());
