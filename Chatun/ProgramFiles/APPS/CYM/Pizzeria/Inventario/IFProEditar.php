...
<script>
	function EnviarForGuardar()
	{
		...
		$(Formulario).attr('action', 'IFProGuardarEditado.php');
		$(Formulario).submit();	
							...
							<div class="card-body">
								...
								<table class="table table-hover table-condensed">
									...
									<tbody>
										...
										$QueryCuentas = "SELECT INVENTARIO_DETALLE.P_CODIGO, INVENTARIO_DETALLE.ID_CANTIDAD_CONTADA, UNIDAD_MEDIDA.UM_NOMBRE, PRODUCTO.P_NOMBRE 
