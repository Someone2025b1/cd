...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	{	
		...
		$rutaFoto = "files/".$CodigoColaborador."/Foto-".$CodigoColaborador.".".$ExtensionFoto;
	}
                        ...
                        <div class="card-body">
							...
							<div class="col-lg-8">
									...
									<div class="col-lg-8">
										...
										<select name="EstadoCol" id="EstadoCol" class="form-control">
								...
								<div class="col-lg-3">
                                        ...
                                        <label for="DPI">DPI</label>
											<input class="form-control" type="text" name="DPI" id="DPI" value="<?php echo $DPI; ?>" />
									...
									<div class="col-lg-3">
                                        ...
                                        <label for="Extendido">Extendido En:</label>
											<input class="form-control" type="text" name="Extendido" id="Extendido" value="<?php echo $Extendido; ?>" />
									...
									<div class="col-lg-3">
                                        ...
                                        <label for="DPI">Tipo Sangre</label>
											<input class="form-control" type="text" name="TipoSangre" id="TipoSangre" value="<?php echo $TipoSangre; ?>" />
								...
								<div class="row">
									...
									<div class="col-lg-3">
                                        ...
                                        <label for="Nacido">Lugar de Nacimineto</label>
											<input class="form-control" type="text" name="Nacido" id="Nacido" value="<?php echo $Nacido; ?>" />
									...
									<div class="col-lg-3">
                                        ...
                                        <label for="FechaNacimiento">Edad</label>
											<input class="form-control" type="text" name="Edad" id="Edad" value="<?php echo $Edad; ?> Años"/>
										</div>
									</div>
									<div class="col-lg-3">
										<div class="form-group floating-label">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<textarea class="form-control" name="Direccion" id="Direccion" rows="2" cols="40"><?php echo $Direccion; ?></textarea>
											</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
                                        <label for="IGSS">No. IGSS</label>
											<input class="form-control" type="num" name="IGSS" id="IGSS"  value="<?php echo $IGSS; ?>" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
                                        <label for="NIT">NIT</label>
											<input class="form-control" type="num" name="NIT" id="NIT"  value="<?php echo $NIT; ?>"/>
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
								...
								<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Vehiculo" id="Vehiculo" <?php if($Vehiculo==1){ echo 'checked';  } ?> onchange="Carro(this)">
												<span>Vehiculo</span>
											</label>
										</div>
										
										<div class="form-group floating-label" id="DIVCARRO" <?php if($Vehiculo==0){ echo 'style="display: none;"';  }?>>
										<div class="checkbox checkbox-styled">
                                        <label>
												<input type="checkbox" name="Automovil" id="Automovil" <?php if($Automovil==1){ echo 'checked';  } ?>>
												<span>Automovil</span>
											</label>
											</div>
											<div class="checkbox checkbox-styled">
											<label>
												<input type="checkbox" name="Motocicleta" id="Motocicleta" <?php if($Motocicleta==1){ echo 'checked';  } ?>>
							...
							<div class="row">
									...
									<div class="col-lg-2">
                                        ...
                                        <label for="FechaInicio">Fecha de Inicio Laboral</label>
											<input class="form-control" type="date" name="FechaInicio" id="FechaInicio" value="<?php echo $FechaInicio; ?>" />
										</div>
									</div>
									...
									<div class="col-lg-4">
                                        ...
                                        <label for="Base">Salario Base</label>
											<input class="form-control" type="num" name="Base" id="Base" value="<?php echo $Base; ?>"  />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
                                        <label for="BonoLey">Bono Ley</label>
											<input class="form-control" type="num" name="BonoLey" id="BonoLey" value="<?php echo $BonoLey; ?>" />
										</div>
									</div>
									<div class="col-lg-4">
										<div class="form-group floating-label">
                                        <label for="Bono">Bonificación Insentivo</label>
											<input class="form-control" type="num" name="Bono" id="Bono" value="<?php echo $Bono; ?>" />
										</div>
									</div>
									</div>
									</div>
									...
									<div class="col-lg-12">
										...
										<textarea class="form-control" name="ObservacionesGen" id="ObservacionesGen" rows="2" cols="40"><?php echo $Observaciones; ?></textarea>
								...
								<div id="accordion-1" class="collapse" aria-expanded="false" style="height: 5px;">
									...
									<div class="col-lg-2">
											<button class="btn btn-success" type="button" onclick="AgregarDocumento()"> Agregar Documento <span class="fa fa-plus-square" aria-hidden="true"></span></button>
										</div>
										<br>
										<div class="row">		
											<div class="col-lg-12">
											...
											<table class="table" name="tabla-<?php echo $CONT."-".$TipoD; ?>" id="tabla-<?php echo $CONT."-".$TipoD; ?>" >
																...
																<?php
																	...
																	<td style="font-size: 24px"><button type="button" class="btn btn-warning"  value="<?php echo $CodigoDoc; ?>" onclick="EditarDocumento(this.value)">
																		...
																		<input type="hidden" name="CodigoEmpleado" id="CodigoEmpleado" value="<?php echo $CodigoColaborador ?>">
																			...
																			<div class="card-head style-primary">
																				...
																				<form class="form" id="FormularioVer" action="GuardarDocumento.php" method="POST" enctype="multipart/form-data">
																					...
																					<embed 	src="files/<?php echo $CodigoColaborador; ?>/<?php echo $NombreDoc."-".$CodigoColaborador; ?>.<?php echo $Extencion; ?>" style="width:100%; height:500px;" frameborder="0" >	
                            ...
                            <div class="card panel" id="Familiares"><!-- Faliares -->
								...
								<div id="accordion-2" class="collapse" aria-expanded="false" style="height: 5px;">
									...
									<div class="col-lg-2">
											<button class="btn btn-success" type="button" onclick="AgregarFamiliar()"> Agregar Familiar <span class="fa fa-plus-square" aria-hidden="true"></span></button>
										</div>
										...
										<table class="table" name="tabla-<?php echo $CONT."-".$TipoD; ?>" id="tabla-<?php echo $CONT."-".$TipoD; ?>" >
																...
																<?php
																	...
																	<td style="font-size: 24px"><button type="button" class="btn btn-warning"  value="<?php echo $CodigoFam; ?>" onclick="EditarFamiliar(this.value)">
																		<span class="fa fa-pencil"></span>
																	</button>
																	</td>		                                                
					...
					<form class="form" id="FormularioDocumento" action="GuardarDocumento.php" method="POST" enctype="multipart/form-data">
						...
						<div class="col-lg-8">
										...
										<select name="TipoDocumento" id="TipoDocumento" class="form-control">
												...
												<option value="EvaluacionDesempeno">Evaluación del Desempeño</option>
