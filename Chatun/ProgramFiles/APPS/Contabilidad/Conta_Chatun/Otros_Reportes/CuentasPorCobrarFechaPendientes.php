...
<script>
	...
	{
		var Formulario = $('#FormularioEnviar');
		$(Formulario).attr('action', 'CuentasPorCobrarPDFPendientes.php');
		$(Formulario).submit();	
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="col-lg-12" align="center">
									<button type="button" class="btn ink-reaction btn-raised btn-primary" id="btnGuardar" onclick="EnviarFormPDF()">GENERAR</button>
								</div>
							</div>
						</div>
					</div>
