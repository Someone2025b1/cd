...
<script>
	...
	function EnviarFormFinal()
	{
		...
		var codigo = "<?php echo $_GET['Codigo']; ?>";
		 $(Formulario).attr('action', 'IFProGuardarFinal.php?CodigoConteo=' + codigo);
		$(Formulario).submit();	
			...
			<div class="container">
				<form class="form" method="POST" role="form" id="FormularioEnviar">
					<div class="col-lg-12">
						<br>
						<div class="card">
							<input class="form-control" type="text" name="CodigoConteo"  id="CodigoConteo" value="<?php echo $_GET["Codigo"]; ?>" required/>
													...
													<div class="col-lg-10">
														<div class="form-group">
															...
															<input class="form-control"
																	...
																	oninput="actualizarSeleccionDesdeInput(this)" 
																	required />
														</div>
													</div>
												</td>
