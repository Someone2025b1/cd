			...
			<div class="container">
				...
				<div class="col-lg-12">
					<div class="card">
						...
						<?php
			if (saber_puesto($id_user)==15 | saber_puesto($id_user)==31 | $id_user==23118 | $id_user==31121 ){
				?>
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<?php
									$Consulta = "SELECT RECETA.*
												FROM Productos.RECETA
												WHERE RECETA.R_SERVICIO = 0
												ORDER BY RECETA.R_NOMBRE";
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										$Codigo = $row["R_CODIGO"];
										echo '<tr>';             
										    	echo '<td style="font-size: 10px">'.$row["R_NOMBRE"].'</td>';
										    	
										    	echo '<td><a href="RModNew.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
