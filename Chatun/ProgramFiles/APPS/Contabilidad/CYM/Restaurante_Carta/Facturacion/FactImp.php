...
$sqlD = "SELECT FACTURA_RS_DETALLE.*, RECETA_SUBRECETA.RS_NOMBRE 
                FROM Bodega.FACTURA_RS_DETALLE, Bodega.RECETA_SUBRECETA 
                WHERE FACTURA_RS_DETALLE.RS_CODIGO = RECETA_SUBRECETA.RS_CODIGO
                AND FACTURA_RS_DETALLE.F_CODIGO = '".$Factura."'";
