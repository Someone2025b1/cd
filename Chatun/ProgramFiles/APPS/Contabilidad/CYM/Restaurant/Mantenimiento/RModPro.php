		...
		<div id="content">
			<div class="container">
				...
				if($_POST["TipoReceta"] == 1)
				{
					...
					$sql = mysqli_query($db,"UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."', CM_CODIGO = ".$_POST["Categoria"].", RS_PRECIO = ".$_POST["Precio"].", RS_MOSTRAR_MENU = ".$_POST["MostrarMenu"]." WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
				...
				elseif($_POST["TipoReceta"] == 2)
				{
					...
					$sql = mysqli_query($db,"UPDATE Bodega.RECETA_SUBRECETA SET RS_NOMBRE = '".$_POST["Nombre"]."', CM_CODIGO = ".$_POST["Categoria"].", RS_MOSTRAR_MENU = ".$_POST["MostrarMenu"]." WHERE RS_CODIGO = '".$_POST["CodigoRecetaSubreceta"]."'");
