            ...
            if(isRoScalar) {
                for (var c = 0; c < offsetRepeats; c++) {
                    for (var i = 0; i < offsetStride; i++) {
                        ...
                        switch (op) {
                            case E_ADD: res = _a + _b; 
                            case E_SUB: res = _a - _b; 
                            case E_MUL: res = _a * _b; 
                            case E_DIV: res = _a / _b; 
                            case E_MOD: res = _a % _b; 
                            case E_AND: res = _a & _b; 
                            case E_OR: res = _a | _b; 
                            case E_XOR: res = _a ^ _b; 
                            case E_EQL: res = _a == _b; 
