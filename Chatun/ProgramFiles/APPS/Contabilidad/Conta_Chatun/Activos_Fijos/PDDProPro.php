					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Contabilización Depreciación de Activos Fijos (Donaciones)</strong></h4>
							</div>
							<div class="card-body">
							<?php
								$UI           = uniqid('tra_');
									...
									while($row2 = mysqli_fetch_array($ResultA))
									{
										...
										elseif($row2["TA_CODIGO"] == 2)
										{
											if(($row2["AF_VALOR_ACTUAL"] != 1))
											{
												...
												$TotalDepreciacionEC = ($ValorActivo-1) / $MesesVida;
												$ValorActualizado = $ValorActual - $TotalDepreciacionEC;
										...
										elseif($row2["TA_CODIGO"] == 3)
										{
											if(($row2["AF_VALOR_ACTUAL"] != 1))
											{
												...
												$TotalDepreciacionV = ($ValorActivo-1) / $MesesVida;
												$ValorActualizado = $ValorActual - $TotalDepreciacionV;
										...
										elseif($row2["TA_CODIGO"] == 4)
										{
											if(($row2["AF_VALOR_ACTUAL"] != 1))
											{
												...
												$TotalDepreciacionH = ($ValorActivo-1) / $MesesVida;
												$ValorActualizado = $ValorActual - $TotalDepreciacionH;
										...
										elseif($row2["TA_CODIGO"] == 5)
										{
											if(($row2["AF_VALOR_ACTUAL"] != 1))
											{
												...
												$TotalDepreciacionSI = ($ValorActivo-1) / $MesesVida;
												$ValorActualizado = $ValorActual - $TotalDepreciacionSI;
