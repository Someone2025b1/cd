							...
							<form class="form" action="AFPro.php" method="POST" role="form" >
								...
								<div class="row">
									<?php
										...
										{
											$Query = "SELECT FACTURA_HS.*, CLIENTE.* 
														FROM Bodega.FACTURA_HS, Bodega.CLIENTE 
														WHERE FACTURA_HS.CLI_NIT = CLIENTE.CLI_NIT
														AND FACTURA_HS.F_SERIE = '".trim($_POST["Serie"])."' AND FACTURA_HS.F_NUMERO = ".$_POST["Numero"];
