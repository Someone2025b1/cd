...
WHERE A.ACC_FECHA = CURRENT_DATE() AND ACC_TIPO = 20";
	...
	$ConsultaCierre = "SELECT ACC_CODIGO FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_TIPO = 20 AND ACC_ESTADO = 2";
