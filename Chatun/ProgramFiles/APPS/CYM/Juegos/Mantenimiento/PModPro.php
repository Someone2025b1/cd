		...
		<div id="content">
			<div class="container">
				...
				<?php
						...
						$sql = mysqli_query($db, "UPDATE Bodega.PRODUCTO SET P_NOMBRE = '".$_POST["Nombre"]."', P_PRECIO = ".$_POST["Precio"].", N_CODIGO = '".$_POST["Nomenclatura"]."'  WHERE P_CODIGO = '".$_POST["CodigoProducto"]."'");
