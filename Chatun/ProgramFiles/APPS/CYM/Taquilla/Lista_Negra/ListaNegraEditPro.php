							...
							<div class="card-body">
								<?php
									...
									$Sancion = $_POST["Tipo"];
			                                    ...
			                                    $Query= mysqli_query($db, "UPDATE Taquilla.LISTA_NEGRA SET LN_TIPO = '".$Sancion."', LN_ESTADO = ".$Estado." WHERE LN_CIF_ASOCIADO = '".$CIF."'");

			                                    if($Query) //Comprobar si existió algún error en la transacción anterior
			                                    {
			                                       echo '<div class="col-lg-12 text-center">
													<h1><span class="text-xxxl text-light">Bien! <i class="fa fa-check-circle text-success"></i></span></h1>
													<h2 class="text-light">La persona se Edito correctamente.</h2>
													<div class="row">
