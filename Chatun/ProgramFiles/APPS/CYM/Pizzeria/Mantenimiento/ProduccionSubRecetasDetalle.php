											...
											?> 	
												<table class="table table-hover table-condensed">
                                                    ...
                                                    <tr>
															...
															<td><h5><b>COSTO</b></h5></td>
															<td><h5><b>CANTIDAD USADA</b></h5></td>
															<td><h5><b>CANTIDAD PRODUCIDA</b></h5></td>
															<td><h5><b>Subtotal Usada</b></h5></td>
															<td><h5><b>Subtotal Producida</b></h5></td>
														</tr>
                                                        <?php
														$totprod=0;
														$totusad=0;
                                                    $Consulta1 = "SELECT B.PRD_CANTIDAD_M, B.PRD_CANTIDAD_P, C.P_NOMBRE, C.P_ULTIMO_COSTO, C.P_CODIGO
                                                    FROM Productos.PRODUCCION_SUBRECETA_DETALLE AS B, Productos.PRODUCTO AS C
                                                    WHERE B.PR_CODIGO = '$CodigoProduccion'
                                                    AND B.P_CODIGO = C.P_CODIGO";
                                                    $Resultado1= mysqli_query($db, $Consulta1);
                                                    while($row1 = mysqli_fetch_array($Resultado1))
                                                    {
														...
														$subUsada=$row1["P_ULTIMO_COSTO"]*$row1["PRD_CANTIDAD_M"];
														$subProdu=$row1["P_ULTIMO_COSTO"]*$row1["PRD_CANTIDAD_P"];
														$totusad+=$subUsada;
														$totprod+=$subProdu;
                                                      ?>
														<tr>
															...
															<td><h5><b><?php echo $row1["P_ULTIMO_COSTO"]; ?></b></h5></td>
															<td><h5><b><?php echo $row1["PRD_CANTIDAD_M"]; ?></b></h5></td>
															<td><h5><b><?php echo $row1["PRD_CANTIDAD_P"]; ?></b></h5></td>
															<td><h5><b><?php echo $subUsada; ?></b></h5></td>
															<td><h5><b><?php echo $subProdu; ?></b></h5></td>
														</tr>
														...
														<td><h5><b></b></h5></td>
															...
															<td><h5><b><?php echo $totusad; ?></b></h5></td>
															<td><h5><b><?php echo $totprod; ?></b></h5></td>
