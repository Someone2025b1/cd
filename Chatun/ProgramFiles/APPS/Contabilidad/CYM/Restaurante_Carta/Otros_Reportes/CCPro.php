...
WHERE b.ACC_FECHA = '".$_POST["FechaInicio"]."' AND b.ACC_TIPO = 7"));
		...
		<div id="content">
			<?php
				...
				$sql = "SELECT APERTURA_CIERRE_CAJA.*, CIERRE_DETALLE.* 
						...
						AND APERTURA_CIERRE_CAJA.ACC_TIPO = 7  $filtroOtro";
				...
				$Query = "SELECT COUNT(F_CODIGO) AS FACTURAS_EMITIDAS FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
				...
				$Query1 = "SELECT COUNT(F_CODIGO) AS FACTURAS_ANULADAS FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_ESTADO = 2";
				...
				$Query3 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITO FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_DOLARES FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 2";
				...
				$Query4 = "SELECT SUM(F_TOTAL) AS TOTAL_LEMPIRAS FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 1 AND F_MONEDA = 3";
				$Result4 = mysqli_query($db,$Query4);
				while($row4 = mysqli_fetch_array($Result4))
				{
				...
				$Query5 = "SELECT SUM(F_TOTAL) AS TOTAL_DEPOSITOS FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 4";
				...
				$Query6 = "SELECT SUM(F_TOTAL) AS TOTAL_CREDITOS FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_TIPO = 3";
				...
				$Query7 = "SELECT SUM(F_TOTAL) AS TOTAL_EFECTIVO FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 1";
				...
				$Query9 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_LEMPIRA FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 3";
				...
				$Query10 = "SELECT SUM(F_CAMBIO) AS TOTAL_CAMBIO_DOLARES FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser AND F_MONEDA = 2";
				...
				$Query11 = "SELECT SUM(F_TOTAL) AS TOTAL_FACTURADO FROM Bodega.FACTURA_RS WHERE F_FECHA_TRANS = '".$Fecha."' $FiltroUser";
											...
											<tbody>
												<?php
													$SqlFacturas = "SELECT FACTURA_RS.* FROM Bodega.FACTURA_RS
																	WHERE FACTURA_RS.F_FECHA_TRANS = '".$_POST["FechaInicio"]."' $FiltroUser
