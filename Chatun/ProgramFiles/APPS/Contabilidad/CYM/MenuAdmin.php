			...
			<div id="content" style="margin-left: -125px">
				...
				<table class="table table-responsive" align="center" >
					...
					$Puesto = saber_puesto($id_user);
						...
						if ($Puesto==32 || $Puesto==17 || $Puesto==19) 
						{
							 $Filtro = "AND A.id_aplicacion IN (160, 159, 166, 156, 168)";
						}
						elseif ($Puesto==18 || $Puesto==10) 
						{
							$Filtro = "AND A.id_aplicacion IN (167, 169, 171, 157, 164)";
						}
						else
						{
							$Filtro = "";
						}
						$sql = mysqli_query($db, "SELECT A.nombre, A.icono, A.LINK, B.id_departamento FROM info_bbdd.aplicaciones AS A, info_base.define_aplicaciones_departamentos AS B WHERE A.id_aplicacion = B.id_aplicacion AND B.id_departamento = ".$_GET["id_depto"]." $Filtro ORDER BY A.nombre");
						$i = 0;
