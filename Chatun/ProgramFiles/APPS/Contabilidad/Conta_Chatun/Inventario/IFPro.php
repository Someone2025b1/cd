						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<!-- PARA HACER LA INSERCIÓN AUTOMATICA -->
									<input class="form-control" type="hidden" name="BodegaCod"  id="BodegaCod" value="<?php echo $BodegaCod; ?>" required/>
									<input class="form-control" type="hidden" name="FechaCod"  id="FechaCod" value="<?php echo $FechaCod; ?>" required/>
								</div>
