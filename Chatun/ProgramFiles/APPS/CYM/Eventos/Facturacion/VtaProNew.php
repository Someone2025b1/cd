...
<body class="menubar-hoverable header-fixed menubar-pin " onload="Imprimir()">
	...
	$XMLEnviar = '
			...
			if($TipoPago == 1)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_FECHA_TRANS, F_HORA, F_USUARIO, F_MONEDA, F_EFECTIVO, F_CAMBIO, F_OBSERVACIONES, RES_NUMERO)
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 2)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_OBSERVACIONES, F_NO_AUTORIZACION, RES_NUMERO)
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 3)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NOMBRE_CREDITO, F_OBSERVACIONES, RES_NUMERO)
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 4)
			{
				...
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA)
...
######################## FIN KARDEX ####################
			...
			elseif($TipoPago == 5){
				...
				for($i=0; $i<$ContadorANTICIPO; $i++)
					{
						...
						if($NumerosdeAnticiposUsados=="-1"){

							$NumerosdeAnticiposUsados="Anticipos Usados: No. ".$CodA.", ";

						}else{

						$NumerosdeAnticiposUsados=$NumerosdeAnticiposUsados."No. ".$CodA.", ";
						}
					}

					if ($NumerosdeAnticiposUsados=="-1"){
						$NumerosdeAnticiposUsados = "";
					}

				###REGISTRO DEL ENCABEZADO
				$QueryEncabezado = mysqli_query($db, "INSERT INTO Bodega.FACTURA_EV (F_CODIGO, F_SERIE, F_TIPO, CLI_NIT, F_TOTAL, F_EFECTIVO, F_CAMBIO, F_FECHA_TRANS, F_HORA, F_USUARIO, F_NO_BOLETA, F_OBSERVACIONES, RES_NUMERO, F_CUENTA_BANCARIA, F_NO_AUTORIZACION, F_EFECTIVO_M, F_TARJETA_M, F_BANCO_M, F_ANTICIPO_M)
												VALUES ('".$Uid."', '".$SerieAutorizada."', 5, '".$NIT."', ".$TotalFacturaFinal.", 0.00, ".$CambioM.", CURRENT_DATE(), CURRENT_TIMESTAMP(),  ".$id_user.",  '".$NumeroBoletaM."', '".$Observaciones."', '".$NumeroResolucion."', '".$CuentaBancariaM."', '".$AutorizacionM."', ".$MontoEfectivo.", ".$MontoTarjeta.", ".$MontoBanco.", ".$MontoAnticipo.")") or die(mysqli_error());

				$sqlAbono = mysqli_query($db, "INSERT INTO Bodega.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_OBSERVACIONES, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, B_CODIGO, F_CODIGO)
											 VALUES('".$UI."', CURRENT_DATE(), 'Vta. Eventos Según Fact. ".$SerieAutorizada." ".$FacturaNumero." ".$NumerosdeAnticiposUsados."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 1, 15, 1, '".$Uid."')") or die(mysqli_error());
				...
				****************************************************************************************/
				...
				$SqlContable = mysqli_query($db, "INSERT INTO Contabilidad.TRANSACCION (TRA_CODIGO, TRA_FECHA_TRANS, TRA_CONCEPTO, TRA_FECHA_HOY, TRA_HORA, TRA_USUARIO, E_CODIGO, TT_CODIGO, TRA_SERIE, TRA_FACTURA, TRA_TOTAL, RES_NUMERO, TRA_CORRELATIVO, PC_CODIGO)
										 VALUES('".$Uid."', CURRENT_DATE(), 'Vta. Eventos Según Fact. ".$SerieAutorizada." ".$FacturaNumero." ".$NumerosdeAnticiposUsados."',  CURRENT_DATE(), CURRENT_TIMESTAMP(), ".$id_user .", 2, 21, '".$SerieAutorizada."', '".$FacturaNumero."', ".$TotalFacturaFinal.", '".$NumeroResolucion."', ".$Correlativo.", ".$Periodo.")") or die(mysqli_error());
...
######################## FIN KARDEX ####################
					   ...
					   $QueryUpdateTransaccionContabilidad = mysqli_query($db, "UPDATE Contabilidad.TRANSACCION SET TRA_CONCEPTO = 'Vta. Eventos Según Fact. ".$responseCerti->body->serie.' - '.$responseCerti->body->numero.' - '.$responseCerti->body->uuid.' '.$NumerosdeAnticiposUsados."', TRA_FECHA_CERTIFICACION = '".$responseCerti->body->fecha."' WHERE TRA_CODIGO = '".$Uid."'");
