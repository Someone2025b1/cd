					...
					<div class="col-lg-12">
						...
						<div class="card">
							<div class="card-head style-primary">
								<h4 class="text-center"><strong>Conbtabilizar Liquidación</strong></h4>
							</div>
							<div class="card-body">
								...
								<?php
									...
									{	
										...
										$TipoDocumento      =$row["TRA_TIPO_DOCUMENTO"];
									}	
								?>
								...
								{
									$query = "SELECT A.* FROM Contabilidad.TRANSACCION AS A
									...
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												<input class="form-control" type="text" name="NoRecibo" id="NoRecibo" value="<?php echo $Factura; ?>" readonly/>
									...
									<div class="row">
										<div class="col-lg-3 col-lg-9">
											<div class="form-group floating-label">
												<input class="form-control" type="number" name="TotalFactura" id="TotalFactura" value="<?php echo $TotalFactura; ?>" readonly/>
												<label for="TotalFactura">Total de Recibo</label>
											</div>
										</div>
									</div>
									<div class="row">
						...
						<div class="card">
							...
							<form class="form" role="form" action="CLProPro.php" method="POST">
							<div class="card-body">
								<div class="row">
