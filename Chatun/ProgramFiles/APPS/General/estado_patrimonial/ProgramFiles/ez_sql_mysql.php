	...
	*/
	...
	class ezSQL_mysql extends ezSQLcore
	{
		...
		*/
		...
		function ezSQL_mysql($dbuser=''password=''name=''host='localhost')
		{
			$this->dbuser = $dbuser;
		...
		*/
		...
		function quick_connect($dbuser=''password=''name=''host='localhost')
		{
			$return_val = false;
			if ( ! $this->connect($dbuserpasswordhost,true) ) ;
		...
		*/
		...
		function connect($dbuser=''password=''host='localhost')
		{
			...
			else if ( ! $this->dbh = @mysqli_connect($dbhostuserpassword,true) )
			{
		...
		*/
		...
		function query($query)
		{
			...
			$this->result = @mysqli_query($db, $query,$this->dbh);
