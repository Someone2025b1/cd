...
<body class="menubar-hoverable header-fixed menubar-pin ">
	...
	<div id="base">
		...
		<div id="content">
			<div class="container">
				<h1 class="text-center"><strong>Consulta de Tipo de Evento</strong><br></h1>
				<br>
				<div class="col-lg-12">
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-hover table-condensed" id="tbl_resultados">
								...
								<?php
									$Contador = 1;
									$Consulta = "SELECT * FROM Bodega.TIPO_EVENTO";
									...
									while($row = mysqli_fetch_array($Resultado))
									{
										...
										echo '<tr>';
										    	...
										    	echo '<td style="font-size: 10px">'.$row["TE_NOMBRE"].'</td>';
										    	echo '<td><a href="TipoEventoMod.php?Codigo='.$Codigo.'"><button type="button" class="btn btn-warning btn-xs">
