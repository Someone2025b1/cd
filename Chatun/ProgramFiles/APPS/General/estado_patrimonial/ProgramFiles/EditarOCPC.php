	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="panel-title" align="center">
				<h3><strong>Editar Obligaciones a Corto Plazo</strong></h3>
			</div>
		</div>
		<div class="panel-body">
			<div class="container">
                <?php
                    $sql = "SELECT * 
                            FROM  `Estado_Patrimonial`.`obligaciones_detalle` 
                            WHERE  `id` ='".$_GET["ID"]."'";
                ...
                ?>
                        ...
                        <form class="form-horizontal" role="form" id="ParentescosFORM" action="ActualizarOCPCEditar.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9" align="left" >
                                    <input type="number" min="0" class="form-control" name="MontoOriginal" id="MontoOriginal" value="<?php echo $MontoOriginal ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="SaldoActual" class="col-lg-3 control-label">Saldo Actual</label>
                                <div class="col-lg-9" align="left" >
                                    <input type="number" min="0" class="form-control" name="SaldoActual" id="SaldoActual" value="<?php echo $SaldoActual ?>"  required>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9" align="left" >
                                    <input type="number" min="0" class="form-control" name="MontoCortoPlazo" id="MontoCortoPlazo" value="<?php echo $MontoAmortizacion ?>"  required>
                                </div>
                            </div>
