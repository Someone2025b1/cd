...
class TCPDF_STATIC {
	...
	public static function getPageSizeFromFormat($format) {
		...
		switch (strtoupper($format)) {
			...
			case 'A0' : {$pf = array( 2383.937, 3370.394); }
			case 'A1' : {$pf = array( 1683.780, 2383.937); }
			case 'A2' : {$pf = array( 1190.551, 1683.780); }
			case 'A3' : {$pf = array(  841.890, 1190.551); }
			case 'A4' : {$pf = array(  595.276,  841.890); }
			case 'A5' : {$pf = array(  419.528,  595.276); }
			case 'A6' : {$pf = array(  297.638,  419.528); }
			case 'A7' : {$pf = array(  209.764,  297.638); }
			case 'A8' : {$pf = array(  147.402,  209.764); }
			case 'A9' : {$pf = array(  104.882,  147.402); }
			case 'A10': {$pf = array(   73.701,  104.882); }
			case 'A11': {$pf = array(   51.024,   73.701); }
			case 'A12': {$pf = array(   36.850,   51.024); }
			// ISO 216 B Series + 2 SIS 014711 extensions
			case 'B0' : {$pf = array( 2834.646, 4008.189); }
			case 'B1' : {$pf = array( 2004.094, 2834.646); }
			case 'B2' : {$pf = array( 1417.323, 2004.094); }
			case 'B3' : {$pf = array( 1000.630, 1417.323); }
			case 'B4' : {$pf = array(  708.661, 1000.630); }
			case 'B5' : {$pf = array(  498.898,  708.661); }
			case 'B6' : {$pf = array(  354.331,  498.898); }
			case 'B7' : {$pf = array(  249.449,  354.331); }
			case 'B8' : {$pf = array(  175.748,  249.449); }
			case 'B9' : {$pf = array(  124.724,  175.748); }
			case 'B10': {$pf = array(   87.874,  124.724); }
			case 'B11': {$pf = array(   62.362,   87.874); }
			case 'B12': {$pf = array(   42.520,   62.362); }
			// ISO 216 C Series + 2 SIS 014711 extensions + 2 EXTENSION
			case 'C0' : {$pf = array( 2599.370, 3676.535); }
			case 'C1' : {$pf = array( 1836.850, 2599.370); }
			case 'C2' : {$pf = array( 1298.268, 1836.850); }
			case 'C3' : {$pf = array(  918.425, 1298.268); }
			case 'C4' : {$pf = array(  649.134,  918.425); }
			case 'C5' : {$pf = array(  459.213,  649.134); }
			case 'C6' : {$pf = array(  323.150,  459.213); }
			case 'C7' : {$pf = array(  229.606,  323.150); }
			case 'C8' : {$pf = array(  161.575,  229.606); }
			case 'C9' : {$pf = array(  113.386,  161.575); }
			case 'C10': {$pf = array(   79.370,  113.386); }
			case 'C11': {$pf = array(   56.693,   79.370); }
			case 'C12': {$pf = array(   39.685,   56.693); }
			case 'C76': {$pf = array(  229.606,  459.213); }
			case 'DL' : {$pf = array(  311.811,  623.622); }
			// SIS 014711 E Series
			case 'E0' : {$pf = array( 2491.654, 3517.795); }
			case 'E1' : {$pf = array( 1757.480, 2491.654); }
			case 'E2' : {$pf = array( 1247.244, 1757.480); }
			case 'E3' : {$pf = array(  878.740, 1247.244); }
			case 'E4' : {$pf = array(  623.622,  878.740); }
			case 'E5' : {$pf = array(  439.370,  623.622); }
			case 'E6' : {$pf = array(  311.811,  439.370); }
			case 'E7' : {$pf = array(  221.102,  311.811); }
			case 'E8' : {$pf = array(  155.906,  221.102); }
			case 'E9' : {$pf = array(  110.551,  155.906); }
			case 'E10': {$pf = array(   76.535,  110.551); }
			case 'E11': {$pf = array(   53.858,   76.535); }
			case 'E12': {$pf = array(   36.850,   53.858); }
			// SIS 014711 G Series
			case 'G0' : {$pf = array( 2715.591, 3838.110); }
			case 'G1' : {$pf = array( 1919.055, 2715.591); }
			case 'G2' : {$pf = array( 1357.795, 1919.055); }
			case 'G3' : {$pf = array(  958.110, 1357.795); }
			case 'G4' : {$pf = array(  677.480,  958.110); }
			case 'G5' : {$pf = array(  479.055,  677.480); }
			case 'G6' : {$pf = array(  337.323,  479.055); }
			case 'G7' : {$pf = array(  238.110,  337.323); }
			case 'G8' : {$pf = array(  167.244,  238.110); }
			case 'G9' : {$pf = array(  119.055,  167.244); }
			case 'G10': {$pf = array(   82.205,  119.055); }
			case 'G11': {$pf = array(   59.528,   82.205); }
			case 'G12': {$pf = array(   39.685,   59.528); }
			// ISO Press
			case 'RA0': {$pf = array( 2437.795, 3458.268); }
			case 'RA1': {$pf = array( 1729.134, 2437.795); }
			case 'RA2': {$pf = array( 1218.898, 1729.134); }
			case 'RA3': {$pf = array(  864.567, 1218.898); }
			case 'RA4': {$pf = array(  609.449,  864.567); }
			case 'SRA0': {$pf = array( 2551.181, 3628.346); }
			case 'SRA1': {$pf = array( 1814.173, 2551.181); }
			case 'SRA2': {$pf = array( 1275.591, 1814.173); }
			case 'SRA3': {$pf = array(  907.087, 1275.591); }
			case 'SRA4': {$pf = array(  637.795,  907.087); }
			// German  DIN 476
			case '4A0': {$pf = array( 4767.874, 6740.787); }
			case '2A0': {$pf = array( 3370.394, 4767.874); }
			// Variations on the ISO Standard
			case 'A2_EXTRA'   : {$pf = array( 1261.417, 1754.646); }
			case 'A3+'        : {$pf = array(  932.598, 1369.134); }
			case 'A3_EXTRA'   : {$pf = array(  912.756, 1261.417); }
			case 'A3_SUPER'   : {$pf = array(  864.567, 1440.000); }
			case 'SUPER_A3'   : {$pf = array(  864.567, 1380.472); }
			case 'A4_EXTRA'   : {$pf = array(  666.142,  912.756); }
			case 'A4_SUPER'   : {$pf = array(  649.134,  912.756); }
			case 'SUPER_A4'   : {$pf = array(  643.465, 1009.134); }
			case 'A4_LONG'    : {$pf = array(  595.276,  986.457); }
			case 'F4'         : {$pf = array(  595.276,  935.433); }
			case 'SO_B5_EXTRA': {$pf = array(  572.598,  782.362); }
			case 'A5_EXTRA'   : {$pf = array(  490.394,  666.142); }
			// ANSI Series
			case 'ANSI_E': {$pf = array( 2448.000, 3168.000); }
			case 'ANSI_D': {$pf = array( 1584.000, 2448.000); }
			case 'ANSI_C': {$pf = array( 1224.000, 1584.000); }
			case 'ANSI_B': {$pf = array(  792.000, 1224.000); }
			case 'ANSI_A': {$pf = array(  612.000,  792.000); }
			// Traditional 'Loose' North American Paper Sizes
			case 'USLEDGER':
			case 'LEDGER' : {$pf = array( 1224.000,  792.000); }
			case 'ORGANIZERK':
			case 'BIBLE':
			case 'USTABLOID':
			case 'TABLOID': {$pf = array(  792.000, 1224.000); }
			case 'ORGANIZERM':
			case 'USLETTER':
			case 'LETTER' : {$pf = array(  612.000,  792.000); }
			case 'USLEGAL':
			case 'LEGAL'  : {$pf = array(  612.000, 1008.000); }
			case 'GOVERNMENTLETTER':
			case 'GLETTER': {$pf = array(  576.000,  756.000); }
			case 'JUNIORLEGAL':
			case 'JLEGAL' : {$pf = array(  576.000,  360.000); }
			// Other North American Paper Sizes
			case 'QUADDEMY': {$pf = array( 2520.000, 3240.000); }
			case 'SUPER_B': {$pf = array(  936.000, 1368.000); }
			case 'QUARTO': {$pf = array(  648.000,  792.000); }
			case 'GOVERNMENTLEGAL':
			case 'FOLIO': {$pf = array(  612.000,  936.000); }
			case 'MONARCH':
			case 'EXECUTIVE': {$pf = array(  522.000,  756.000); }
			case 'ORGANIZERL':
			case 'STATEMENT':
			case 'MEMO': {$pf = array(  396.000,  612.000); }
			case 'FOOLSCAP': {$pf = array(  595.440,  936.000); }
			case 'COMPACT': {$pf = array(  306.000,  486.000); }
			case 'ORGANIZERJ': {$pf = array(  198.000,  360.000); }
			// Canadian standard CAN 2-9.60M
			case 'P1': {$pf = array( 1587.402, 2437.795); }
			case 'P2': {$pf = array( 1218.898, 1587.402); }
			case 'P3': {$pf = array(  793.701, 1218.898); }
			case 'P4': {$pf = array(  609.449,  793.701); }
			case 'P5': {$pf = array(  396.850,  609.449); }
			case 'P6': {$pf = array(  303.307,  396.850); }
			// North American Architectural Sizes
			case 'ARCH_E' : {$pf = array( 2592.000, 3456.000); }
			case 'ARCH_E1': {$pf = array( 2160.000, 3024.000); }
			case 'ARCH_D' : {$pf = array( 1728.000, 2592.000); }
			case 'BROADSHEET':
			case 'ARCH_C' : {$pf = array( 1296.000, 1728.000); }
			case 'ARCH_B' : {$pf = array(  864.000, 1296.000); }
			case 'ARCH_A' : {$pf = array(  648.000,  864.000); }
			// --- North American Envelope Sizes ---
			//   - Announcement Envelopes
			case 'ANNENV_A2'  : {$pf = array(  314.640,  414.000); }
			case 'ANNENV_A6'  : {$pf = array(  342.000,  468.000); }
			case 'ANNENV_A7'  : {$pf = array(  378.000,  522.000); }
			case 'ANNENV_A8'  : {$pf = array(  396.000,  584.640); }
			case 'ANNENV_A10' : {$pf = array(  450.000,  692.640); }
			case 'ANNENV_SLIM': {$pf = array(  278.640,  638.640); }
			//   - Commercial Envelopes
			case 'COMMENV_N6_1/4': {$pf = array(  252.000,  432.000); }
			case 'COMMENV_N6_3/4': {$pf = array(  260.640,  468.000); }
			case 'COMMENV_N8'    : {$pf = array(  278.640,  540.000); }
			case 'COMMENV_N9'    : {$pf = array(  278.640,  638.640); }
			case 'COMMENV_N10'   : {$pf = array(  296.640,  684.000); }
			case 'COMMENV_N11'   : {$pf = array(  324.000,  746.640); }
			case 'COMMENV_N12'   : {$pf = array(  342.000,  792.000); }
			case 'COMMENV_N14'   : {$pf = array(  360.000,  828.000); }
			//   - Catalogue Envelopes
			case 'CATENV_N1'     : {$pf = array(  432.000,  648.000); }
			case 'CATENV_N1_3/4' : {$pf = array(  468.000,  684.000); }
			case 'CATENV_N2'     : {$pf = array(  468.000,  720.000); }
			case 'CATENV_N3'     : {$pf = array(  504.000,  720.000); }
			case 'CATENV_N6'     : {$pf = array(  540.000,  756.000); }
			case 'CATENV_N7'     : {$pf = array(  576.000,  792.000); }
			case 'CATENV_N8'     : {$pf = array(  594.000,  810.000); }
			case 'CATENV_N9_1/2' : {$pf = array(  612.000,  756.000); }
			case 'CATENV_N9_3/4' : {$pf = array(  630.000,  810.000); }
			case 'CATENV_N10_1/2': {$pf = array(  648.000,  864.000); }
			case 'CATENV_N12_1/2': {$pf = array(  684.000,  900.000); }
			case 'CATENV_N13_1/2': {$pf = array(  720.000,  936.000); }
			case 'CATENV_N14_1/4': {$pf = array(  810.000,  882.000); }
			case 'CATENV_N14_1/2': {$pf = array(  828.000, 1044.000); }
			// Japanese (JIS P 0138-61) Standard B-Series
			case 'JIS_B0' : {$pf = array( 2919.685, 4127.244); }
			case 'JIS_B1' : {$pf = array( 2063.622, 2919.685); }
			case 'JIS_B2' : {$pf = array( 1459.843, 2063.622); }
			case 'JIS_B3' : {$pf = array( 1031.811, 1459.843); }
			case 'JIS_B4' : {$pf = array(  728.504, 1031.811); }
			case 'JIS_B5' : {$pf = array(  515.906,  728.504); }
			case 'JIS_B6' : {$pf = array(  362.835,  515.906); }
			case 'JIS_B7' : {$pf = array(  257.953,  362.835); }
			case 'JIS_B8' : {$pf = array(  181.417,  257.953); }
			case 'JIS_B9' : {$pf = array(  127.559,  181.417); }
			case 'JIS_B10': {$pf = array(   90.709,  127.559); }
			case 'JIS_B11': {$pf = array(   62.362,   90.709); }
			case 'JIS_B12': {$pf = array(   45.354,   62.362); }
			// PA Series
			case 'PA0' : {$pf = array( 2381.102, 3174.803,); }
			case 'PA1' : {$pf = array( 1587.402, 2381.102); }
			case 'PA2' : {$pf = array( 1190.551, 1587.402); }
			case 'PA3' : {$pf = array(  793.701, 1190.551); }
			case 'PA4' : {$pf = array(  595.276,  793.701); }
			case 'PA5' : {$pf = array(  396.850,  595.276); }
			case 'PA6' : {$pf = array(  297.638,  396.850); }
			case 'PA7' : {$pf = array(  198.425,  297.638); }
			case 'PA8' : {$pf = array(  147.402,  198.425); }
			case 'PA9' : {$pf = array(   99.213,  147.402); }
			case 'PA10': {$pf = array(   73.701,   99.213); }
			// Standard Photographic Print Sizes
			case 'PASSPORT_PHOTO': {$pf = array(   99.213,  127.559); }
			case 'E'   : {$pf = array(  233.858,  340.157); }
			case 'L':
			case '3R'  : {$pf = array(  252.283,  360.000); }
			case 'KG':
			case '4R'  : {$pf = array(  289.134,  430.866); }
			case '4D'  : {$pf = array(  340.157,  430.866); }
			case '2L':
			case '5R'  : {$pf = array(  360.000,  504.567); }
			case '8P':
			case '6R'  : {$pf = array(  430.866,  575.433); }
			case '6P':
			case '8R'  : {$pf = array(  575.433,  720.000); }
			case '6PW':
			case 'S8R' : {$pf = array(  575.433,  864.567); }
			case '4P':
			case '10R' : {$pf = array(  720.000,  864.567); }
			case '4PW':
			case 'S10R': {$pf = array(  720.000, 1080.000); }
			case '11R' : {$pf = array(  790.866, 1009.134); }
			case 'S11R': {$pf = array(  790.866, 1224.567); }
			case '12R' : {$pf = array(  864.567, 1080.000); }
			case 'S12R': {$pf = array(  864.567, 1292.598); }
			// Common Newspaper Sizes
			case 'NEWSPAPER_BROADSHEET': {$pf = array( 2125.984, 1700.787); }
			case 'NEWSPAPER_BERLINER'  : {$pf = array( 1332.283,  892.913); }
			case 'NEWSPAPER_TABLOID':
			case 'NEWSPAPER_COMPACT'   : {$pf = array( 1218.898,  793.701); }
			// Business Cards
			case 'CREDIT_CARD':
			case 'BUSINESS_CARD':
			case 'BUSINESS_CARD_ISO7810': {$pf = array(  153.014,  242.646); }
			case 'BUSINESS_CARD_ISO216' : {$pf = array(  147.402,  209.764); }
			case 'BUSINESS_CARD_IT':
			case 'BUSINESS_CARD_UK':
			case 'BUSINESS_CARD_FR':
			case 'BUSINESS_CARD_DE':
			case 'BUSINESS_CARD_ES'     : {$pf = array(  155.906,  240.945); }
			case 'BUSINESS_CARD_CA':
			case 'BUSINESS_CARD_US'     : {$pf = array(  144.567,  252.283); }
			case 'BUSINESS_CARD_JP'     : {$pf = array(  155.906,  257.953); }
			case 'BUSINESS_CARD_HK'     : {$pf = array(  153.071,  255.118); }
			case 'BUSINESS_CARD_AU':
			case 'BUSINESS_CARD_DK':
			case 'BUSINESS_CARD_SE'     : {$pf = array(  155.906,  255.118); }
			case 'BUSINESS_CARD_RU':
			case 'BUSINESS_CARD_CZ':
			case 'BUSINESS_CARD_FI':
			case 'BUSINESS_CARD_HU':
			case 'BUSINESS_CARD_IL'     : {$pf = array(  141.732,  255.118); }
			// Billboards
			case '4SHEET' : {$pf = array( 2880.000, 4320.000); }
			case '6SHEET' : {$pf = array( 3401.575, 5102.362); }
			case '12SHEET': {$pf = array( 8640.000, 4320.000); }
			case '16SHEET': {$pf = array( 5760.000, 8640.000); }
			case '32SHEET': {$pf = array(11520.000, 8640.000); }
			case '48SHEET': {$pf = array(17280.000, 8640.000); }
			case '64SHEET': {$pf = array(23040.000, 8640.000); }
			case '96SHEET': {$pf = array(34560.000, 8640.000); }
			// Old European Sizes
			//   - Old Imperial English Sizes
			case 'EN_EMPEROR'          : {$pf = array( 3456.000, 5184.000); }
			case 'EN_ANTIQUARIAN'      : {$pf = array( 2232.000, 3816.000); }
			case 'EN_GRAND_EAGLE'      : {$pf = array( 2070.000, 3024.000); }
			case 'EN_DOUBLE_ELEPHANT'  : {$pf = array( 1926.000, 2880.000); }
			case 'EN_ATLAS'            : {$pf = array( 1872.000, 2448.000); }
			case 'EN_COLOMBIER'        : {$pf = array( 1692.000, 2484.000); }
			case 'EN_ELEPHANT'         : {$pf = array( 1656.000, 2016.000); }
			case 'EN_DOUBLE_DEMY'      : {$pf = array( 1620.000, 2556.000); }
			case 'EN_IMPERIAL'         : {$pf = array( 1584.000, 2160.000); }
			case 'EN_PRINCESS'         : {$pf = array( 1548.000, 2016.000); }
			case 'EN_CARTRIDGE'        : {$pf = array( 1512.000, 1872.000); }
			case 'EN_DOUBLE_LARGE_POST': {$pf = array( 1512.000, 2376.000); }
			case 'EN_ROYAL'            : {$pf = array( 1440.000, 1800.000); }
			case 'EN_SHEET':
			case 'EN_HALF_POST'        : {$pf = array( 1404.000, 1692.000); }
			case 'EN_SUPER_ROYAL'      : {$pf = array( 1368.000, 1944.000); }
			case 'EN_DOUBLE_POST'      : {$pf = array( 1368.000, 2196.000); }
			case 'EN_MEDIUM'           : {$pf = array( 1260.000, 1656.000); }
			case 'EN_DEMY'             : {$pf = array( 1260.000, 1620.000); }
			case 'EN_LARGE_POST'       : {$pf = array( 1188.000, 1512.000); }
			case 'EN_COPY_DRAUGHT'     : {$pf = array( 1152.000, 1440.000); }
			case 'EN_POST'             : {$pf = array( 1116.000, 1386.000); }
			case 'EN_CROWN'            : {$pf = array( 1080.000, 1440.000); }
			case 'EN_PINCHED_POST'     : {$pf = array( 1062.000, 1332.000); }
			case 'EN_BRIEF'            : {$pf = array(  972.000, 1152.000); }
			case 'EN_FOOLSCAP'         : {$pf = array(  972.000, 1224.000); }
			case 'EN_SMALL_FOOLSCAP'   : {$pf = array(  954.000, 1188.000); }
			case 'EN_POTT'             : {$pf = array(  900.000, 1080.000); }
			//   - Old Imperial Belgian Sizes
			case 'BE_GRAND_AIGLE' : {$pf = array( 1984.252, 2948.031); }
			case 'BE_COLOMBIER'   : {$pf = array( 1757.480, 2409.449); }
			case 'BE_DOUBLE_CARRE': {$pf = array( 1757.480, 2607.874); }
			case 'BE_ELEPHANT'    : {$pf = array( 1746.142, 2182.677); }
			case 'BE_PETIT_AIGLE' : {$pf = array( 1700.787, 2381.102); }
			case 'BE_GRAND_JESUS' : {$pf = array( 1559.055, 2069.291); }
			case 'BE_JESUS'       : {$pf = array( 1530.709, 2069.291); }
			case 'BE_RAISIN'      : {$pf = array( 1417.323, 1842.520); }
			case 'BE_GRAND_MEDIAN': {$pf = array( 1303.937, 1714.961); }
			case 'BE_DOUBLE_POSTE': {$pf = array( 1233.071, 1601.575); }
			case 'BE_COQUILLE'    : {$pf = array( 1218.898, 1587.402); }
			case 'BE_PETIT_MEDIAN': {$pf = array( 1176.378, 1502.362); }
			case 'BE_RUCHE'       : {$pf = array( 1020.472, 1303.937); }
			case 'BE_PROPATRIA'   : {$pf = array(  977.953, 1218.898); }
			case 'BE_LYS'         : {$pf = array(  898.583, 1125.354); }
			case 'BE_POT'         : {$pf = array(  870.236, 1088.504); }
			case 'BE_ROSETTE'     : {$pf = array(  765.354,  983.622); }
			//   - Old Imperial French Sizes
			case 'FR_UNIVERS'          : {$pf = array( 2834.646, 3685.039); }
			case 'FR_DOUBLE_COLOMBIER' : {$pf = array( 2551.181, 3571.654); }
			case 'FR_GRANDE_MONDE'     : {$pf = array( 2551.181, 3571.654); }
			case 'FR_DOUBLE_SOLEIL'    : {$pf = array( 2267.717, 3401.575); }
			case 'FR_DOUBLE_JESUS'     : {$pf = array( 2154.331, 3174.803); }
			case 'FR_GRAND_AIGLE'      : {$pf = array( 2125.984, 3004.724); }
			case 'FR_PETIT_AIGLE'      : {$pf = array( 1984.252, 2664.567); }
			case 'FR_DOUBLE_RAISIN'    : {$pf = array( 1842.520, 2834.646); }
			case 'FR_JOURNAL'          : {$pf = array( 1842.520, 2664.567); }
			case 'FR_COLOMBIER_AFFICHE': {$pf = array( 1785.827, 2551.181); }
			case 'FR_DOUBLE_CAVALIER'  : {$pf = array( 1757.480, 2607.874); }
			case 'FR_CLOCHE'           : {$pf = array( 1700.787, 2267.717); }
			case 'FR_SOLEIL'           : {$pf = array( 1700.787, 2267.717); }
			case 'FR_DOUBLE_CARRE'     : {$pf = array( 1587.402, 2551.181); }
			case 'FR_DOUBLE_COQUILLE'  : {$pf = array( 1587.402, 2494.488); }
			case 'FR_JESUS'            : {$pf = array( 1587.402, 2154.331); }
			case 'FR_RAISIN'           : {$pf = array( 1417.323, 1842.520); }
			case 'FR_CAVALIER'         : {$pf = array( 1303.937, 1757.480); }
			case 'FR_DOUBLE_COURONNE'  : {$pf = array( 1303.937, 2040.945); }
			case 'FR_CARRE'            : {$pf = array( 1275.591, 1587.402); }
			case 'FR_COQUILLE'         : {$pf = array( 1247.244, 1587.402); }
			case 'FR_DOUBLE_TELLIERE'  : {$pf = array( 1247.244, 1927.559); }
			case 'FR_DOUBLE_CLOCHE'    : {$pf = array( 1133.858, 1700.787); }
			case 'FR_DOUBLE_POT'       : {$pf = array( 1133.858, 1757.480); }
			case 'FR_ECU'              : {$pf = array( 1133.858, 1474.016); }
			case 'FR_COURONNE'         : {$pf = array( 1020.472, 1303.937); }
			case 'FR_TELLIERE'         : {$pf = array(  963.780, 1247.244); }
			case 'FR_POT'              : {$pf = array(  878.740, 1133.858); }
			// DEFAULT ISO A4
			default: {$pf = array(  595.276,  841.890); }
		}
		return $pf;
	}
