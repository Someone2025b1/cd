						...
						<div class="card-body">
							<?php
                                ...
                                for($i=0; $i<$Contador; $i++)
                                {
									...
									AND KARDEX.K_FECHA BETWEEN '$FechaInicio' AND '2024-03-17'
									...
									while($row1 = mysqli_fetch_array($NomTitulo))
											...
											$Cantidad=$row1["K_EXISTENCIA_ACTUAL_PUNTO"]-$row1["K_EXISTENCIA_ANTERIOR_PUNTO"];
												...
												$Devoluciones=$Devoluciones+$Cantidad;
											}
									...
									##########FIN##########
											...
											$Sistema = $ContAnterior+$Con+$Traslados+$Ventas-$Devoluciones;

										

											$Diferencia = $Sistema-$Can;
									...
									echo '<div class="col-lg-12 text-center">
											...
											<h2 class="text-light">Se Agrego Correctamente '.$Can.' '.$i.' '.$Prod.'</h2>
											<div class="row">
								...
								else
								{
										echo '<div class="col-lg-12 text-center">
											<h1><span class="text-xxxl text-light">Bien! <i class="fa fa-check-circle text-success"></i></span></h1>
											<h2 class="text-light">Se Agrego Correctamente '.$Can.'</h2>
											<div class="row">
												<div class="col-lg-12 text-center"><a href="ControldeInventario.php"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></div>
											</div>';					
								}
