					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								$Consulta = "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_ESTADO = 1 AND ACC_TIPO = 11";
								$ResultConsulta = mysqli_query($db, $Consulta) or die(mysqli_error());
								$Registros = mysqli_num_rows(mysqli_query($db, "SELECT * FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_FECHA = CURRENT_DATE() AND ACC_ESTADO = 1 AND ACC_TIPO = 11"));


								if($Registros == 0)
								{	

									$Query = "SELECT ACC_FECHA FROM Bodega.APERTURA_CIERRE_CAJA WHERE ACC_ESTADO = 1 AND ACC_FECHA < CURRENT_DATE() AND ACC_TIPO = 11";
